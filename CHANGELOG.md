...
* add ability to edit id in flows ([#4364](https://github.com/windmill-labs/windmill/issues/4364)) ([9e8c9fb](https://github.com/windmill-labs/windmill/commit/9e8c9fb1cba2558e8b6889e0559b02a81f878cdf))
* add load more to runs page if nb of jobs &gt;= 1000 ([4c174cb](https://github.com/windmill-labs/windmill/commit/4c174cb35912f3d2b976407d0e9e811f9a18beaf))
* add return_last_result annotation to sql ([#4443](https://github.com/windmill-labs/windmill/issues/4443)) ([97cdafa](https://github.com/windmill-labs/windmill/commit/97cdafac86133be63ab0ee9e1e3d6686b2227683))
* add rust ([#4253](https://github.com/windmill-labs/windmill/issues/4253)) ([91d328b](https://github.com/windmill-labs/windmill/commit/91d328b13249b09bc68fbb64430deafa6d806f31))
* add slack as a critical alert channel ([#4319](https://github.com/windmill-labs/windmill/issues/4319)) ([c487934](https://github.com/windmill-labs/windmill/commit/c487934e3b42ddae36c28843967ddf0db95e679a))
* add Spotify oauth provider ([#4581](https://github.com/windmill-labs/windmill/issues/4581)) ([e4e5603](https://github.com/windmill-labs/windmill/commit/e4e5603a48426cf71375d18675f2f60b3c69f8a7))
* add static variable and resources support to ansible ([#4435](https://github.com/windmill-labs/windmill/issues/4435)) ([08ae91e](https://github.com/windmill-labs/windmill/commit/08ae91e6ddcd6a0e4493ff5a0c0fc70c11c7d0d5))
* add tag filtering to external JWT authentication ([#4425](https://github.com/windmill-labs/windmill/issues/4425)) ([1feccd4](https://github.com/windmill-labs/windmill/commit/1feccd493eb55272cd046b4a59ae0b8d0dc2c9cb))
* add vim support for monaco/webeditor ([2b3e86e](https://github.com/windmill-labs/windmill/commit/2b3e86e34126d73bf745810d032649ab82f6b472))
* add yaml editor in flow builder ([fc8ba4d](https://github.com/windmill-labs/windmill/commit/fc8ba4d7f9ccaa120a147674ec7213a27dc93974))
* Allow setProgress and getProgress from within the script ([#4400](https://github.com/windmill-labs/windmill/issues/4400)) ([d3e0b1c](https://github.com/windmill-labs/windmill/commit/d3e0b1c636d03e09e27a2e2a548e1acf6678b82f))
* ansible playbook support ([#4399](https://github.com/windmill-labs/windmill/issues/4399)) ([b0cb1e0](https://github.com/windmill-labs/windmill/commit/b0cb1e0b27b09c7dfc0796bd2de9c3903c5d1986))
* **app builder:** file download helper ([#4511](https://github.com/windmill-labs/windmill/issues/4511)) ([ddba111](https://github.com/windmill-labs/windmill/commit/ddba11138022cdc8d1a542e83c2c5e43a3893bc4))
* autoscaling v0 ([#4593](https://github.com/windmill-labs/windmill/issues/4593)) ([85de44c](https://github.com/windmill-labs/windmill/commit/85de44cb93c1ad2a2da0cc8657829a985ce20077))
* **cli:** add queues, workers and worker-groups commands ([#4439](https://github.com/windmill-labs/windmill/issues/4439)) ([bd6ddc1](https://github.com/windmill-labs/windmill/commit/bd6ddc166bd2987f1abadfad9abab40b4af1f3fc))
* **cli:** encrypt sensitive instance settings ([#4561](https://github.com/windmill-labs/windmill/issues/4561)) ([9bf7868](https://github.com/windmill-labs/windmill/commit/9bf7868aa1baf21bc9d647bb4986b1460c28df9d))
* **cli:** instance yaml files inside the instance prefix folders ([#4627](https://github.com/windmill-labs/windmill/issues/4627)) ([57d59bc](https://github.com/windmill-labs/windmill/commit/57d59bc90a867b41d374b2b70951527cc3fbe6b8))
* **cli:** opts.instance as instace name and prefix ([#4609](https://github.com/windmill-labs/windmill/issues/4609)) ([13ee433](https://github.com/windmill-labs/windmill/commit/13ee433ec053be896038448b587648678c05cf9e))
* failed key renewal alert + renew on start if no recent renewal ([#4387](https://github.com/windmill-labs/windmill/issues/4387)) ([d3e8731](https://github.com/windmill-labs/windmill/commit/d3e8731be28a85a471b0783f0afed9687a0cc815))
* flow step skipping ([#4461](https://github.com/windmill-labs/windmill/issues/4461)) ([62d8843](https://github.com/windmill-labs/windmill/commit/62d88436b22881ac454d503647bc3231155958ad))
* **frontend:** add a favorite button on detail pages ([#4297](https://github.com/windmill-labs/windmill/issues/4297)) ([90cccc5](https://github.com/windmill-labs/windmill/commit/90cccc53b45ebaa66c52b2f3576000799baeb9e9))
* **frontend:** Add a toggle to disable breakpoints in the App editor ([#4274](https://github.com/windmill-labs/windmill/issues/4274)) ([3b14d56](https://github.com/windmill-labs/windmill/commit/3b14d566236a11cdb7e6985683105a42346ddea5))
* **frontend:** add http routing templates ([#4421](https://github.com/windmill-labs/windmill/issues/4421)) ([e874c9c](https://github.com/windmill-labs/windmill/commit/e874c9c5d57d60b09614e035cdd3a006c6e18b2b))
* **frontend:** add indicator when a component is locked ([#4296](https://github.com/windmill-labs/windmill/issues/4296)) ([9dccb04](https://github.com/windmill-labs/windmill/commit/9dccb04ae8116f41b5aa5ed204ad46219fcb0727))
* **frontend:** add quick access menu in flow editor ([#4415](https://github.com/windmill-labs/windmill/issues/4415)) ([7c36e55](https://github.com/windmill-labs/windmill/commit/7c36e554d7f13e16e65c6907dfcf5af17cd617fc))
* **frontend:** add support to copy a cell value in the clipboard in aggrid tables ([#4286](https://github.com/windmill-labs/windmill/issues/4286)) ([14e1007](https://github.com/windmill-labs/windmill/commit/14e10072ded4adab371e67d1fa9c8a3e596372d1))
* **frontend:** Catch flow errors in the UI ([#4429](https://github.com/windmill-labs/windmill/issues/4429)) ([06b7363](https://github.com/windmill-labs/windmill/commit/06b7363b4461ff22e82117a51f8f8fac82c0c783))
* **frontend:** components can be moved inside containers by holding ctrl/cmd ([a66c530](https://github.com/windmill-labs/windmill/commit/a66c5303b81c13c67c7329343b56b267efbc29e5))
* **frontend:** hide/show app editor panels ([#4266](https://github.com/windmill-labs/windmill/issues/4266)) ([7a28811](https://github.com/windmill-labs/windmill/commit/7a288112f6ceb9ef9b6a3c3fae4569f34efb8cc8))
* **frontend:** manage ag grid actions programmatically ([#4289](https://github.com/windmill-labs/windmill/issues/4289)) ([c2276d5](https://github.com/windmill-labs/windmill/commit/c2276d5620b91f4079292305dde0e1a24498a2b9))
* **frontend:** unify all triggers UX and simplify flow settings ([#4259](https://github.com/windmill-labs/windmill/issues/4259)) ([258445e](https://github.com/windmill-labs/windmill/commit/258445e52399906bcb4f0144c5923a0afb762930))
* http routing ([#4339](https://github.com/windmill-labs/windmill/issues/4339)) ([ae8f29a](https://github.com/windmill-labs/windmill/commit/ae8f29a4cb7d8ef4c397b56eed8e91e98ac99913))
* make CLI node compatible ([#4347](https://github.com/windmill-labs/windmill/issues/4347)) ([fd18f42](https://github.com/windmill-labs/windmill/commit/fd18f42e0fd37e4451429a54eb44ac2755529ece))
* min workers in worker group alert + zombie job critical alert ([#4307](https://github.com/windmill-labs/windmill/issues/4307)) ([c3ce680](https://github.com/windmill-labs/windmill/commit/c3ce68066cfb8e3b81121a84b7e862a8a4ed135e))
* **monitoring:** Critical Alerts for Jobs Waiting in Queue [enterprise] ([#4491](https://github.com/windmill-labs/windmill/issues/4491)) ([585f55e](https://github.com/windmill-labs/windmill/commit/585f55edd2e7f74f2a98b25f6325141b636426ce))
* private hub user accessible url setting ([#4617](https://github.com/windmill-labs/windmill/issues/4617)) ([c803f9c](https://github.com/windmill-labs/windmill/commit/c803f9cdb296ff5cf9416f1fb170192ffc82cc8e))
* put email triggers attachments on s3 ([#4272](https://github.com/windmill-labs/windmill/issues/4272)) ([5e5b3e2](https://github.com/windmill-labs/windmill/commit/5e5b3e2b53a1fe6e05af90dfff6d86b32210e2ba))
* Replace `pip-compile` with `uv` ([#4460](https://github.com/windmill-labs/windmill/issues/4460)) ([1e7a37a](https://github.com/windmill-labs/windmill/commit/1e7a37ac8bf0d06eaf3d3950b8b4822bf0607705))
* s3 image preview ([#4262](https://github.com/windmill-labs/windmill/issues/4262)) ([4671e97](https://github.com/windmill-labs/windmill/commit/4671e9703867e4d7e1d3c81f1c65208895a99a07))
* schedule success handler ([#4346](https://github.com/windmill-labs/windmill/issues/4346)) ([a009c8d](https://github.com/windmill-labs/windmill/commit/a009c8df23c5339fa2a6ce45a24e9d5df14b730a))
* Scroll to element in virtual list when clicking on graph point ([#4532](https://github.com/windmill-labs/windmill/issues/4532)) ([42f8e45](https://github.com/windmill-labs/windmill/commit/42f8e457febc220a80788dffc7e982b4eed4226f))
* service logs ([#4244](https://github.com/windmill-labs/windmill/issues/4244)) ([c62e152](https://github.com/windmill-labs/windmill/commit/c62e152d27851c3f8c29eb6e3ce028f5c18d5773))
* show last job instead of current job on workers page ([#4293](https://github.com/windmill-labs/windmill/issues/4293)) ([5a300fb](https://github.com/windmill-labs/windmill/commit/5a300fb3e25366f048e1e03c0fa8c09e7ed379f6))
* **sso:** adding the ability to define a custom display name for sso ([#4529](https://github.com/windmill-labs/windmill/issues/4529)) ([3bf4d4f](https://github.com/windmill-labs/windmill/commit/3bf4d4f43e4fbb0ec98073a201a67d6035660ab9))
* **typescript-bun:** support relative imports without the .ts extension ([7024404](https://github.com/windmill-labs/windmill/commit/7024404bb33b74ef4de914f1c024e1fc27f495e3))
* upgrade to deno 2 ([ae6eac5](https://github.com/windmill-labs/windmill/commit/ae6eac5f7b5ddbefc6753d8a9227f226df294e4c))
* websocket triggers ([#4505](https://github.com/windmill-labs/windmill/issues/4505)) ([b0fbcd8](https://github.com/windmill-labs/windmill/commit/b0fbcd8305c30830aa5501f8de3ecf9d4332fde9))
* **worker:** support workers to run natively on windows ([#4446](https://github.com/windmill-labs/windmill/issues/4446)) ([6eb7f8c](https://github.com/windmill-labs/windmill/commit/6eb7f8ce817ca13fd1a83dc4347b3f06d53abc00))


### Bug Fixes

* add extra args support for exception to bun scripts ([f3ddd76](https://github.com/windmill-labs/windmill/commit/f3ddd76159c29d4ccaf59baf31338444d255ae17))
* add filename to s3 upload ([6c3f969](https://github.com/windmill-labs/windmill/commit/6c3f9696cbe4549092909674731647b50f573801))
* Add indexer backup lock to fit the deployment model ([#4531](https://github.com/windmill-labs/windmill/issues/4531)) ([98a6418](https://github.com/windmill-labs/windmill/commit/98a64188f58dedc78085ad490df67d8e30cd6873))
* add run immediately popover to run again ([4f46663](https://github.com/windmill-labs/windmill/commit/4f46663b262bc425262351806f961ba5de69314f))
* add tag_override for script in flows ([34b130d](https://github.com/windmill-labs/windmill/commit/34b130d01853641f6b1ef51bf999fab19ea8fe00))
* allow no body in job requests ([#4413](https://github.com/windmill-labs/windmill/issues/4413)) ([ef74468](https://github.com/windmill-labs/windmill/commit/ef744685061af868553f05cd64b9ec51c9133c35))
* allow preprocessor to write to args.json on nsjail ([#4455](https://github.com/windmill-labs/windmill/issues/4455)) ([6fb936c](https://github.com/windmill-labs/windmill/commit/6fb936cdb6da3417e237a1a86d2074d7dea85741))
* **apidocs:** fix generated openapi files ([4f31783](https://github.com/windmill-labs/windmill/commit/4f3178343d037080c394e09d43b9f990c1cd4293))
* **app builder:** date input default value improvements ([1c56690](https://github.com/windmill-labs/windmill/commit/1c56690fea6c37c6ed7da05ad030d2790856ffc0))
* **app:** accept connecting to non yet existing state output for convenience ([4199c1c](https://github.com/windmill-labs/windmill/commit/4199c1c47de529f2457c72a2761add04ba7e01b5))
* **app:** improve absolute url handling in download button and downloadFile ([f537c7b](https://github.com/windmill-labs/windmill/commit/f537c7b98bcf612025b0b350b8a985d8a43d3df8))
* apply NO_PROXY and HTTP_PROXY, HTTPS_PROXY more consistently ([e11cc13](https://github.com/windmill-labs/windmill/commit/e11cc13c927f816b6f705687153d22d5bcfc3080))
* **app:** make s3 uploads persistent across tabs change ([8a926ac](https://github.com/windmill-labs/windmill/commit/8a926acdb6bf0e51b2108ec4464b296cb829f2dd))
* **apps:** enable text selection on aggrid tables by default ([fd8f05c](https://github.com/windmill-labs/windmill/commit/fd8f05c51c78a404119490e1f60c71daf213e487))
* **apps:** public apps can take full height ([022b0e0](https://github.com/windmill-labs/windmill/commit/022b0e0b4d654385c64c82e2d50cc00beaca6599))
* **backend:** in flows, workspace scripts should use their set tags instead of the default one ([ab38215](https://github.com/windmill-labs/windmill/commit/ab38215c865a2b619c3a97abd5492a5c2840d156))
* **bash:** correctly propagate sigterm for cancelled bash scripts ([2cd46cc](https://github.com/windmill-labs/windmill/commit/2cd46cc55f2866b0fc78d5c2cd49ec19cc496b7d))
* bun 1.1.21-&gt;1.1.25 ([7b1ea57](https://github.com/windmill-labs/windmill/commit/7b1ea579248e71a4cede8548c03052340a3e1639))
* bun scripts cached in docker image have their dependencies pre-loaded ([16e9f06](https://github.com/windmill-labs/windmill/commit/16e9f063f7fe30788a391010ce4f6ff48b11fa67))
* **bun:** handle bun lockfile created with windows ([#4602](https://github.com/windmill-labs/windmill/issues/4602)) ([692b056](https://github.com/windmill-labs/windmill/commit/692b0568fc262aa1561bd78f61aa870c0bdf0354))
* **bun:** never pre-bundle BASE_URL env variable ([73d25c8](https://github.com/windmill-labs/windmill/commit/73d25c867ceda8e816c5a0a02363a9e199710c66))
* cache hub scripts in more cases + pre-cache hub scripts deps in deno ([e1223a6](https://github.com/windmill-labs/windmill/commit/e1223a6f24a2c6d1f81dbe77de1e42ade4304abd))
* cache js static assets by default ([2953154](https://github.com/windmill-labs/windmill/commit/2953154a25471627d36b421cdd06df9384f76991))
* canceled jobs button reporting 0 jobs cancelled ([#4534](https://github.com/windmill-labs/windmill/issues/4534)) ([a51cbc9](https://github.com/windmill-labs/windmill/commit/a51cbc9e084696509ca0f319ba78dd7da9fea403))
* cannot create duplicate apps and raw_apps ([f864709](https://github.com/windmill-labs/windmill/commit/f864709ab2e37751d09b94f02cb875f36809010b))
* **cli:** add --base-url option to add possibility of setting every arg without needing to add a workspace first ([d1e46d7](https://github.com/windmill-labs/windmill/commit/d1e46d7dfae39dcfa54475774499f3db3126cc49))
* **cli:** add --extra-includes to improve git sync capabilities ([7b8b164](https://github.com/windmill-labs/windmill/commit/7b8b1642845171d0e9dbb87b3bf7b812f7ad832a))
* **cli:** browser login works on npm ([98e7205](https://github.com/windmill-labs/windmill/commit/98e7205edd2d729f6bd8508c8fd955994c94686f))
* **cli:** fix opts.yes for instance sync ([e279c2e](https://github.com/windmill-labs/windmill/commit/e279c2eea770e58bfa02e365e4af92be915df329))
* **cli:** fix set client of instance when passing token and base url ([53f494e](https://github.com/windmill-labs/windmill/commit/53f494e81427ce68d24b0f5a84297bc4940257a1))
* **cli:** fix wmill instance pull  --instance ([24d11cd](https://github.com/windmill-labs/windmill/commit/24d11cd1488ba8c6a70710b116231902fb6373d7))
* **cli:** fix wmill instance push --base-url and --instance ([f9f4d1c](https://github.com/windmill-labs/windmill/commit/f9f4d1caf9a34035895c37a9d6a39bcf034c710c))
* **cli:** guide users to migrate to node version of the CLI ([5817efc](https://github.com/windmill-labs/windmill/commit/5817efc16f3ceabc704572e948a97f42cbe6b8d4))
* **cli:** handle case where 'toString' is a schema field ([fdfcea3](https://github.com/windmill-labs/windmill/commit/fdfcea3cc830a360a4862468e360b093a59a9645))
* **cli:** improve --instance handling wmill instance push ([d9349e8](https://github.com/windmill-labs/windmill/commit/d9349e82e534ee9505752dcfeff0621de6d89290))
* **cli:** improve instance sync for CI/CD + --folder-per-instance ([1c70c0c](https://github.com/windmill-labs/windmill/commit/1c70c0c2f10858fbd0f22880ff18c8ec92b3ff69))
* **cli:** improve schedule path handling on windows ([d194ffe](https://github.com/windmill-labs/windmill/commit/d194ffe115ca5ab09951d4f76bb5c530affb36ef))
* **cli:** improve wmill init behavior ([f064748](https://github.com/windmill-labs/windmill/commit/f064748aa072f86f6a55656db1bf4fac3563442c))
* **cli:** instance sync push does not require sync pull ([29056a6](https://github.com/windmill-labs/windmill/commit/29056a610e9e16b0c61f716b8c90165470b4e3d7))
* **cli:** make CLI compatible with Node 18 ([0993a18](https://github.com/windmill-labs/windmill/commit/0993a1843f8b753bdc3db2d9ed7a344bfa306c06))
* **cli:** make CLI not require latest version of windmill ([ab26e44](https://github.com/windmill-labs/windmill/commit/ab26e4422efda38f5e0d345b64162ac945e2c710))
* **cli:** on node, prompt paste accept more than 8 chars ([9577f21](https://github.com/windmill-labs/windmill/commit/9577f21a0b5428fb388aa3c31722d17ba212124a))
* **cli:** update CLI schema parsers to latest ([91bd6f7](https://github.com/windmill-labs/windmill/commit/91bd6f73d2e368aac3ab6fae38a49d2cea85c157))
* **cli:** version the whole client for deno compatibility ([db39a89](https://github.com/windmill-labs/windmill/commit/db39a893951102d899c63abd092b4aa22217fe57))
* correct AI generation for CRON and regex ([#4437](https://github.com/windmill-labs/windmill/issues/4437)) ([39cc2b1](https://github.com/windmill-labs/windmill/commit/39cc2b13aad38a532ebba4e63be9e45a0f81c7b7))
* default success handler key can be viewed by anyone in the workspace ([d551593](https://github.com/windmill-labs/windmill/commit/d55159367d9e29f0cbbb4bdc10a28d56112331d9))
* **deno:** replace lock-write with frozen=false ([605ac74](https://github.com/windmill-labs/windmill/commit/605ac7439b67144b4f887d298ce5a7d61762dd7b))
* do not delete primary schedule of script/flow on redeploy even if schedule wasn't loaded ([47a3ae7](https://github.com/windmill-labs/windmill/commit/47a3ae741f04b41c2d4820b802c7525348a787be))
* Do not ignore file resources with json file ext ([#4562](https://github.com/windmill-labs/windmill/issues/4562)) ([8a0e974](https://github.com/windmill-labs/windmill/commit/8a0e9743a65444c0bf07bcafc7f70aa36c0a0003))
* do not require hasNullParent only if scriptPathExact on runs search ([a9bf63a](https://github.com/windmill-labs/windmill/commit/a9bf63ae1f66a3f84b490864e6487d599e57d07e))
* do not update created_at of scripts on lockfile generation ([2cbf027](https://github.com/windmill-labs/windmill/commit/2cbf027653fb38d3f05079073ef1d68f9a58c01e))
* **docs:** smtp setup documentation link ([#4590](https://github.com/windmill-labs/windmill/issues/4590)) ([37eb38b](https://github.com/windmill-labs/windmill/commit/37eb38b5fa26ea31ce1c73857e99cc9c614a3fa2))
* fix app navbar query reactivity + hash in ctx handling is more consistent ([d4ff206](https://github.com/windmill-labs/windmill/commit/d4ff20682b5ac79f2364560714995f35e045818e))
* fix CLI publishing ([87c1168](https://github.com/windmill-labs/windmill/commit/87c11680a9a335b926a6fe2a9010363e32c25f06))
* fix deno cache --allow-import on deno 2 ([98e2580](https://github.com/windmill-labs/windmill/commit/98e2580bbba75b726202b4633f331d72481911f5))
* fix erronous branchone status ([c5feaef](https://github.com/windmill-labs/windmill/commit/c5feaefec7ab55a291353d646960f6ce14c217cc))
* fix error handler new script if no modules ([881dfd1](https://github.com/windmill-labs/windmill/commit/881dfd10aa2581b9ed718a386d46ff39801517ae))
* fix flow rendering ([cad1426](https://github.com/windmill-labs/windmill/commit/cad14264baede14d41b64b3983bc9ed47026b4c5))
* fix flow viewer renderer outside of flow details and editor context ([bd38b53](https://github.com/windmill-labs/windmill/commit/bd38b5312482a10ae8db07d19d8c9e349dc561a0))
* fix hub sync script ([dc7963d](https://github.com/windmill-labs/windmill/commit/dc7963d4c7bf3ff166496373baf3e21363640e8b))
* fix id editor for app ([6e81c68](https://github.com/windmill-labs/windmill/commit/6e81c680a9fc5b846ada2280e255c175206867c2))
* fix id save on apps ([38c2928](https://github.com/windmill-labs/windmill/commit/38c2928da6d61e580f7eb6a7e7c0e9b7cbfcb25e))
* fix new instance db setup ([16692d5](https://github.com/windmill-labs/windmill/commit/16692d5ff6978862fe8eb0fea3f4db0cb5ae4ec2))
* fix resource list in args being pre-pended with $res ([3ff0701](https://github.com/windmill-labs/windmill/commit/3ff0701832310c94a17a295c33f01585ce15efa5))
* fix script persistence in url + add support for extra error args in python ([fac41fd](https://github.com/windmill-labs/windmill/commit/fac41fd7001a9dbfc72757f75dfc3830ac20c344))
* fix uv path ([7c0950d](https://github.com/windmill-labs/windmill/commit/7c0950d9da1a7e6beed0aab73c992f1839e32201))
* flow picker of flows ([fbd196c](https://github.com/windmill-labs/windmill/commit/fbd196ca5f03eae78c386bb9ec92792bce38215a))
* flow picker of flows + precache hub scripts as bundles ([c2c2a49](https://github.com/windmill-labs/windmill/commit/c2c2a494bdc0eb404aac347737c2357cf534d98d))
* frontend/package.json & frontend/package-lock.json to reduce vulnerabilities ([#3918](https://github.com/windmill-labs/windmill/issues/3918)) ([1727046](https://github.com/windmill-labs/windmill/commit/172704633d6562886da1297cf914a95ad49b4a23))
* frontend/package.json & frontend/package-lock.json to reduce vulnerabilities ([#4314](https://github.com/windmill-labs/windmill/issues/4314)) ([b87ff89](https://github.com/windmill-labs/windmill/commit/b87ff89bbc966952138994ba3d98b35a3b3638f0))
* **frontend:** add back script lockfile to script details pae ([edadb51](https://github.com/windmill-labs/windmill/commit/edadb5183f9579c4c522ba6dc850720155f71677))
* **frontend:** add support for step id change for forloops and branch… ([#4395](https://github.com/windmill-labs/windmill/issues/4395)) ([fda1f21](https://github.com/windmill-labs/windmill/commit/fda1f21d5e581a33a6e1c3911b57a216d966e572))
* **frontend:** correctly initialize step inputs on new inline script ([acab1c8](https://github.com/windmill-labs/windmill/commit/acab1c8bacc3434f5caa22c1a1805b74b046e7bc))
* **frontend:** disable runnable field on route editor from detail panel ([#4469](https://github.com/windmill-labs/windmill/issues/4469)) ([9000500](https://github.com/windmill-labs/windmill/commit/90005005af6853e010586a3b7e645640b0da3202))
* **frontend:** Fix delete branch one index ([#4418](https://github.com/windmill-labs/windmill/issues/4418)) ([b187b77](https://github.com/windmill-labs/windmill/commit/b187b77f95b652a916ef7558e11b43b4e1607a45))
* **frontend:** Fix flow graph bg in dark mode on chrome ([#4454](https://github.com/windmill-labs/windmill/issues/4454)) ([745fa66](https://github.com/windmill-labs/windmill/commit/745fa66c90b654a9fba72f338393f8e18857c18c))
* **frontend:** fix inserting Ws scripts from the search menu ([#4290](https://github.com/windmill-labs/windmill/issues/4290)) ([a4dea84](https://github.com/windmill-labs/windmill/commit/a4dea842d607fb710b72490ffac6426651723210))
* **frontend:** fix large JSON viewer ([#4273](https://github.com/windmill-labs/windmill/issues/4273)) ([86f7bd7](https://github.com/windmill-labs/windmill/commit/86f7bd7f97d8fb905bcc4b20d735e115ef6650dc))
* **frontend:** fix script and flow renaming ([b31f629](https://github.com/windmill-labs/windmill/commit/b31f62940c0cfa7689d24669491ab3d60d6c9deb))
* **frontend:** improve display of error handlers ([45af254](https://github.com/windmill-labs/windmill/commit/45af2544df006c0c689ffeadb95d9fbd298402f8))
* **frontend:** improve tag selector for workspace script drawer ([c60df3c](https://github.com/windmill-labs/windmill/commit/c60df3c95661c5b2d03a850ca21ec1c9092d9bbb))
* **frontend:** make script and schema scrollable on script detail page ([f795a65](https://github.com/windmill-labs/windmill/commit/f795a65276bbc26728f6ba2ae0699fef6d18b1f1))
* **frontend:** new approval steps default to timeout 1800 ([9fbcfc7](https://github.com/windmill-labs/windmill/commit/9fbcfc712c981b8a1fee29a1d6b0eed136667e23))
* **frontend:** new resource type name must be snake case ([#4396](https://github.com/windmill-labs/windmill/issues/4396)) ([65dfad8](https://github.com/windmill-labs/windmill/commit/65dfad8275d9ccaf64aaaaffe265ad8bf3b507e4))
* **frontend:** prompt fix-AI not to rename existing variables ([#4382](https://github.com/windmill-labs/windmill/issues/4382)) ([e0a6cfa](https://github.com/windmill-labs/windmill/commit/e0a6cfaeacb32f067cebc5a950897143133b2aee))
* **frontend:** s3 file uploader works on public apps too ([64b5789](https://github.com/windmill-labs/windmill/commit/64b5789a201155badf9dcf10cd93560945b610d5))
* **frontend:** set unused schema property fields to null ([8a53bb0](https://github.com/windmill-labs/windmill/commit/8a53bb0e7a4430037ad9bc903c029b73b9b3a2a1))
* **frontend:** table footer display on safari ([#4377](https://github.com/windmill-labs/windmill/issues/4377)) ([5227a67](https://github.com/windmill-labs/windmill/commit/5227a6703549cf650a95f4cbf2bb9635ee1f51e6))
* **git-sync:** propagate update of folders with git sync ([3ec8720](https://github.com/windmill-labs/windmill/commit/3ec8720a65952ce869cb1d4d08f069c2a42b2df8))
* **go-client:** reduce runtime dependencies by bumping oai-codeen to v2.4.1 ([57f5fb8](https://github.com/windmill-labs/windmill/commit/57f5fb8c00376a6cbe732d04e3329e1dd01b5832))
* **go:** put shared directory in job dir and not go parent ([57a6bea](https://github.com/windmill-labs/windmill/commit/57a6beaed2c0a000248dbc134113bf640b1195b0))
* graceful worker exits for same worker jobs ([#4371](https://github.com/windmill-labs/windmill/issues/4371)) ([7d29651](https://github.com/windmill-labs/windmill/commit/7d29651d3ebe373d0a2e0e047ebe6803bbc97418))
* handle better same_worker flow monitor ([458dcfe](https://github.com/windmill-labs/windmill/commit/458dcfe1e8a20b33434bca10261ff5308d2923f7))
* **image:** correctly publish windmill-full image ([b060a1c](https://github.com/windmill-labs/windmill/commit/b060a1c39a66cf8b4d113fe56f0b239e1986692e))
* improve ability to paste from macos in vscode extension ([71c7811](https://github.com/windmill-labs/windmill/commit/71c7811d970d717f51369c53ed3d2c563bdc8fb6))
* improve allowed domains setting for sso ([cbd7a01](https://github.com/windmill-labs/windmill/commit/cbd7a016fec61c3a97e35c008d33b56acbf8d099))
* improve app reports puppeteer interactions ([fa2f5e1](https://github.com/windmill-labs/windmill/commit/fa2f5e1b3f233beaadc9c5ef7a7b0a664de6b7f2))
* improve app select propagation to list inputs in apps ([5a481e0](https://github.com/windmill-labs/windmill/commit/5a481e0a8ecd865c6fc9c9cd9659474d8f34ea81))
* improve cancelling of jobs on public apps for anonymous users ([4e90aab](https://github.com/windmill-labs/windmill/commit/4e90aab84977a65bea722f468cdc1dbf63bbc1a0))
* improve default properties of new nodes of flows (suspend, branchone, branchall) ([a359d86](https://github.com/windmill-labs/windmill/commit/a359d86c6cfdf65d41e3341df0513e1be851a463))
* improve dependency map to handle recusrive loops + handle better flow relative imports ([552f7d6](https://github.com/windmill-labs/windmill/commit/552f7d61a1ad75b931fec0b6b64a6246d7d00229))
* improve express oauth setup ([f5b6050](https://github.com/windmill-labs/windmill/commit/f5b6050d5d787ac3527736f66133a69027bf12aa))
* improve first time setup experience ([d533a01](https://github.com/windmill-labs/windmill/commit/d533a017a78bc799bee2d0a1a6e3d08e9c2d988b))
* improve handling of empty lock files on deno 2.0 ([9e31cce](https://github.com/windmill-labs/windmill/commit/9e31cceb999893055c2dad66bbf7f0fdbdbccae4))
* improve history navigation on the runs page ([dc0251b](https://github.com/windmill-labs/windmill/commit/dc0251b1be786bdb7101d105410cc967c8c2a568))
* improve password input for resources editor ([bc30996](https://github.com/windmill-labs/windmill/commit/bc30996188a3a34997fd001fee5d8fbd768eb422))
* improve runFlowAsync and run_flow_async default behavior + time formatting of scheduled for ([b5a9111](https://github.com/windmill-labs/windmill/commit/b5a9111d07646e8bfbb49edbfe8952b457d3f3ec))
* improve suspend_first behavior and frequency ([f189aaa](https://github.com/windmill-labs/windmill/commit/f189aaad5a6a356aac0c65fd08f6c28dd8aa0c99))
* improve user resource input ([ea98e6b](https://github.com/windmill-labs/windmill/commit/ea98e6b6badef06f7b65b65e6556662746721592))
* improve vscode extension handling of relative paths ([3e3b57f](https://github.com/windmill-labs/windmill/commit/3e3b57f203bc5852f0dc73a2ee90073863a1059f))
* improve wm_labels indices + UX nits ([84e18c7](https://github.com/windmill-labs/windmill/commit/84e18c73c084858cae935af0692482c8bb1d55e4))
* improve workflow as code row-lock on db to handle more concurrency ([8232b4c](https://github.com/windmill-labs/windmill/commit/8232b4cdb0c51fd9ed3f841b3f045cffb419367b))
* increase AI gen timeout + upgrade to 16k gpt4o ([#4340](https://github.com/windmill-labs/windmill/issues/4340)) ([04a3af8](https://github.com/windmill-labs/windmill/commit/04a3af8024ca31722359c1602f6037f673c2a818))
* initialize empty smtp settings correctly ([c2908e5](https://github.com/windmill-labs/windmill/commit/c2908e52c68103f5882dba896542f7f7fdec5cf7))
* integration_tests/requirements.txt to reduce vulnerabilities ([#4038](https://github.com/windmill-labs/windmill/issues/4038)) ([0dc9466](https://github.com/windmill-labs/windmill/commit/0dc9466dc1242b47a89484aa8176bbdb4fbf89b3))
* items with starred info ([#4298](https://github.com/windmill-labs/windmill/issues/4298)) ([304de14](https://github.com/windmill-labs/windmill/commit/304de146740611772b3c64962ed250d63808ae7a))
* llm/requirements.txt to reduce vulnerabilities ([#3965](https://github.com/windmill-labs/windmill/issues/3965)) ([660fb54](https://github.com/windmill-labs/windmill/commit/660fb549fb9f2ffb033cc519e61964c4cb99dcaa))
* llm/requirements.txt to reduce vulnerabilities ([#4313](https://github.com/windmill-labs/windmill/issues/4313)) ([fe67ab4](https://github.com/windmill-labs/windmill/commit/fe67ab444106f68cb6a048d8e9767c452a3e9c88))
* **lsp:** use ruff server instead of ruff-lsp ([db11c15](https://github.com/windmill-labs/windmill/commit/db11c15c3d09f939fe50911f6ce325ab337f99df))
* make form properties disablable ([ded73ff](https://github.com/windmill-labs/windmill/commit/ded73ff2968e4c203ea6c3eef6ab49b8e74ae23c))
* make select not reset on user changes in app + app css fix ([d225e80](https://github.com/windmill-labs/windmill/commit/d225e806b4f64e0341be9e79cc70c53a496e830e))
* migrate git sync to using bun based script ([9fb8c19](https://github.com/windmill-labs/windmill/commit/9fb8c195e89eca958979edafc6a48a28c8731f6b))
* migrate smtp instance settings to global settings ([#4416](https://github.com/windmill-labs/windmill/issues/4416)) ([efbcb1f](https://github.com/windmill-labs/windmill/commit/efbcb1ffdd5775f8dda192bcf8a84ea9f9319350))
* multiple secret picker candidates in resource adder ([770b475](https://github.com/windmill-labs/windmill/commit/770b475aa2a7b789173e0c5a7382f056cd53e7a3))
* nativets correct transform resources in args ([3e3f9dd](https://github.com/windmill-labs/windmill/commit/3e3f9dd74df2250231bb47231ef203079b0c26a0))
* no failed renewal alert if trial ([#4414](https://github.com/windmill-labs/windmill/issues/4414)) ([d318f10](https://github.com/windmill-labs/windmill/commit/d318f10f364068ab1249de783b731948706cf9bb))
* **nsjail:** improve memory reading when using nsjail ([d89877e](https://github.com/windmill-labs/windmill/commit/d89877e0baedde964c1f0306b2e82c4c23ae2362))
* parquet renderer display number of rows" ([#4389](https://github.com/windmill-labs/windmill/issues/4389)) ([307b46c](https://github.com/windmill-labs/windmill/commit/307b46cb9cca598b72bf8aeac61ce955214739e3))
* postgres scripts that take longer than 20s do not timeout anymore ([fc6e480](https://github.com/windmill-labs/windmill/commit/fc6e480e569fc74227c4f057d3547d2e36fe7e8e))
* prevent duplicate worker alerts ([#4309](https://github.com/windmill-labs/windmill/issues/4309)) ([6915ae6](https://github.com/windmill-labs/windmill/commit/6915ae6bfe61c860ac2907108efcb0b82501adde))
* **prometheus:** fix incorrect worker_busy set to 1 ([05ac6ba](https://github.com/windmill-labs/windmill/commit/05ac6ba0948c51b04f04910afb30eaad0c61052e))
* **python-client:** improve get_job_status for running jobs ([f39b16f](https://github.com/windmill-labs/windmill/commit/f39b16f3bb2116da98775d4cb2b9dd8cbb226472))
* **python-client:** only require httpx to be &gt;= 0.24 instead of ^0.24 ([50cd193](https://github.com/windmill-labs/windmill/commit/50cd1932740c408f201305e2b1f8fd899f802763))
* queue metrics graph ([#4388](https://github.com/windmill-labs/windmill/issues/4388)) ([6ca628c](https://github.com/windmill-labs/windmill/commit/6ca628c811ecb795d68335d592232395491f94c3))
* remove autocomplete for searchbar ([#4440](https://github.com/windmill-labs/windmill/issues/4440)) ([308d832](https://github.com/windmill-labs/windmill/commit/308d8322bde74f53eef6f834fd04251feb76d118))
* remove monaco-editor for app preview code path for faster app loads ([0902bec](https://github.com/windmill-labs/windmill/commit/0902bec9827997d68081afb6ef3bd94fffd31148))
* **s3:** align s3 handler additional creds providers ([557b949](https://github.com/windmill-labs/windmill/commit/557b949efe9de6b33d71df60bccf02632fcbe269))
* same worker is transitive on nested flows ([7a29c93](https://github.com/windmill-labs/windmill/commit/7a29c93bf86284cebc862ff8033cfaa938512460))
* show vCPU, mem aggregate on top of worker group ([9a4c883](https://github.com/windmill-labs/windmill/commit/9a4c883012912f43bde330702830092d47bd2c34))
* skip one migration to avoid using md5 for azure support ([f438d1a](https://github.com/windmill-labs/windmill/commit/f438d1adbe79fcc61fc34b086ab0ce2b2ed55e47))
* smtp server build without parquet feature ([#4292](https://github.com/windmill-labs/windmill/issues/4292)) ([8140166](https://github.com/windmill-labs/windmill/commit/814016687e64d0c6d7146b67eed7df1c4bb8915e))
* tighten inputs for granular kinds ([#4379](https://github.com/windmill-labs/windmill/issues/4379)) ([d3dc65b](https://github.com/windmill-labs/windmill/commit/d3dc65b740b73bafeef7130838b1d76d7adfab2e))
* tighten number input validity if min or max is set ([4a7b6aa](https://github.com/windmill-labs/windmill/commit/4a7b6aa77f8def056d3750a31c570bca9832eadd))
* time handling in bun and deno ([#4423](https://github.com/windmill-labs/windmill/issues/4423)) ([17f6e77](https://github.com/windmill-labs/windmill/commit/17f6e778534cec69e1d0030340bfa6d75a0d8d1d))
* timeout in pg executor on postgresql connection after 20s ([bef1bcb](https://github.com/windmill-labs/windmill/commit/bef1bcb2a4da24bd52a2e600d8c2929f2e15b02d))
* **ui:** dark mode support for queue metrics based critical alert ([#4535](https://github.com/windmill-labs/windmill/issues/4535)) ([09e0d30](https://github.com/windmill-labs/windmill/commit/09e0d309dca59ce11d5f964ed1fcd54c0ec36bcf))
* update bun to 1.1.27 ([ae61035](https://github.com/windmill-labs/windmill/commit/ae6103569afc361ae788198100c864f63f142d82))
* update bun to 1.1.31 and deno to 2.0.2 ([d7b8327](https://github.com/windmill-labs/windmill/commit/d7b83274db5ba89c6358a07ca0e2d8a4ec41e013))
* update bun to 1.1.32 ([#4568](https://github.com/windmill-labs/windmill/issues/4568)) ([1ae0338](https://github.com/windmill-labs/windmill/commit/1ae033841eb8def4456ad8117adbcb3aa7316994))
* update git sync script ([f96ae58](https://github.com/windmill-labs/windmill/commit/f96ae584f9692e369aefaf4ad23fb9631eb1dcfe))
* update internal deno runtime to latest (deno 2.0) ([5c51d86](https://github.com/windmill-labs/windmill/commit/5c51d86b6a21bd6a82aae9490bf7621d4f7b7b51))
* update internal hub scritps to bun ([#4384](https://github.com/windmill-labs/windmill/issues/4384)) ([7e01908](https://github.com/windmill-labs/windmill/commit/7e01908b3af4b2d0691fdf7748d0cca8fec1f27d))
* update monaco-editor to latest monaco/language-client ([#4285](https://github.com/windmill-labs/windmill/issues/4285)) ([557df4d](https://github.com/windmill-labs/windmill/commit/557df4dd56998f3e2d5599924566e353eea08e44))
* update pip to 24.2 and python 3.11.8-&gt;3.11.10 ([768d4b7](https://github.com/windmill-labs/windmill/commit/768d4b752edbcff4766c76b1ec9234dab2d9dd74))
* various improvements for ansible ([#4419](https://github.com/windmill-labs/windmill/issues/4419)) ([a7ef3ed](https://github.com/windmill-labs/windmill/commit/a7ef3ed293ec9a827ee0d37844bdcb269cc5e98f))
* windows.exe build with github workflow doesn't have openssl.dll bundled in ([#4489](https://github.com/windmill-labs/windmill/issues/4489)) ([86ccf9a](https://github.com/windmill-labs/windmill/commit/86ccf9a77d5e9f46644867a0ec11316300983f29))
