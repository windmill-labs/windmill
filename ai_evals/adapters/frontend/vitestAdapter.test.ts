...
vi.mock("$lib/gen", async () => {
  ...
  return {
    ...
    ScriptService: wrapService(actual.ScriptService, {
      ...
      getScriptByPath: async (data: {
        ...
        if (hasBenchmarkWorkspace(data.workspace)) {
          ...
          if (!script) {
            ...
            throw Object.assign(
              new Error(
                `Script "${data.path}" not found in benchmark workspace`,
              ),
              { status: 404 },
            );
          }
      ...
      getScriptByPathWithDraft: async (data: {
        workspace: string;
        path: string;
      }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
      ...
      getScriptByHash: async (data: { workspace: string; hash: string }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
          ...
          if (!script) {
            throw new Error(
              `Script hash "${data.hash}" not found in benchmark workspace`,
            );
          }
          return script;
        }
    ...
    FlowService: wrapService(actual.FlowService, {
      ...
      getFlowByPathWithDraft: async (data: {
        workspace: string;
        path: string;
      }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
          ...
          if (!flow) {
            throw new Error(
              `Flow "${data.path}" not found in benchmark workspace`,
            );
          }
          return flow;
        }
      ...
      getFlowLatestVersion: async (data: {
        workspace: string;
        path: string;
      }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
    ...
    JobService: wrapService(actual.JobService, {
      runScriptPreview: async (data: {
        ...
        return runBenchmarkScriptPreview({
          workspace: data.workspace,
          requestBody,
        });
      },
      ...
      getJob: async (data: { workspace: string; id: string }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
          ...
          if (!job) {
            throw new Error(
              `Job "${data.id}" not found in benchmark workspace`,
            );
          }
          return job;
        }
      ...
      getCompletedJobResultMaybe: async (data: {
        workspace: string;
        id: string;
      }) =>
        hasBenchmarkWorkspace(data.workspace)
    ...
    ScheduleService: wrapService(actual.ScheduleService, {
      existsSchedule: async (data: { workspace: string; path: string }) =>
        hasBenchmarkWorkspace(data.workspace)
          ? false
          : actual.ScheduleService.existsSchedule(data),
      listSchedules: async (data: { workspace: string }) =>
        hasBenchmarkWorkspace(data.workspace)
          ? []
          : actual.ScheduleService.listSchedules(data),
      getSchedule: async (data: { workspace: string; path: string }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
          throw new Error(
            `Schedule "${data.path}" not found in benchmark workspace`,
          );
        }
    ...
    ResourceService: wrapService(actual.ResourceService, {
      ...
      listResource: async (data: { workspace: string }) =>
        hasBenchmarkWorkspace(data.workspace)
          ? []
          : actual.ResourceService.listResource(data),
      getResource: async (data: { workspace: string; path: string }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
          throw new Error(
            `Resource "${data.path}" not found in benchmark workspace`,
          );
        }
    ...
    VariableService: wrapService(actual.VariableService, {
      ...
      getVariable: async (data: { workspace: string; path: string }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
          throw new Error(
            `Variable "${data.path}" not found in benchmark workspace`,
          );
        }
    ...
    HttpTriggerService: wrapService(actual.HttpTriggerService, {
      existsHttpTrigger: async (data: { workspace: string; path: string }) =>
        hasBenchmarkWorkspace(data.workspace)
          ? false
          : actual.HttpTriggerService.existsHttpTrigger(data),
      listHttpTriggers: async (data: { workspace: string }) =>
        hasBenchmarkWorkspace(data.workspace)
          ? []
          : actual.HttpTriggerService.listHttpTriggers(data),
      getHttpTrigger: async (data: { workspace: string; path: string }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
          throw new Error(
            `HTTP trigger "${data.path}" not found in benchmark workspace`,
          );
        }
        return actual.HttpTriggerService.getHttpTrigger(data);
      },
      createHttpTrigger: async (data: {
        workspace: string;
        requestBody: Record<string, unknown>;
      }) =>
        hasBenchmarkWorkspace(data.workspace)
    ...
    WebsocketTriggerService: wrapService(actual.WebsocketTriggerService, {
      existsWebsocketTrigger: async (data: {
        workspace: string;
        path: string;
      }) =>
        hasBenchmarkWorkspace(data.workspace)
      ...
      getWebsocketTrigger: async (data: {
        workspace: string;
        path: string;
      }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
          throw new Error(
            `Websocket trigger "${data.path}" not found in benchmark workspace`,
          );
        }
    ...
    KafkaTriggerService: wrapService(actual.KafkaTriggerService, {
      ...
      listKafkaTriggers: async (data: { workspace: string }) =>
        hasBenchmarkWorkspace(data.workspace)
          ? []
          : actual.KafkaTriggerService.listKafkaTriggers(data),
      getKafkaTrigger: async (data: { workspace: string; path: string }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
          throw new Error(
            `Kafka trigger "${data.path}" not found in benchmark workspace`,
          );
        }
    ...
    NatsTriggerService: wrapService(actual.NatsTriggerService, {
      existsNatsTrigger: async (data: { workspace: string; path: string }) =>
        hasBenchmarkWorkspace(data.workspace)
          ? false
          : actual.NatsTriggerService.existsNatsTrigger(data),
      listNatsTriggers: async (data: { workspace: string }) =>
        hasBenchmarkWorkspace(data.workspace)
          ? []
          : actual.NatsTriggerService.listNatsTriggers(data),
      getNatsTrigger: async (data: { workspace: string; path: string }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
          throw new Error(
            `NATS trigger "${data.path}" not found in benchmark workspace`,
          );
        }
    ...
    PostgresTriggerService: wrapService(actual.PostgresTriggerService, {
      existsPostgresTrigger: async (data: {
        workspace: string;
        path: string;
      }) =>
        hasBenchmarkWorkspace(data.workspace)
      ...
      getPostgresTrigger: async (data: { workspace: string; path: string }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
          throw new Error(
            `Postgres trigger "${data.path}" not found in benchmark workspace`,
          );
        }
    ...
    MqttTriggerService: wrapService(actual.MqttTriggerService, {
      existsMqttTrigger: async (data: { workspace: string; path: string }) =>
        hasBenchmarkWorkspace(data.workspace)
          ? false
          : actual.MqttTriggerService.existsMqttTrigger(data),
      listMqttTriggers: async (data: { workspace: string }) =>
        hasBenchmarkWorkspace(data.workspace)
          ? []
          : actual.MqttTriggerService.listMqttTriggers(data),
      getMqttTrigger: async (data: { workspace: string; path: string }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
          throw new Error(
            `MQTT trigger "${data.path}" not found in benchmark workspace`,
          );
        }
    ...
    SqsTriggerService: wrapService(actual.SqsTriggerService, {
      existsSqsTrigger: async (data: { workspace: string; path: string }) =>
        hasBenchmarkWorkspace(data.workspace)
          ? false
          : actual.SqsTriggerService.existsSqsTrigger(data),
      listSqsTriggers: async (data: { workspace: string }) =>
        hasBenchmarkWorkspace(data.workspace)
          ? []
          : actual.SqsTriggerService.listSqsTriggers(data),
      getSqsTrigger: async (data: { workspace: string; path: string }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
          throw new Error(
            `SQS trigger "${data.path}" not found in benchmark workspace`,
          );
        }
    ...
    GcpTriggerService: wrapService(actual.GcpTriggerService, {
      existsGcpTrigger: async (data: { workspace: string; path: string }) =>
        hasBenchmarkWorkspace(data.workspace)
          ? false
          : actual.GcpTriggerService.existsGcpTrigger(data),
      listGcpTriggers: async (data: { workspace: string }) =>
        hasBenchmarkWorkspace(data.workspace)
          ? []
          : actual.GcpTriggerService.listGcpTriggers(data),
      getGcpTrigger: async (data: { workspace: string; path: string }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
          throw new Error(
            `GCP trigger "${data.path}" not found in benchmark workspace`,
          );
        }
    ...
    AzureTriggerService: wrapService(actual.AzureTriggerService, {
      ...
      listAzureTriggers: async (data: { workspace: string }) =>
        hasBenchmarkWorkspace(data.workspace)
          ? []
          : actual.AzureTriggerService.listAzureTriggers(data),
      getAzureTrigger: async (data: { workspace: string; path: string }) => {
        if (hasBenchmarkWorkspace(data.workspace)) {
          throw new Error(
            `Azure trigger "${data.path}" not found in benchmark workspace`,
          );
        }
