...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[List['ListWorkspacesAsSuperAdminResponse200Item']]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[List['ListWorkspacesAsSuperAdminResponse200Item']]:
    return Response(
