...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "/w/{workspace}/resources/list".format(workspace=workspace,),
        "params": params,
    }


def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[List['ListResourceResponse200Item']]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[List['ListResourceResponse200Item']]:
    return Response(
