...
if TYPE_CHECKING:
  from ..models.open_flow_value_modules_item_suspend_user_groups_required_type_0 import OpenFlowValueModulesItemSuspendUserGroupsRequiredType0
  from ..models.open_flow_value_modules_item_suspend_resume_form import OpenFlowValueModulesItemSuspendResumeForm
  from ..models.open_flow_value_modules_item_suspend_user_groups_required_type_1 import OpenFlowValueModulesItemSuspendUserGroupsRequiredType1
...
class OpenFlowValueModulesItemSuspend:
    ...
    user_groups_required: Union['OpenFlowValueModulesItemSuspendUserGroupsRequiredType0', 'OpenFlowValueModulesItemSuspendUserGroupsRequiredType1', Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_user_groups_required(data: object) -> Union['OpenFlowValueModulesItemSuspendUserGroupsRequiredType0', 'OpenFlowValueModulesItemSuspendUserGroupsRequiredType1', Unset]:
            ...
            try:
                ...
                if isinstance(_user_groups_required_type_0,  Unset):
                    ...
                    user_groups_required_type_0 = OpenFlowValueModulesItemSuspendUserGroupsRequiredType0.from_dict(_user_groups_required_type_0)
            ...
            if isinstance(_user_groups_required_type_1,  Unset):
                ...
                user_groups_required_type_1 = OpenFlowValueModulesItemSuspendUserGroupsRequiredType1.from_dict(_user_groups_required_type_1)
