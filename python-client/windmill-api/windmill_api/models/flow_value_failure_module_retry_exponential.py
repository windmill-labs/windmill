...
T = TypeVar("T", bound="FlowValueFailureModuleRetryExponential")


@attr.s(auto_attribs=True)
class FlowValueFailureModuleRetryExponential:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_value_failure_module_retry_exponential = cls(
            attempts=attempts,
            multiplier=multiplier,
            seconds=seconds,
        )

        flow_value_failure_module_retry_exponential.additional_properties = d
