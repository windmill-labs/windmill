...
from ..models.list_queue_response_200_item_raw_flow_failure_module_suspend_user_groups_required_type_1_type import ListQueueResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType1Type
...
class ListQueueResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType1:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_queue_response_200_item_raw_flow_failure_module_suspend_user_groups_required_type_1.additional_properties = d
