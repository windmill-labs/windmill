...
if TYPE_CHECKING:
  from ..models.list_queue_response_200_item_raw_flow_modules_item_suspend_user_groups_required_type_1 import ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType1
  from ..models.list_queue_response_200_item_raw_flow_modules_item_suspend_resume_form import ListQueueResponse200ItemRawFlowModulesItemSuspendResumeForm
  from ..models.list_queue_response_200_item_raw_flow_modules_item_suspend_user_groups_required_type_0 import ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0
...
class ListQueueResponse200ItemRawFlowModulesItemSuspend:
    ...
    user_groups_required: Union['ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0', 'ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType1', Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_user_groups_required(data: object) -> Union['ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0', 'ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType1', Unset]:
            ...
            try:
                ...
                user_groups_required_type_0: Union[Unset, ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0]
                if isinstance(_user_groups_required_type_0,  Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType0.from_dict(_user_groups_required_type_0)
            ...
            user_groups_required_type_1: Union[Unset, ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType1]
            if isinstance(_user_groups_required_type_1,  Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = ListQueueResponse200ItemRawFlowModulesItemSuspendUserGroupsRequiredType1.from_dict(_user_groups_required_type_1)
