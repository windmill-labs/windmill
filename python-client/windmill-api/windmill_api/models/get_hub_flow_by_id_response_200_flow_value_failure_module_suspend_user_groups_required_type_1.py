...
from ..models.get_hub_flow_by_id_response_200_flow_value_failure_module_suspend_user_groups_required_type_1_type import GetHubFlowByIdResponse200FlowValueFailureModuleSuspendUserGroupsRequiredType1Type
...
class GetHubFlowByIdResponse200FlowValueFailureModuleSuspendUserGroupsRequiredType1:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_hub_flow_by_id_response_200_flow_value_failure_module_suspend_user_groups_required_type_1.additional_properties = d
