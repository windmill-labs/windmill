...
from ..types import UNSET, Unset
from ..models.get_completed_job_response_200_flow_status_failure_module_type import GetCompletedJobResponse200FlowStatusFailureModuleType

if TYPE_CHECKING:
  from ..models.get_completed_job_response_200_flow_status_failure_module_approvers_item import GetCompletedJobResponse200FlowStatusFailureModuleApproversItem
  from ..models.get_completed_job_response_200_flow_status_failure_module_iterator import GetCompletedJobResponse200FlowStatusFailureModuleIterator
  from ..models.get_completed_job_response_200_flow_status_failure_module_branchall import GetCompletedJobResponse200FlowStatusFailureModuleBranchall
  from ..models.get_completed_job_response_200_flow_status_failure_module_branch_chosen import GetCompletedJobResponse200FlowStatusFailureModuleBranchChosen
...
class GetCompletedJobResponse200FlowStatusFailureModule:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for approvers_item_data in (_approvers or []):
            approvers_item = GetCompletedJobResponse200FlowStatusFailureModuleApproversItem.from_dict(approvers_item_data)
