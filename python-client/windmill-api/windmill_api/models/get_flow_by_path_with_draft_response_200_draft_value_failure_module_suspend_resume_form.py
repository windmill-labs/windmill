...
if TYPE_CHECKING:
  from ..models.get_flow_by_path_with_draft_response_200_draft_value_failure_module_suspend_resume_form_schema import GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendResumeFormSchema
...
class GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendResumeForm:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_flow_by_path_with_draft_response_200_draft_value_failure_module_suspend_resume_form.additional_properties = d
