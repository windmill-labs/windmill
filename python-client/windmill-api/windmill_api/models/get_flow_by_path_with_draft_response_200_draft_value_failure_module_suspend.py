...
if TYPE_CHECKING:
  from ..models.get_flow_by_path_with_draft_response_200_draft_value_failure_module_suspend_resume_form import GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendResumeForm
  from ..models.get_flow_by_path_with_draft_response_200_draft_value_failure_module_suspend_user_groups_required_type_0 import GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType0
  from ..models.get_flow_by_path_with_draft_response_200_draft_value_failure_module_suspend_user_groups_required_type_1 import GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType1
...
class GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspend:
    ...
    user_groups_required: Union['GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType0', 'GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType1', Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_resume_form,  Unset):
            ...
            resume_form = GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendResumeForm.from_dict(_resume_form)
        ...
        def _parse_user_groups_required(data: object) -> Union['GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType0', 'GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType1', Unset]:
            ...
            try:
                ...
                user_groups_required_type_0: Union[Unset, GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType0]
                if isinstance(_user_groups_required_type_0,  Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType0.from_dict(_user_groups_required_type_0)
            ...
            user_groups_required_type_1: Union[Unset, GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType1]
            if isinstance(_user_groups_required_type_1,  Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = GetFlowByPathWithDraftResponse200DraftValueFailureModuleSuspendUserGroupsRequiredType1.from_dict(_user_groups_required_type_1)
