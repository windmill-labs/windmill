...
if TYPE_CHECKING:
  from ..models.create_app_json_body_policy_triggerables_additional_property import CreateAppJsonBodyPolicyTriggerablesAdditionalProperty
...
class CreateAppJsonBodyPolicyTriggerables:
    ...
    additional_properties: Dict[str, 'CreateAppJsonBodyPolicyTriggerablesAdditionalProperty'] = _attrs_field(init=False, factory=dict)
