...
T = TypeVar("T", bound="FlowValueModulesItemRetryExponential")


@attr.s(auto_attribs=True)
class FlowValueModulesItemRetryExponential:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        flow_value_modules_item_retry_exponential = cls(
            attempts=attempts,
            multiplier=multiplier,
            seconds=seconds,
        )

        flow_value_modules_item_retry_exponential.additional_properties = d
        return flow_value_modules_item_retry_exponential
