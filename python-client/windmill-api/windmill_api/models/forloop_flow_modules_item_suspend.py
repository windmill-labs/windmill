...
if TYPE_CHECKING:
  from ..models.forloop_flow_modules_item_suspend_user_groups_required_type_0 import ForloopFlowModulesItemSuspendUserGroupsRequiredType0
  from ..models.forloop_flow_modules_item_suspend_user_groups_required_type_1 import ForloopFlowModulesItemSuspendUserGroupsRequiredType1
...
class ForloopFlowModulesItemSuspend:
    ...
    user_groups_required: Union['ForloopFlowModulesItemSuspendUserGroupsRequiredType0', 'ForloopFlowModulesItemSuspendUserGroupsRequiredType1', Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_user_groups_required(data: object) -> Union['ForloopFlowModulesItemSuspendUserGroupsRequiredType0', 'ForloopFlowModulesItemSuspendUserGroupsRequiredType1', Unset]:
            ...
            try:
                ...
                if isinstance(_user_groups_required_type_0,  Unset):
                    ...
                    user_groups_required_type_0 = ForloopFlowModulesItemSuspendUserGroupsRequiredType0.from_dict(_user_groups_required_type_0)
            ...
            if isinstance(_user_groups_required_type_1,  Unset):
                ...
                user_groups_required_type_1 = ForloopFlowModulesItemSuspendUserGroupsRequiredType1.from_dict(_user_groups_required_type_1)
