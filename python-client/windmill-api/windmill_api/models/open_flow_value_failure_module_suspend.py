...
class OpenFlowValueFailureModuleSuspend:
    ...
    user_groups_required: Union['OpenFlowValueFailureModuleSuspendUserGroupsRequiredType0', 'OpenFlowValueFailureModuleSuspendUserGroupsRequiredType1', Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_user_groups_required(data: object) -> Union['OpenFlowValueFailureModuleSuspendUserGroupsRequiredType0', 'OpenFlowValueFailureModuleSuspendUserGroupsRequiredType1', Unset]:
            ...
            try:
                ...
                if isinstance(_user_groups_required_type_0,  Unset):
                    ...
                    user_groups_required_type_0 = OpenFlowValueFailureModuleSuspendUserGroupsRequiredType0.from_dict(_user_groups_required_type_0)
            ...
            if isinstance(_user_groups_required_type_1,  Unset):
                ...
                user_groups_required_type_1 = OpenFlowValueFailureModuleSuspendUserGroupsRequiredType1.from_dict(_user_groups_required_type_1)
