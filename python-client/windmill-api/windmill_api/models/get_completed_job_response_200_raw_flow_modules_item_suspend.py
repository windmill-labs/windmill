...
if TYPE_CHECKING:
  from ..models.get_completed_job_response_200_raw_flow_modules_item_suspend_user_groups_required_type_1 import GetCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType1
  from ..models.get_completed_job_response_200_raw_flow_modules_item_suspend_resume_form import GetCompletedJobResponse200RawFlowModulesItemSuspendResumeForm
...
class GetCompletedJobResponse200RawFlowModulesItemSuspend:
    ...
    user_groups_required: Union['GetCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType0', 'GetCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType1', Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, GetCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_user_groups_required(data: object) -> Union['GetCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType0', 'GetCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType1', Unset]:
            ...
            try:
                ...
                user_groups_required_type_0: Union[Unset, GetCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType0]
                if isinstance(_user_groups_required_type_0,  Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = GetCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType0.from_dict(_user_groups_required_type_0)
            ...
            user_groups_required_type_1: Union[Unset, GetCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType1]
            if isinstance(_user_groups_required_type_1,  Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = GetCompletedJobResponse200RawFlowModulesItemSuspendUserGroupsRequiredType1.from_dict(_user_groups_required_type_1)
