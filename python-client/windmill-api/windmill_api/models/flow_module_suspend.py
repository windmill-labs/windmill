...
class FlowModuleSuspend:
    ...
    user_groups_required: Union['FlowModuleSuspendUserGroupsRequiredType0', 'FlowModuleSuspendUserGroupsRequiredType1', Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_user_groups_required(data: object) -> Union['FlowModuleSuspendUserGroupsRequiredType0', 'FlowModuleSuspendUserGroupsRequiredType1', Unset]:
            ...
            try:
                ...
                if isinstance(_user_groups_required_type_0,  Unset):
                    ...
                    user_groups_required_type_0 = FlowModuleSuspendUserGroupsRequiredType0.from_dict(_user_groups_required_type_0)
            ...
            if isinstance(_user_groups_required_type_1,  Unset):
                ...
                user_groups_required_type_1 = FlowModuleSuspendUserGroupsRequiredType1.from_dict(_user_groups_required_type_1)
