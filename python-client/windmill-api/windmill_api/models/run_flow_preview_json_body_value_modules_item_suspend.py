...
if TYPE_CHECKING:
  from ..models.run_flow_preview_json_body_value_modules_item_suspend_user_groups_required_type_0 import RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType0
  from ..models.run_flow_preview_json_body_value_modules_item_suspend_user_groups_required_type_1 import RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType1
  from ..models.run_flow_preview_json_body_value_modules_item_suspend_resume_form import RunFlowPreviewJsonBodyValueModulesItemSuspendResumeForm
...
class RunFlowPreviewJsonBodyValueModulesItemSuspend:
    ...
    user_groups_required: Union['RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType0', 'RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType1', Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_user_groups_required(data: object) -> Union['RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType0', 'RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType1', Unset]:
            ...
            try:
                ...
                user_groups_required_type_0: Union[Unset, RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType0]
                if isinstance(_user_groups_required_type_0,  Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType0.from_dict(_user_groups_required_type_0)
            ...
            user_groups_required_type_1: Union[Unset, RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType1]
            if isinstance(_user_groups_required_type_1,  Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = RunFlowPreviewJsonBodyValueModulesItemSuspendUserGroupsRequiredType1.from_dict(_user_groups_required_type_1)
