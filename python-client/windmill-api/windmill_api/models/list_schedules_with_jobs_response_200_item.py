...
if TYPE_CHECKING:
  ...
  from ..models.list_schedules_with_jobs_response_200_item_on_failure_extra_args import ListSchedulesWithJobsResponse200ItemOnFailureExtraArgs
  from ..models.list_schedules_with_jobs_response_200_item_extra_perms import ListSchedulesWithJobsResponse200ItemExtraPerms
  ...
  from ..models.list_schedules_with_jobs_response_200_item_on_recovery_extra_args import ListSchedulesWithJobsResponse200ItemOnRecoveryExtraArgs
...
class ListSchedulesWithJobsResponse200Item:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_on_failure_extra_args,  Unset):
            ...
            on_failure_extra_args = ListSchedulesWithJobsResponse200ItemOnFailureExtraArgs.from_dict(_on_failure_extra_args)
        ...
        if isinstance(_on_recovery_extra_args,  Unset):
            ...
            on_recovery_extra_args = ListSchedulesWithJobsResponse200ItemOnRecoveryExtraArgs.from_dict(_on_recovery_extra_args)
