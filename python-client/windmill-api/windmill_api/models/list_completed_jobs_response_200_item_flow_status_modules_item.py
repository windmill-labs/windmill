...
from ..models.list_completed_jobs_response_200_item_flow_status_modules_item_type import ListCompletedJobsResponse200ItemFlowStatusModulesItemType
from typing import Dict
from ..types import UNSET, Unset

if TYPE_CHECKING:
  from ..models.list_completed_jobs_response_200_item_flow_status_modules_item_approvers_item import ListCompletedJobsResponse200ItemFlowStatusModulesItemApproversItem
  from ..models.list_completed_jobs_response_200_item_flow_status_modules_item_iterator import ListCompletedJobsResponse200ItemFlowStatusModulesItemIterator
  from ..models.list_completed_jobs_response_200_item_flow_status_modules_item_branchall import ListCompletedJobsResponse200ItemFlowStatusModulesItemBranchall
  from ..models.list_completed_jobs_response_200_item_flow_status_modules_item_branch_chosen import ListCompletedJobsResponse200ItemFlowStatusModulesItemBranchChosen
...
class ListCompletedJobsResponse200ItemFlowStatusModulesItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for approvers_item_data in (_approvers or []):
            approvers_item = ListCompletedJobsResponse200ItemFlowStatusModulesItemApproversItem.from_dict(approvers_item_data)
