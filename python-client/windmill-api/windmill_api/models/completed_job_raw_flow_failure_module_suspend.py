...
if TYPE_CHECKING:
  from ..models.completed_job_raw_flow_failure_module_suspend_user_groups_required_type_0 import CompletedJobRawFlowFailureModuleSuspendUserGroupsRequiredType0
  from ..models.completed_job_raw_flow_failure_module_suspend_user_groups_required_type_1 import CompletedJobRawFlowFailureModuleSuspendUserGroupsRequiredType1
  from ..models.completed_job_raw_flow_failure_module_suspend_resume_form import CompletedJobRawFlowFailureModuleSuspendResumeForm
...
class CompletedJobRawFlowFailureModuleSuspend:
    ...
    user_groups_required: Union['CompletedJobRawFlowFailureModuleSuspendUserGroupsRequiredType0', 'CompletedJobRawFlowFailureModuleSuspendUserGroupsRequiredType1', Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_user_groups_required(data: object) -> Union['CompletedJobRawFlowFailureModuleSuspendUserGroupsRequiredType0', 'CompletedJobRawFlowFailureModuleSuspendUserGroupsRequiredType1', Unset]:
            ...
            try:
                ...
                user_groups_required_type_0: Union[Unset, CompletedJobRawFlowFailureModuleSuspendUserGroupsRequiredType0]
                if isinstance(_user_groups_required_type_0,  Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = CompletedJobRawFlowFailureModuleSuspendUserGroupsRequiredType0.from_dict(_user_groups_required_type_0)
            ...
            if isinstance(_user_groups_required_type_1,  Unset):
                ...
                user_groups_required_type_1 = CompletedJobRawFlowFailureModuleSuspendUserGroupsRequiredType1.from_dict(_user_groups_required_type_1)
