...
if TYPE_CHECKING:
  from ..models.list_completed_jobs_response_200_item_raw_flow_failure_module_suspend_resume_form import ListCompletedJobsResponse200ItemRawFlowFailureModuleSuspendResumeForm
  from ..models.list_completed_jobs_response_200_item_raw_flow_failure_module_suspend_user_groups_required_type_0 import ListCompletedJobsResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType0
  from ..models.list_completed_jobs_response_200_item_raw_flow_failure_module_suspend_user_groups_required_type_1 import ListCompletedJobsResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType1
...
class ListCompletedJobsResponse200ItemRawFlowFailureModuleSuspend:
    ...
    user_groups_required: Union['ListCompletedJobsResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType0', 'ListCompletedJobsResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType1', Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        elif isinstance(self.user_groups_required, ListCompletedJobsResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType0):
            user_groups_required = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_user_groups_required(data: object) -> Union['ListCompletedJobsResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType0', 'ListCompletedJobsResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType1', Unset]:
            ...
            try:
                ...
                user_groups_required_type_0: Union[Unset, ListCompletedJobsResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType0]
                if isinstance(_user_groups_required_type_0,  Unset):
                    user_groups_required_type_0 = UNSET
                else:
                    user_groups_required_type_0 = ListCompletedJobsResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType0.from_dict(_user_groups_required_type_0)
            ...
            user_groups_required_type_1: Union[Unset, ListCompletedJobsResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType1]
            if isinstance(_user_groups_required_type_1,  Unset):
                user_groups_required_type_1 = UNSET
            else:
                user_groups_required_type_1 = ListCompletedJobsResponse200ItemRawFlowFailureModuleSuspendUserGroupsRequiredType1.from_dict(_user_groups_required_type_1)
