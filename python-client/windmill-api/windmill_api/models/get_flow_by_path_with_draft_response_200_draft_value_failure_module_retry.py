...
if TYPE_CHECKING:
  from ..models.get_flow_by_path_with_draft_response_200_draft_value_failure_module_retry_constant import GetFlowByPathWithDraftResponse200DraftValueFailureModuleRetryConstant
  from ..models.get_flow_by_path_with_draft_response_200_draft_value_failure_module_retry_exponential import GetFlowByPathWithDraftResponse200DraftValueFailureModuleRetryExponential
...
class GetFlowByPathWithDraftResponse200DraftValueFailureModuleRetry:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_exponential,  Unset):
            ...
            exponential = GetFlowByPathWithDraftResponse200DraftValueFailureModuleRetryExponential.from_dict(_exponential)
