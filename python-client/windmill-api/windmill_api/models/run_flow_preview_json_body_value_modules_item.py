...
if TYPE_CHECKING:
  ...
  from ..models.run_flow_preview_json_body_value_modules_item_stop_after_if import RunFlowPreviewJsonBodyValueModulesItemStopAfterIf
  from ..models.run_flow_preview_json_body_value_modules_item_retry import RunFlowPreviewJsonBodyValueModulesItemRetry
  from ..models.run_flow_preview_json_body_value_modules_item_sleep_type_1 import RunFlowPreviewJsonBodyValueModulesItemSleepType1
...
class RunFlowPreviewJsonBodyValueModulesItem:
    ...
    sleep: Union['RunFlowPreviewJsonBodyValueModulesItemSleepType0', 'RunFlowPreviewJsonBodyValueModulesItemSleepType1', Unset] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_sleep(data: object) -> Union['RunFlowPreviewJsonBodyValueModulesItemSleepType0', 'RunFlowPreviewJsonBodyValueModulesItemSleepType1', Unset]:
