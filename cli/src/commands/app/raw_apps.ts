...
import { colors, log, SEP, Table, yamlParseFile } from "../../../deps.ts";
import * as wmill from "../../../gen/services.gen.ts";
import { Policy } from "../../../gen/types.gen.ts";

import { GlobalOptions, isSuperset } from "../../types.ts";

import { generatingPolicy, replaceInlineScripts } from "./apps.ts";
...
export async function pushRawApp(
  ...
  const runnables = localApp.value.runnables;
