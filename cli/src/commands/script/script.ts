...
async function setPermissionedAs(
  ...
  await wmill.createScript({
    ...
    requestBody: {
      ...
      ws_error_handler_muted: remote.ws_error_handler_muted,
      dedicated_worker: remote.dedicated_worker,
      cache_ttl: remote.cache_ttl,
      concurrent_limit: remote.concurrent_limit,
      concurrency_time_window_s: remote.concurrency_time_window_s,
      concurrency_key: (remote as any).concurrency_key,
      restart_unless_cancelled: remote.restart_unless_cancelled,
      visible_to_runner_only: remote.visible_to_runner_only,
      has_preprocessor: remote.has_preprocessor,
      timeout: remote.timeout,
      priority: remote.priority,
      envs: remote.envs,
      codebase: remote.codebase ?? undefined,
    },
  });
