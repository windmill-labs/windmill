...
var http_internal = require('./internal.js');
...
class Server {
    constructor(impl, options) {
        ...
        if (env.isDeno) {
            ...
            if (this.type === "classic") {
                let bindings;
                if (runtime.default().identity === "workerd") {
                    bindings = {};
                ...
                http_internal.listenFetchEvent({ ws, fetch: handle, onError, headers, bindings });
            }
            else {
     ...
     */
    get port() {
        return this[_port] || (env.isBun && this.type === "module" ? 3000 : 0);
    }
    /**
    ...
    async close(force = false) {
        ...
        if (typeof server.stop === "function") {
            ...
            _server.stop(force);
            if (!force) {
                await async.until(() => !_server.pendingRequests && !_server.pendingWebSockets);
            }
        }
