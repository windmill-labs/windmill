...
var bytes$1 = require('./bytes.js');
var string_constants = require('./string/constants.js');
...
function chunk(str, length) {
    return array_base.chunk(str, length);
}
/**
...
function byteLength(str) {
    return bytes$1.default(str).byteLength;
}
...
function isEmoji(str) {
    return chars(str).every((char) => string_constants.EMOJI_CHAR.test(char));
}
