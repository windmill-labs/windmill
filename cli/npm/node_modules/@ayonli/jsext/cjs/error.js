...
function toObject(err) {
    ...
    const obj = {
        ...
        ...object.omit(err, ["toString", "toJSON", "__callSiteEvals"]),
    };
...
function fromObject(obj, ctor = undefined) {
    ...
    if (isAggregateError(err) && Array.isArray(err["errors"])) {
        err["errors"] = err["errors"].map(item => {
            return object.isPlainObject(item) ? fromObject(item) : item;
        });
    }
    return err;
}
...
function toErrorEvent(err, type = "error") {
    ...
    return event.createErrorEvent(type, {
        error: err,
        message: err.message,
        filename,
        lineno,
...
exports.Exception = error_Exception.default;
exports.fromErrorEvent = fromErrorEvent;
