...
function runtime() {
    ...
    if (env$1.isDeno) {
        return {
            ...
            fsSupport: true,
            tsSupport: true,
            worker: env$1.isMainThread ? undefined : "dedicated",
        };
    }
    else if (env$1.isBun) {
        return {
    ...
    const worker = env$1.isSharedWorker ? "shared"
        : env$1.isServiceWorker ? "service"
            : env$1.isDedicatedWorker ? "dedicated"
                : undefined;
    if (typeof navigator === "object" && typeof navigator.userAgent === "string") {
        const ua = http_userAgent.parseUserAgent(navigator.userAgent);
        if (ua.runtime) {
...
function platform() {
    if (env$1.isDeno) {
        ...
        return http_userAgent.parseUserAgent(navigator.userAgent).platform;
    }
    return "unknown";
}
const ENV = {};
...
function refTimer(timer) {
    ...
    else if (typeof timer === "number" && env$1.isDeno) {
        Deno.refTimer(timer);
    }
}
/**
...
function addShutdownListener(fn) {
    if (!env$1.isDeno && !env$1.isNodeLike) {
        return;
    }
    ...
    const shutdownListener = async () => {
        try {
            const event$1 = event.createCloseEvent("shutdown", {
                cancelable: true,
                code: 0,
...
exports.WellknownPlatforms = WellknownPlatforms;
exports.WellknownRuntimes = WellknownRuntimes;
exports.addShutdownListener = addShutdownListener;
exports.addUnhandledRejectionListener = addUnhandledRejectionListener;
exports.customInspect = customInspect;
exports.default = runtime;
exports.env = env;
exports.isREPL = isREPL;
exports.platform = platform;
exports.refTimer = refTimer;
