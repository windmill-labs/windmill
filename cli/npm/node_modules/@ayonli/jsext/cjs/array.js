...
var array_base = require('./array/base.js');
...
function random(arr, remove = false) {
    ...
    const i = number.random(0, arr.length - 1);
    if (remove) {
...
function count(arr, item) {
    return array_base.count(arr, item);
}
/**
...
function equals(arr1, arr2) {
    return array_base.equals(arr1, arr2);
}
/**
...
function includesSlice(arr, slice) {
    return array_base.includeSlice(arr, slice);
}
/**
...
function startsWith(arr, prefix) {
    return array_base.startsWith(arr, prefix);
}
/**
...
function endsWith(arr, suffix) {
    return array_base.endsWith(arr, suffix);
}
/**
...
function split(arr, delimiter) {
    return array_base.split(arr, delimiter);
}
/**
...
function chunk(arr, length) {
    return array_base.chunk(arr, length);
}
/**
...
function groupBy(arr, fn, type = Object) {
    if (type === Map || _class.isSubclassOf(type, Map)) {
...
exports.includesSlice = includesSlice;
exports.keyBy = keyBy;
exports.last = last;
