...
export declare class SettingService {
     ...
     * @throws ApiError
     */
    static renewLicenseKey(): CancelablePromise<RenewLicenseKeyResponse>;
    /**
     * create customer portal session
     * @returns string url to portal
     * @throws ApiError
     */
    static createCustomerPortalSession(): CancelablePromise<CreateCustomerPortalSessionResponse>;
    /**
     * test metadata
     * @param data The data for the request.
