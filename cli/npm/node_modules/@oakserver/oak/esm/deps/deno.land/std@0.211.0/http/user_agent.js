...
export class UserAgent {
    ...
    constructor(ua) {
        ...
        __classPrivateFieldSet(this, _UserAgent_ua, ua ?? "", "f");
    }
    /** The name and version of the browser extracted from the user agent
     * string. */
    get browser() {
        if (!__classPrivateFieldGet(this, _UserAgent_browser, "f")) {
            __classPrivateFieldSet(this, _UserAgent_browser, { name: undefined, version: undefined, major: undefined }, "f");
            mapper(__classPrivateFieldGet(this, _UserAgent_browser, "f"), __classPrivateFieldGet(this, _UserAgent_ua, "f"), matchers.browser);
            // deno-lint-ignore no-explicit-any
            __classPrivateFieldGet(this, _UserAgent_browser, "f").major = majorize(__classPrivateFieldGet(this, _UserAgent_browser, "f").version);
            Object.freeze(__classPrivateFieldGet(this, _UserAgent_browser, "f"));
        }
        return __classPrivateFieldGet(this, _UserAgent_browser, "f");
    }
    /** The architecture of the CPU extracted from the user agent string. */
    get cpu() {
        if (!__classPrivateFieldGet(this, _UserAgent_cpu, "f")) {
            __classPrivateFieldSet(this, _UserAgent_cpu, { architecture: undefined }, "f");
            mapper(__classPrivateFieldGet(this, _UserAgent_cpu, "f"), __classPrivateFieldGet(this, _UserAgent_ua, "f"), matchers.cpu);
            Object.freeze(__classPrivateFieldGet(this, _UserAgent_cpu, "f"));
        }
        return __classPrivateFieldGet(this, _UserAgent_cpu, "f");
    }
    /** The model, type, and vendor of a device if present in a user agent
     * string. */
    get device() {
        if (!__classPrivateFieldGet(this, _UserAgent_device, "f")) {
            __classPrivateFieldSet(this, _UserAgent_device, { model: undefined, type: undefined, vendor: undefined }, "f");
            mapper(__classPrivateFieldGet(this, _UserAgent_device, "f"), __classPrivateFieldGet(this, _UserAgent_ua, "f"), matchers.device);
            Object.freeze(__classPrivateFieldGet(this, _UserAgent_device, "f"));
        }
        return __classPrivateFieldGet(this, _UserAgent_device, "f");
    }
    /** The name and version of the browser engine in a user agent string. */
    get engine() {
        if (!__classPrivateFieldGet(this, _UserAgent_engine, "f")) {
            __classPrivateFieldSet(this, _UserAgent_engine, { name: undefined, version: undefined }, "f");
            mapper(__classPrivateFieldGet(this, _UserAgent_engine, "f"), __classPrivateFieldGet(this, _UserAgent_ua, "f"), matchers.engine);
            Object.freeze(__classPrivateFieldGet(this, _UserAgent_engine, "f"));
        }
        return __classPrivateFieldGet(this, _UserAgent_engine, "f");
    }
    /** The name and version of the operating system in a user agent string. */
    get os() {
        if (!__classPrivateFieldGet(this, _UserAgent_os, "f")) {
            __classPrivateFieldSet(this, _UserAgent_os, { name: undefined, version: undefined }, "f");
            mapper(__classPrivateFieldGet(this, _UserAgent_os, "f"), __classPrivateFieldGet(this, _UserAgent_ua, "f"), matchers.os);
            Object.freeze(__classPrivateFieldGet(this, _UserAgent_os, "f"));
        }
        return __classPrivateFieldGet(this, _UserAgent_os, "f");
    }
    /** A read only version of the user agent string related to the instance. */
    get ua() {
        return __classPrivateFieldGet(this, _UserAgent_ua, "f");
    }
    toJSON() {
