...
async function convertBodyToBodyInit(body, type, jsonBodyReplacer) {
    ...
    if (util_js_1.BODY_TYPES.includes(typeof body)) {
        result = String(body);
        type = type ?? ((0, util_js_1.isHtml)(result) ? "html" : "text/plain");
    }
    else if ((0, util_js_1.isReader)(body)) {
        result = (0, util_js_1.readableStreamFromReader)(body);
    }
        ...
        result = body.pipeThrough(new util_js_1.Uint8ArrayTransformStream());
    }
        ...
        result = (0, util_js_1.readableStreamFromAsyncIterable)(body);
    }
...
class Response {
    ...
    get body() {
        return tslib_1.__classPrivateFieldGet(this, _Response_body, "f");
    }
    /** The body of the response.  The body will be automatically processed when
     * the response is being sent and converted to a `Uint8Array` or a
     * `Deno.Reader`.
     ...
     * Automatic conversion to a `Deno.Reader` occurs for async iterables. */
    set body(value) {
        if (!tslib_1.__classPrivateFieldGet(this, _Response_writable, "f")) {
            throw new Error("The response is not writable.");
        }
        tslib_1.__classPrivateFieldSet(this, _Response_bodySet, true, "f");
        tslib_1.__classPrivateFieldSet(this, _Response_body, value, "f");
    }
    /** Headers that will be returned in the response. */
    get headers() {
        return tslib_1.__classPrivateFieldGet(this, _Response_headers, "f");
    }
    /** Headers that will be returned in the response. */
    set headers(value) {
        if (!tslib_1.__classPrivateFieldGet(this, _Response_writable, "f")) {
        ...
        tslib_1.__classPrivateFieldSet(this, _Response_headers, value, "f");
    }
    ...
    get status() {
        if (tslib_1.__classPrivateFieldGet(this, _Response_status, "f")) {
            return tslib_1.__classPrivateFieldGet(this, _Response_status, "f");
        }
        return this.body != null
            ? deps_js_1.Status.OK
            : tslib_1.__classPrivateFieldGet(this, _Response_bodySet, "f")
    ...
    set status(value) {
        ...
        tslib_1.__classPrivateFieldSet(this, _Response_status, value, "f");
    }
    ...
    get type() {
        return tslib_1.__classPrivateFieldGet(this, _Response_type, "f");
    }
    /** The media type, or extension of the response.  Setting this value will
     * ensure an appropriate `Content-Type` header is added to the response. */
    set type(value) {
        ...
        tslib_1.__classPrivateFieldSet(this, _Response_type, value, "f");
    }
    ...
    get writable() {
        return tslib_1.__classPrivateFieldGet(this, _Response_writable, "f");
    }
    constructor(request, jsonBodyReplacer) {
        ...
        tslib_1.__classPrivateFieldSet(this, _Response_request, request, "f");
        tslib_1.__classPrivateFieldSet(this, _Response_jsonBodyReplacer, jsonBodyReplacer, "f");
    }
    /** Add a resource to the list of resources that will be closed when the
     * request is destroyed. */
    addResource(rid) {
        tslib_1.__classPrivateFieldGet(this, _Response_resources, "f").push(rid);
    }
    ...
    destroy(closeResources = true) {
        tslib_1.__classPrivateFieldSet(this, _Response_writable, false, "f");
        tslib_1.__classPrivateFieldSet(this, _Response_body, undefined, "f");
        tslib_1.__classPrivateFieldSet(this, _Response_domResponse, undefined, "f");
        if (closeResources) {
            for (const rid of tslib_1.__classPrivateFieldGet(this, _Response_resources, "f")) {
                try {
    ...
    redirect(url, alt = "/") {
        if (url === exports.REDIRECT_BACK) {
            url = tslib_1.__classPrivateFieldGet(this, _Response_request, "f").headers.get("Referer") ?? String(alt);
        }
        else if (typeof url === "object") {
            url = String(url);
        }
        this.headers.set("Location", (0, util_js_1.encodeUrl)(url));
        if (!this.status || !(0, deps_js_1.isRedirectStatus)(this.status)) {
            this.status = deps_js_1.Status.Found;
        }
        if (tslib_1.__classPrivateFieldGet(this, _Response_request, "f").accepts("html")) {
            url = encodeURI(url);
    ...
    async toDomResponse() {
        if (tslib_1.__classPrivateFieldGet(this, _Response_domResponse, "f")) {
            return tslib_1.__classPrivateFieldGet(this, _Response_domResponse, "f");
        }
        const bodyInit = await tslib_1.__classPrivateFieldGet(this, _Response_instances, "m", _Response_getBodyInit).call(this);
        tslib_1.__classPrivateFieldGet(this, _Response_instances, "m", _Response_setContentType).call(this);
        const { headers } = this;
        ...
        return tslib_1.__classPrivateFieldSet(this, _Response_domResponse, new http_server_native_request_js_1.DomResponse(bodyInit, responseInit), "f");
    }
    [(_Response_body = new WeakMap(), _Response_bodySet = new WeakMap(), _Response_domResponse = new WeakMap(), _Response_headers = new WeakMap(), _Response_jsonBodyReplacer = new WeakMap(), _Response_request = new WeakMap(), _Response_resources = new WeakMap(), _Response_status = new WeakMap(), _Response_type = new WeakMap(), _Response_writable = new WeakMap(), _Response_instances = new WeakSet(), _Response_getBodyInit = async function _Response_getBodyInit() {
        const [body, type] = await convertBodyToBodyInit(this.body, this.type, tslib_1.__classPrivateFieldGet(this, _Response_jsonBodyReplacer, "f"));
        this.type = type;
        return body;
