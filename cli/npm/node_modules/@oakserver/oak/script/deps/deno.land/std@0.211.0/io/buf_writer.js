...
class BufWriter extends AbstractBufBase {
    ...
    constructor(writer, size = DEFAULT_BUF_SIZE) {
        ...
        tslib_1.__classPrivateFieldSet(this, _BufWriter_writer, writer, "f");
    }
    ...
    reset(w) {
        ...
        tslib_1.__classPrivateFieldSet(this, _BufWriter_writer, w, "f");
    }
    ...
    async flush() {
        ...
        try {
            ...
            while (nwritten < p.length) {
                nwritten += await tslib_1.__classPrivateFieldGet(this, _BufWriter_writer, "f").write(p.subarray(nwritten));
            }
        }
        catch (e) {
    ...
    async write(data) {
        ...
        while (data.byteLength > this.available()) {
            if (this.buffered() === 0) {
                ...
                try {
                    numBytesWritten = await tslib_1.__classPrivateFieldGet(this, _BufWriter_writer, "f").write(data);
                }
                catch (e) {
                    if (e instanceof Error) {
                        this.err = e;
...
class BufWriterSync extends AbstractBufBase {
    ...
    constructor(writer, size = DEFAULT_BUF_SIZE) {
        ...
        tslib_1.__classPrivateFieldSet(this, _BufWriterSync_writer, writer, "f");
    }
    /** Discards any unflushed buffered data, clears any error, and
     * resets buffer to write its output to w.
     */
    reset(w) {
        this.err = null;
        this.usedBufferBytes = 0;
        tslib_1.__classPrivateFieldSet(this, _BufWriterSync_writer, w, "f");
    }
    ...
    flush() {
        ...
        try {
            ...
            let nwritten = 0;
            while (nwritten < p.length) {
                nwritten += tslib_1.__classPrivateFieldGet(this, _BufWriterSync_writer, "f").writeSync(p.subarray(nwritten));
            }
        }
        catch (e) {
            if (e instanceof Error) {
    ...
    writeSync(data) {
        ...
        while (data.byteLength > this.available()) {
            if (this.buffered() === 0) {
                ...
                // Write directly from data to avoid copy.
                try {
                    numBytesWritten = tslib_1.__classPrivateFieldGet(this, _BufWriterSync_writer, "f").writeSync(data);
                }
                catch (e) {
                    if (e instanceof Error) {
                        this.err = e;
