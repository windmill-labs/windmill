...
const base64url_js_1 = require("../encoding/base64url.js");
...
class KeyStack {
    /** Number of keys */
    get length() {
        return tslib_1.__classPrivateFieldGet(this, _KeyStack_keys, "f").length;
    }
    ...
    constructor(keys) {
        ...
        tslib_1.__classPrivateFieldSet(this, _KeyStack_keys, values, "f");
    }
    ...
    async sign(data) {
        const key = await tslib_1.__classPrivateFieldGet(this, _KeyStack_instances, "m", _KeyStack_toCryptoKey).call(this, tslib_1.__classPrivateFieldGet(this, _KeyStack_keys, "f")[0]);
        return (0, base64url_js_1.encodeBase64Url)(await sign(data, key));
    }
    ...
    async indexOf(data, digest) {
        for (let i = 0; i < tslib_1.__classPrivateFieldGet(this, _KeyStack_keys, "f").length; i++) {
            const cryptoKey = await tslib_1.__classPrivateFieldGet(this, _KeyStack_instances, "m", _KeyStack_toCryptoKey).call(this, tslib_1.__classPrivateFieldGet(this, _KeyStack_keys, "f")[i]);
            if (await compare(digest, (0, base64url_js_1.encodeBase64Url)(await sign(data, cryptoKey)))) {
                return i;
            }
        }
        return -1;
    ...
    [(_KeyStack_cryptoKeys = new WeakMap(), _KeyStack_keys = new WeakMap(), _KeyStack_instances = new WeakSet(), _KeyStack_toCryptoKey = async function _KeyStack_toCryptoKey(key) {
        if (!tslib_1.__classPrivateFieldGet(this, _KeyStack_cryptoKeys, "f").has(key)) {
            tslib_1.__classPrivateFieldGet(this, _KeyStack_cryptoKeys, "f").set(key, await importKey(key));
        }
        return tslib_1.__classPrivateFieldGet(this, _KeyStack_cryptoKeys, "f").get(key);
