...
exports.DelimiterStream = void 0;
 ...
 * ```
 */
class DelimiterStream extends dntShim.TransformStream {
    /** Constructs a new instance. */
    constructor(delimiter, options) {
        super({
            transform: (chunk, controller) => delimiter.length === 1
                ? tslib_1.__classPrivateFieldGet(this, _DelimiterStream_instances, "m", _DelimiterStream_handleChar).call(this, chunk, controller)
                : tslib_1.__classPrivateFieldGet(this, _DelimiterStream_instances, "m", _DelimiterStream_handle).call(this, chunk, controller),
            flush: (controller) => tslib_1.__classPrivateFieldGet(this, _DelimiterStream_instances, "m", _DelimiterStream_flush).call(this, controller),
        });
        ...
        tslib_1.__classPrivateFieldSet(this, _DelimiterStream_delimiter, delimiter, "f");
        tslib_1.__classPrivateFieldSet(this, _DelimiterStream_delimLPS, delimiter.length > 1 ? (0, _common_js_1.createLPS)(delimiter) : null, "f");
        tslib_1.__classPrivateFieldSet(this, _DelimiterStream_disp, options?.disposition ?? "discard", "f");
    }
}
exports.DelimiterStream = DelimiterStream;
_DelimiterStream_bufs = new WeakMap(), _DelimiterStream_delimiter = new WeakMap(), _DelimiterStream_matchIndex = new WeakMap(), _DelimiterStream_delimLPS = new WeakMap(), _DelimiterStream_disp = new WeakMap(), _DelimiterStream_instances = new WeakSet(), _DelimiterStream_handle = function _DelimiterStream_handle(chunk, controller) {
    const bufs = tslib_1.__classPrivateFieldGet(this, _DelimiterStream_bufs, "f");
    const length = chunk.byteLength;
    const disposition = tslib_1.__classPrivateFieldGet(this, _DelimiterStream_disp, "f");
    const delimiter = tslib_1.__classPrivateFieldGet(this, _DelimiterStream_delimiter, "f");
    const delimLen = delimiter.length;
    const lps = tslib_1.__classPrivateFieldGet(this, _DelimiterStream_delimLPS, "f");
    let chunkStart = 0;
    let matchIndex = tslib_1.__classPrivateFieldGet(this, _DelimiterStream_matchIndex, "f");
    let inspectIndex = 0;
            ...
            if (matchIndex === delimLen) {
                ...
                if (delimitedChunkEnd <= 0 && bufs.length === 0) {
                    ...
                    if (bufs.length === 1) {
                        ...
                        controller.enqueue((0, concat_js_1.concat)(bufs));
                    }
                    ...
                    const result = (0, concat_js_1.concat)([...bufs, chunkSliced]);
                    bufs.length = 0;
    ...
    // Save match index.
    tslib_1.__classPrivateFieldSet(this, _DelimiterStream_matchIndex, matchIndex, "f");
    if (chunkStart === 0) {
        bufs.push(chunk);
    }
    ...
    const length = chunk.byteLength;
    const disposition = tslib_1.__classPrivateFieldGet(this, _DelimiterStream_disp, "f");
    const delimiter = tslib_1.__classPrivateFieldGet(this, _DelimiterStream_delimiter, "f")[0];
    let chunkStart = 0;
    let inspectIndex = 0;
    while (inspectIndex < length) {
