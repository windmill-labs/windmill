...
class Context {
    ...
    constructor(app, serverRequest, state, { secure = false, jsonBodyReplacer, jsonBodyReviver, } = {}) {
        ...
        this.request = new request_js_1.Request(serverRequest, {
            proxy,
            secure,
            jsonBodyReviver: tslib_1.__classPrivateFieldGet(this, _Context_instances, "m", _Context_wrapReviverReplacer).call(this, jsonBodyReviver),
        });
        this.respond = true;
        this.response = new response_js_1.Response(this.request, tslib_1.__classPrivateFieldGet(this, _Context_instances, "m", _Context_wrapReviverReplacer).call(this, jsonBodyReplacer));
    ...
    sendEvents(options) {
        if (!tslib_1.__classPrivateFieldGet(this, _Context_sse, "f")) {
            (0, util_js_1.assert)(this.response.writable, "The response is not writable.");
            const sse = tslib_1.__classPrivateFieldSet(this, _Context_sse, new deps_js_1.ServerSentEventStreamTarget(options), "f");
    ...
    upgrade(options) {
        ...
        this.app.addEventListener("close", () => tslib_1.__classPrivateFieldGet(this, _Context_socket, "f")?.close());
        this.respond = false;
        return tslib_1.__classPrivateFieldGet(this, _Context_socket, "f");
    }
