...
const FILENAME_STAR_REGEX = (0, headers_js_1.toParamRegExp)("filename\\*", "i");
const FILENAME_START_ITER_REGEX = (0, headers_js_1.toParamRegExp)("filename\\*((?!0\\d)\\d+)(\\*?)", "ig");
const FILENAME_REGEX = (0, headers_js_1.toParamRegExp)("filename", "i");
...
function rfc2231getParam(header) {
    ...
    for (let n = 0; n < matches.length; ++n) {
        ...
        part = (0, headers_js_1.unquote)(part);
        if (quote) {
            part = unescape(part);
            if (n === 0) {
...
function getFilename(header) {
    ...
    if (matches) {
        ...
        return fixupEncoding(rfc2047decode(rfc5987decode(unescape((0, headers_js_1.unquote)(filename)))));
    }
    ...
    if (matches) {
        const [, filename] = matches;
        return fixupEncoding(rfc2047decode((0, headers_js_1.unquote)(filename)));
    }
    return "";
}
