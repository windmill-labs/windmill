...
exports.Application = exports.ApplicationListenEvent = exports.ApplicationErrorEvent = exports.ApplicationCloseEvent = void 0;
const tslib_1 = require("tslib");
// Copyright 2018-2023 the oak authors. All rights reserved. MIT license.
const dntShim = tslib_1.__importStar(require("./_dnt.shims.js"));
const context_js_1 = require("./context.js");
const deps_js_1 = require("./deps.js");
const http_server_node_js_1 = require("./http_server_node.js");
const http_server_native_request_js_1 = require("./http_server_native_request.js");
const middleware_js_1 = require("./middleware.js");
const structured_clone_js_1 = require("./structured_clone.js");
const util_js_1 = require("./util.js");
const ADDR_REGEXP = /^\[?([^\]]*)\]?:([0-9]{1,5})$/;
const DEFAULT_SERVER = http_server_node_js_1.HttpServer;
class ApplicationCloseEvent extends Event {
    constructor(eventInitDict) {
        super("close", eventInitDict);
    }
}
exports.ApplicationCloseEvent = ApplicationCloseEvent;
class ApplicationErrorEvent extends dntShim.ErrorEvent {
    constructor(eventInitDict) {
...
class Application extends EventTarget {
     ...
     * cookies. */
    get keys() {
        return tslib_1.__classPrivateFieldGet(this, _Application_keys, "f");
    }
    set keys(keys) {
        if (!keys) {
            tslib_1.__classPrivateFieldSet(this, _Application_keys, undefined, "f");
            return;
        }
        else if (Array.isArray(keys)) {
            tslib_1.__classPrivateFieldSet(this, _Application_keys, new deps_js_1.KeyStack(keys), "f");
        }
        else {
            tslib_1.__classPrivateFieldSet(this, _Application_keys, keys, "f");
        }
    }
    constructor(options = {}) {
        super();
        ...
        Object.defineProperty(this, "handle", {
            ...
            value: (async (request, secureOrConn, secure = false) => {
                if (!tslib_1.__classPrivateFieldGet(this, _Application_middleware, "f").length) {
                    throw new TypeError("There is no middleware to process requests.");
                }
                (0, util_js_1.assert)((0, util_js_1.isConn)(secureOrConn) || typeof secureOrConn === "undefined");
                const contextRequest = new http_server_native_request_js_1.NativeRequest({
                    request,
                    respondWith() {
                        return Promise.resolve(undefined);
                    },
                }, { conn: secureOrConn });
                const context = new context_js_1.Context(this, contextRequest, tslib_1.__classPrivateFieldGet(this, _Application_instances, "m", _Application_getContextState).call(this), { secure, ...tslib_1.__classPrivateFieldGet(this, _Application_contextOptions, "f") });
                try {
                    await tslib_1.__classPrivateFieldGet(this, _Application_instances, "m", _Application_getComposed).call(this)(context);
                }
                catch (err) {
                    tslib_1.__classPrivateFieldGet(this, _Application_instances, "m", _Application_handleError).call(this, context, err);
                }
        ...
        this.keys = keys;
        this.state = state ?? {};
        tslib_1.__classPrivateFieldSet(this, _Application_serverConstructor, serverConstructor, "f");
        tslib_1.__classPrivateFieldSet(this, _Application_contextOptions, contextOptions, "f");
        tslib_1.__classPrivateFieldSet(this, _Application_contextState, contextState, "f");
        if (logErrors) {
    ...
    async listen(options = { port: 0 }) {
        ...
        for (const middleware of tslib_1.__classPrivateFieldGet(this, _Application_middleware, "f")) {
            if ((0, middleware_js_1.isMiddlewareObject)(middleware) && middleware.init) {
        ...
        const server = new (tslib_1.__classPrivateFieldGet(this, _Application_serverConstructor, "f"))(this, options);
        ...
        const serverType = server instanceof http_server_node_js_1.HttpServer ? "native" : "custom";
        ...
        try {
            for await (const request of server) {
                tslib_1.__classPrivateFieldGet(this, _Application_instances, "m", _Application_handleRequest).call(this, request, secure, state);
            }
    ...
    use(...middleware) {
        tslib_1.__classPrivateFieldGet(this, _Application_middleware, "f").push(...middleware);
        tslib_1.__classPrivateFieldSet(this, _Application_composedMiddleware, undefined, "f");
        // deno-lint-ignore no-explicit-any
        return this;
    }
    [(_Application_composedMiddleware = new WeakMap(), _Application_contextOptions = new WeakMap(), _Application_contextState = new WeakMap(), _Application_keys = new WeakMap(), _Application_middleware = new WeakMap(), _Application_serverConstructor = new WeakMap(), _Application_instances = new WeakSet(), _Application_getComposed = function _Application_getComposed() {
        if (!tslib_1.__classPrivateFieldGet(this, _Application_composedMiddleware, "f")) {
            tslib_1.__classPrivateFieldSet(this, _Application_composedMiddleware, (0, middleware_js_1.compose)(tslib_1.__classPrivateFieldGet(this, _Application_middleware, "f")), "f");
        }
        return tslib_1.__classPrivateFieldGet(this, _Application_composedMiddleware, "f");
    }, _Application_getContextState = function _Application_getContextState() {
        switch (tslib_1.__classPrivateFieldGet(this, _Application_contextState, "f")) {
            case "alias":
                return this.state;
            case "clone":
                return (0, structured_clone_js_1.cloneState)(this.state);
            case "empty":
                return {};
            case "prototype":
        ...
        const status = context.response.status =
            dntShim.Deno.errors && error instanceof dntShim.Deno.errors.NotFound
                ...
                : error.status && typeof error.status === "number"
                    ? error.status
                    : 500;
        context.response.body = error.expose ? error.message : deps_js_1.STATUS_TEXT[status];
    ...
    async function _Application_handleRequest(request, secure, state) {
        let context;
        try {
            context = new context_js_1.Context(this, request, tslib_1.__classPrivateFieldGet(this, _Application_instances, "m", _Application_getContextState).call(this), { secure, ...tslib_1.__classPrivateFieldGet(this, _Application_contextOptions, "f") });
        }
        catch (e) {
        ...
        (0, util_js_1.assert)(context, "Context was not created.");
        let resolve;
        ...
        return `${this.constructor.name} ${inspect({ "#middleware": tslib_1.__classPrivateFieldGet(this, _Application_middleware, "f"), keys, proxy, state })}`;
    }
    ...
    options, inspect) {
        ...
        const { keys, proxy, state } = this;
        return `${options.stylize(this.constructor.name, "special")} ${inspect({ "#middleware": tslib_1.__classPrivateFieldGet(this, _Application_middleware, "f"), keys, proxy, state }, newOptions)}`;
    }
}
