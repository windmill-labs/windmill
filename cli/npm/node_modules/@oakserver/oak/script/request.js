...
class Request {
     ...
     */
    get userAgent() {
        return tslib_1.__classPrivateFieldGet(this, _Request_userAgent, "f");
    }
    constructor(serverRequest, { proxy = false, secure = false, jsonBodyReviver } = {}) {
        ...
        tslib_1.__classPrivateFieldSet(this, _Request_body, new body_js_1.RequestBody(serverRequest.getBody(), serverRequest.headers, jsonBodyReviver), "f");
        tslib_1.__classPrivateFieldSet(this, _Request_userAgent, new deps_js_1.UserAgent(serverRequest.headers.get("user-agent")), "f");
    }
    accepts(...types) {
