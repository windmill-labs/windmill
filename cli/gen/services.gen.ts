 ...
 * @throws ApiError
 */
export const getCriticalAlerts = (): CancelablePromise<GetCriticalAlertsResponse> => { return __request(OpenAPI, {
    method: 'GET',
