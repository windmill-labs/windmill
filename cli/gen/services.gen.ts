...
import type {
  ...
  BackendUptodateResponse,
  GetLicenseIdResponse,
  GetOpenApiYamlResponse,
  GetAuditLogData,
  GetAuditLogResponse,
  ListAuditLogsData,
  ...
  UpdateUserResponse,
  IsOwnerOfPathData,
  IsOwnerOfPathResponse,
  SetPasswordData,
  SetPasswordResponse,
  SetPasswordForUserData,
  SetPasswordForUserResponse,
  SetLoginTypeForUserData,
  SetLoginTypeForUserResponse,
  CreateUserGloballyData,
  CreateUserGloballyResponse,
  GlobalUserUpdateData,
  GlobalUserUpdateResponse,
  GlobalUsernameInfoData,
  GlobalUsernameInfoResponse,
  GlobalUserRenameData,
  GlobalUserRenameResponse,
  GlobalUserDeleteData,
  GlobalUserDeleteResponse,
  GlobalUsersOverwriteData,
  GlobalUsersOverwriteResponse,
  GlobalUsersExportResponse,
  DeleteUserData,
  DeleteUserResponse,
  ListWorkspacesResponse,
  IsDomainAllowedResponse,
  ListUserWorkspacesResponse,
  ListWorkspacesAsSuperAdminData,
  ListWorkspacesAsSuperAdminResponse,
  CreateWorkspaceData,
  CreateWorkspaceResponse,
  ExistsWorkspaceData,
  ExistsWorkspaceResponse,
  ExistsUsernameData,
  ...
  TestSmtpData,
  TestSmtpResponse,
  TestCriticalChannelsData,
  TestCriticalChannelsResponse,
  GetCriticalAlertsData,
  GetCriticalAlertsResponse,
  AcknowledgeCriticalAlertData,
  AcknowledgeCriticalAlertResponse,
  AcknowledgeAllCriticalAlertsResponse,
  TestLicenseKeyData,
  TestLicenseKeyResponse,
  TestObjectStorageConfigData,
  TestObjectStorageConfigResponse,
  SendStatsResponse,
  GetLatestKeyRenewalAttemptResponse,
  RenewLicenseKeyData,
  RenewLicenseKeyResponse,
  CreateCustomerPortalSessionData,
  CreateCustomerPortalSessionResponse,
  TestMetadataData,
  TestMetadataResponse,
  ListGlobalSettingsResponse,
  ...
  ChangeWorkspaceIdResponse,
  ChangeWorkspaceColorData,
  ChangeWorkspaceColorResponse,
  WhoisData,
  WhoisResponse,
  UpdateOperatorSettingsData,
  UpdateOperatorSettingsResponse,
  ExistsEmailData,
  ExistsEmailResponse,
  ListUsersAsSuperAdminData,
  ListUsersAsSuperAdminResponse,
  ...
  GetDeployToResponse,
  GetIsPremiumData,
  GetIsPremiumResponse,
  GetPremiumInfoData,
  GetPremiumInfoResponse,
  SetAutomaticBillingData,
  SetAutomaticBillingResponse,
  GetThresholdAlertData,
  GetThresholdAlertResponse,
  SetThresholdAlertData,
  SetThresholdAlertResponse,
  EditSlackCommandData,
  EditSlackCommandResponse,
  EditTeamsCommandData,
  EditTeamsCommandResponse,
  ListAvailableTeamsIdsData,
  ListAvailableTeamsIdsResponse,
  ListAvailableTeamsChannelsData,
  ListAvailableTeamsChannelsResponse,
  ConnectTeamsData,
  ConnectTeamsResponse,
  RunSlackMessageTestJobData,
  RunSlackMessageTestJobResponse,
  RunTeamsMessageTestJobData,
  RunTeamsMessageTestJobResponse,
  EditDeployToData,
  EditDeployToResponse,
  EditAutoInviteData,
  EditAutoInviteResponse,
  EditWebhookData,
  EditWebhookResponse,
  EditCopilotConfigData,
  EditCopilotConfigResponse,
  GetCopilotInfoData,
  GetCopilotInfoResponse,
  EditErrorHandlerData,
  EditErrorHandlerResponse,
  EditLargeFileStorageConfigData,
  EditLargeFileStorageConfigResponse,
  EditWorkspaceGitSyncConfigData,
  EditWorkspaceGitSyncConfigResponse,
  EditWorkspaceDeployUiSettingsData,
  EditWorkspaceDeployUiSettingsResponse,
  EditWorkspaceDefaultAppData,
  EditWorkspaceDefaultAppResponse,
  EditDefaultScriptsData,
  EditDefaultScriptsResponse,
  ...
  CreateTokenImpersonateResponse,
  DeleteTokenData,
  DeleteTokenResponse,
  ListTokensData,
  ListTokensResponse,
  ...
  ExistsVariableData,
  ExistsVariableResponse,
  ListVariableData,
  ListVariableResponse,
  ListContextualVariablesData,
  ListContextualVariablesResponse,
  WorkspaceGetCriticalAlertsData,
  WorkspaceGetCriticalAlertsResponse,
  WorkspaceAcknowledgeCriticalAlertData,
  WorkspaceAcknowledgeCriticalAlertResponse,
  WorkspaceAcknowledgeAllCriticalAlertsData,
  WorkspaceAcknowledgeAllCriticalAlertsResponse,
  WorkspaceMuteCriticalAlertsUiData,
  WorkspaceMuteCriticalAlertsUiResponse,
  LoginWithOauthData,
  LoginWithOauthResponse,
  ConnectSlackCallbackData,
  ConnectSlackCallbackResponse,
  ConnectSlackCallbackInstanceData,
  ConnectSlackCallbackInstanceResponse,
  ConnectCallbackData,
  ...
  UpdateResourceValueResponse,
  GetResourceData,
  GetResourceResponse,
  GetResourceValueInterpolatedData,
  GetResourceValueInterpolatedResponse,
  GetResourceValueData,
  GetResourceValueResponse,
  ExistsResourceData,
  ExistsResourceResponse,
  ListResourceData,
  ...
  FileResourceTypeToFileExtMapData,
  FileResourceTypeToFileExtMapResponse,
  ...
  GetPublicAppByCustomPathData,
  GetPublicAppByCustomPathResponse,
  GetHubScriptContentByPathData,
  GetHubScriptContentByPathResponse,
  ...
  ToggleWorkspaceErrorHandlerForScriptResponse,
  GetCustomTagsData,
  GetCustomTagsResponse,
  GeDefaultTagsResponse,
  IsDefaultTagsPerWorkspaceResponse,
  ArchiveScriptByPathData,
  ArchiveScriptByPathResponse,
  ArchiveScriptByHashData,
  ArchiveScriptByHashResponse,
  DeleteScriptByHashData,
  DeleteScriptByHashResponse,
  DeleteScriptByPathData,
  DeleteScriptByPathResponse,
  GetScriptByPathData,
  GetScriptByPathResponse,
  GetTriggersCountOfScriptData,
  GetTriggersCountOfScriptResponse,
  ListTokensOfScriptData,
  ListTokensOfScriptResponse,
  GetScriptByPathWithDraftData,
  GetScriptByPathWithDraftResponse,
  GetScriptHistoryByPathData,
  GetScriptHistoryByPathResponse,
  GetScriptLatestVersionData,
  GetScriptLatestVersionResponse,
  UpdateScriptHistoryData,
  UpdateScriptHistoryResponse,
  RawScriptByPathData,
  RawScriptByPathResponse,
  RawScriptByPathTokenedData,
  RawScriptByPathTokenedResponse,
  ExistsScriptByPathData,
  ExistsScriptByPathResponse,
  GetScriptByHashData,
  GetScriptByHashResponse,
  RawScriptByHashData,
  RawScriptByHashResponse,
  GetScriptDeploymentStatusData,
  GetScriptDeploymentStatusResponse,
  RunScriptByPathData,
  RunScriptByPathResponse,
  OpenaiSyncScriptByPathData,
  OpenaiSyncScriptByPathResponse,
  RunWaitResultScriptByPathData,
  RunWaitResultScriptByPathResponse,
  RunWaitResultScriptByPathGetData,
  RunWaitResultScriptByPathGetResponse,
  OpenaiSyncFlowByPathData,
  OpenaiSyncFlowByPathResponse,
  RunWaitResultFlowByPathData,
  RunWaitResultFlowByPathResponse,
  ResultByIdData,
  ResultByIdResponse,
  ListFlowPathsData,
  ListFlowPathsResponse,
  ListSearchFlowData,
  ...
  GetFlowLatestVersionData,
  GetFlowLatestVersionResponse,
  ListFlowPathsFromWorkspaceRunnableData,
  ListFlowPathsFromWorkspaceRunnableResponse,
  GetFlowVersionData,
  GetFlowVersionResponse,
  UpdateFlowHistoryData,
  UpdateFlowHistoryResponse,
  GetFlowByPathData,
  GetFlowByPathResponse,
  GetFlowDeploymentStatusData,
  GetFlowDeploymentStatusResponse,
  GetTriggersCountOfFlowData,
  GetTriggersCountOfFlowResponse,
  ListTokensOfFlowData,
  ListTokensOfFlowResponse,
  ToggleWorkspaceErrorHandlerForFlowData,
  ToggleWorkspaceErrorHandlerForFlowResponse,
  GetFlowByPathWithDraftData,
  GetFlowByPathWithDraftResponse,
  ExistsFlowByPathData,
  ExistsFlowByPathResponse,
  CreateFlowData,
  CreateFlowResponse,
  UpdateFlowData,
  UpdateFlowResponse,
  ArchiveFlowByPathData,
  ArchiveFlowByPathResponse,
  DeleteFlowByPathData,
  DeleteFlowByPathResponse,
  ListRawAppsData,
  ListRawAppsResponse,
  ExistsRawAppData,
  ExistsRawAppResponse,
  GetRawAppDataData,
  GetRawAppDataResponse,
  ListSearchAppData,
  ...
  ExistsAppResponse,
  GetAppByPathData,
  GetAppByPathResponse,
  GetAppLiteByPathData,
  GetAppLiteByPathResponse,
  GetAppByPathWithDraftData,
  GetAppByPathWithDraftResponse,
  GetAppHistoryByPathData,
  GetAppHistoryByPathResponse,
  GetAppLatestVersionData,
  GetAppLatestVersionResponse,
  UpdateAppHistoryData,
  UpdateAppHistoryResponse,
  GetPublicAppBySecretData,
  GetPublicAppBySecretResponse,
  GetPublicResourceData,
  GetPublicResourceResponse,
  GetPublicSecretOfAppData,
  GetPublicSecretOfAppResponse,
  GetAppByVersionData,
  GetAppByVersionResponse,
  CreateRawAppData,
  CreateRawAppResponse,
  UpdateRawAppData,
  UpdateRawAppResponse,
  DeleteRawAppData,
  DeleteRawAppResponse,
  DeleteAppData,
  DeleteAppResponse,
  UpdateAppData,
  UpdateAppResponse,
  CustomPathExistsData,
  CustomPathExistsResponse,
  ExecuteComponentData,
  ExecuteComponentResponse,
  UploadS3FileFromAppData,
  UploadS3FileFromAppResponse,
  DeleteS3FileFromAppData,
  DeleteS3FileFromAppResponse,
  RunFlowByPathData,
  RunFlowByPathResponse,
  RestartFlowAtStepData,
  RestartFlowAtStepResponse,
  RunScriptByHashData,
  RunScriptByHashResponse,
  RunScriptPreviewData,
  RunScriptPreviewResponse,
  RunCodeWorkflowTaskData,
  RunCodeWorkflowTaskResponse,
  RunRawScriptDependenciesData,
  RunRawScriptDependenciesResponse,
  RunFlowPreviewData,
  RunFlowPreviewResponse,
  ListQueueData,
  ListQueueResponse,
  GetQueueCountData,
  ...
  CountCompletedJobsData,
  CountCompletedJobsResponse,
  ListFilteredUuidsData,
  ListFilteredUuidsResponse,
  CancelSelectionData,
  CancelSelectionResponse,
  ListCompletedJobsData,
  ListCompletedJobsResponse,
  ListJobsData,
  ListJobsResponse,
  GetDbClockResponse,
  CountJobsByTagData,
  CountJobsByTagResponse,
  GetJobData,
  GetJobResponse,
  GetRootJobIdData,
  GetRootJobIdResponse,
  GetJobLogsData,
  GetJobLogsResponse,
  GetJobArgsData,
  GetJobArgsResponse,
  ...
  GetScheduleResponse,
  ExistsScheduleData,
  ExistsScheduleResponse,
  ListSchedulesData,
  ListSchedulesResponse,
  ListSchedulesWithJobsData,
  ListSchedulesWithJobsResponse,
  SetDefaultErrorOrRecoveryHandlerData,
  SetDefaultErrorOrRecoveryHandlerResponse,
  CreateHttpTriggerData,
  CreateHttpTriggerResponse,
  UpdateHttpTriggerData,
  UpdateHttpTriggerResponse,
  DeleteHttpTriggerData,
  DeleteHttpTriggerResponse,
  GetHttpTriggerData,
  GetHttpTriggerResponse,
  ListHttpTriggersData,
  ListHttpTriggersResponse,
  ExistsHttpTriggerData,
  ExistsHttpTriggerResponse,
  ExistsRouteData,
  ExistsRouteResponse,
  CreateWebsocketTriggerData,
  CreateWebsocketTriggerResponse,
  UpdateWebsocketTriggerData,
  UpdateWebsocketTriggerResponse,
  DeleteWebsocketTriggerData,
  DeleteWebsocketTriggerResponse,
  GetWebsocketTriggerData,
  GetWebsocketTriggerResponse,
  ListWebsocketTriggersData,
  ListWebsocketTriggersResponse,
  ExistsWebsocketTriggerData,
  ExistsWebsocketTriggerResponse,
  SetWebsocketTriggerEnabledData,
  SetWebsocketTriggerEnabledResponse,
  TestWebsocketConnectionData,
  TestWebsocketConnectionResponse,
  CreateKafkaTriggerData,
  CreateKafkaTriggerResponse,
  UpdateKafkaTriggerData,
  UpdateKafkaTriggerResponse,
  DeleteKafkaTriggerData,
  DeleteKafkaTriggerResponse,
  GetKafkaTriggerData,
  GetKafkaTriggerResponse,
  ListKafkaTriggersData,
  ListKafkaTriggersResponse,
  ExistsKafkaTriggerData,
  ExistsKafkaTriggerResponse,
  SetKafkaTriggerEnabledData,
  SetKafkaTriggerEnabledResponse,
  TestKafkaConnectionData,
  TestKafkaConnectionResponse,
  CreateNatsTriggerData,
  CreateNatsTriggerResponse,
  UpdateNatsTriggerData,
  UpdateNatsTriggerResponse,
  DeleteNatsTriggerData,
  DeleteNatsTriggerResponse,
  GetNatsTriggerData,
  GetNatsTriggerResponse,
  ListNatsTriggersData,
  ListNatsTriggersResponse,
  ExistsNatsTriggerData,
  ExistsNatsTriggerResponse,
  SetNatsTriggerEnabledData,
  SetNatsTriggerEnabledResponse,
  TestNatsConnectionData,
  TestNatsConnectionResponse,
  CreateSqsTriggerData,
  CreateSqsTriggerResponse,
  UpdateSqsTriggerData,
  UpdateSqsTriggerResponse,
  DeleteSqsTriggerData,
  DeleteSqsTriggerResponse,
  GetSqsTriggerData,
  GetSqsTriggerResponse,
  ListSqsTriggersData,
  ListSqsTriggersResponse,
  ExistsSqsTriggerData,
  ExistsSqsTriggerResponse,
  SetSqsTriggerEnabledData,
  SetSqsTriggerEnabledResponse,
  TestSqsConnectionData,
  TestSqsConnectionResponse,
  CreateMqttTriggerData,
  CreateMqttTriggerResponse,
  UpdateMqttTriggerData,
  UpdateMqttTriggerResponse,
  DeleteMqttTriggerData,
  DeleteMqttTriggerResponse,
  GetMqttTriggerData,
  GetMqttTriggerResponse,
  ListMqttTriggersData,
  ListMqttTriggersResponse,
  ExistsMqttTriggerData,
  ExistsMqttTriggerResponse,
  SetMqttTriggerEnabledData,
  SetMqttTriggerEnabledResponse,
  TestMqttConnectionData,
  TestMqttConnectionResponse,
  IsValidPostgresConfigurationData,
  IsValidPostgresConfigurationResponse,
  CreateTemplateScriptData,
  CreateTemplateScriptResponse,
  GetTemplateScriptData,
  GetTemplateScriptResponse,
  ListPostgresReplicationSlotData,
  ListPostgresReplicationSlotResponse,
  CreatePostgresReplicationSlotData,
  CreatePostgresReplicationSlotResponse,
  DeletePostgresReplicationSlotData,
  DeletePostgresReplicationSlotResponse,
  ListPostgresPublicationData,
  ListPostgresPublicationResponse,
  GetPostgresPublicationData,
  GetPostgresPublicationResponse,
  CreatePostgresPublicationData,
  CreatePostgresPublicationResponse,
  UpdatePostgresPublicationData,
  UpdatePostgresPublicationResponse,
  DeletePostgresPublicationData,
  DeletePostgresPublicationResponse,
  CreatePostgresTriggerData,
  CreatePostgresTriggerResponse,
  UpdatePostgresTriggerData,
  UpdatePostgresTriggerResponse,
  DeletePostgresTriggerData,
  DeletePostgresTriggerResponse,
  GetPostgresTriggerData,
  GetPostgresTriggerResponse,
  ListPostgresTriggersData,
  ListPostgresTriggersResponse,
  ExistsPostgresTriggerData,
  ExistsPostgresTriggerResponse,
  SetPostgresTriggerEnabledData,
  SetPostgresTriggerEnabledResponse,
  TestPostgresConnectionData,
  TestPostgresConnectionResponse,
  ...
  RemoveUserFromInstanceGroupResponse,
  ExportInstanceGroupsResponse,
  OverwriteInstanceGroupsData,
  OverwriteInstanceGroupsResponse,
  ListGroupsData,
  ListGroupsResponse,
  ListGroupNamesData,
  ListGroupNamesResponse,
  CreateGroupData,
  CreateGroupResponse,
  UpdateGroupData,
  UpdateGroupResponse,
  ...
  RemoveUserToGroupResponse,
  ListFoldersData,
  ListFoldersResponse,
  ListFolderNamesData,
  ListFolderNamesResponse,
  CreateFolderData,
  ...
  ListConfigsResponse,
  ListAutoscalingEventsData,
  ListAutoscalingEventsResponse,
  GetGranularAclsData,
  GetGranularAclsResponse,
  AddGranularAclsData,
  AddGranularAclsResponse,
  RemoveGranularAclsData,
  RemoveGranularAclsResponse,
  SetCaptureConfigData,
  SetCaptureConfigResponse,
  PingCaptureConfigData,
  PingCaptureConfigResponse,
  GetCaptureConfigsData,
  GetCaptureConfigsResponse,
  ListCapturesData,
  ListCapturesResponse,
  MoveCapturesAndConfigsData,
  MoveCapturesAndConfigsResponse,
  GetCaptureData,
  GetCaptureResponse,
  DeleteCaptureData,
  ...
  UnstarResponse,
  GetInputHistoryData,
  GetInputHistoryResponse,
  GetArgsFromHistoryOrSavedInputData,
  GetArgsFromHistoryOrSavedInputResponse,
  ListInputsData,
  ListInputsResponse,
  CreateInputData,
  CreateInputResponse,
  ...
  S3ResourceInfoData,
  S3ResourceInfoResponse,
  DatasetStorageTestConnectionData,
  DatasetStorageTestConnectionResponse,
  ListStoredFilesData,
  ListStoredFilesResponse,
  LoadFileMetadataData,
  LoadFileMetadataResponse,
  LoadFilePreviewData,
  LoadFilePreviewResponse,
  LoadParquetPreviewData,
  LoadParquetPreviewResponse,
  LoadTableRowCountData,
  LoadTableRowCountResponse,
  LoadCsvPreviewData,
  LoadCsvPreviewResponse,
  DeleteS3FileData,
  ...
  FileDownloadParquetAsCsvResponse,
  GetJobMetricsData,
  GetJobMetricsResponse,
  SetJobProgressData,
  SetJobProgressResponse,
  GetJobProgressData,
  ...
  GetLogFileData,
  GetLogFileResponse,
  ListConcurrencyGroupsResponse,
  DeleteConcurrencyGroupData,
  DeleteConcurrencyGroupResponse,
  GetConcurrencyKeyData,
  GetConcurrencyKeyResponse,
  ListExtendedJobsData,
  ListExtendedJobsResponse,
  SearchJobsIndexData,
  SearchJobsIndexResponse,
  SearchLogsIndexData,
  SearchLogsIndexResponse,
  CountSearchLogsIndexData,
  CountSearchLogsIndexResponse,
  ClearIndexData,
  ClearIndexResponse,
} from "./types.gen.ts";
 ...
 * @throws ApiError
 */
export const backendVersion = (): CancelablePromise<BackendVersionResponse> => {
...
export const backendUptodate =
  (): CancelablePromise<BackendUptodateResponse> => {
    return __request(OpenAPI, {
      method: "GET",
      url: "/uptodate",
    });
 ...
 * @throws ApiError
 */
export const getLicenseId = (): CancelablePromise<GetLicenseIdResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/ee_license",
  });
 ...
 * @throws ApiError
 */
export const getOpenApiYaml = (): CancelablePromise<GetOpenApiYamlResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/openapi.yaml",
  });
...
): CancelablePromise<GetAuditLogResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const listAuditLogs = (
  data: ListAuditLogsData
): CancelablePromise<ListAuditLogsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const isOwnerOfPath = (
  data: IsOwnerOfPathData
): CancelablePromise<IsOwnerOfPathResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const setPasswordForUser = (
  data: SetPasswordForUserData
): CancelablePromise<SetPasswordForUserResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const setLoginTypeForUser = (
  data: SetLoginTypeForUserData
): CancelablePromise<SetLoginTypeForUserResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const createUserGlobally = (
  data: CreateUserGloballyData
): CancelablePromise<CreateUserGloballyResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/users/create",
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const globalUserUpdate = (
  data: GlobalUserUpdateData
): CancelablePromise<GlobalUserUpdateResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const globalUsernameInfo = (
  data: GlobalUsernameInfoData
): CancelablePromise<GlobalUsernameInfoResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const globalUserRename = (
  data: GlobalUserRenameData
): CancelablePromise<GlobalUserRenameResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const globalUserDelete = (
  data: GlobalUserDeleteData
): CancelablePromise<GlobalUserDeleteResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
 ...
 * @throws ApiError
 */
export const globalUsersOverwrite = (
  data: GlobalUsersOverwriteData
): CancelablePromise<GlobalUsersOverwriteResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/users/overwrite",
    body: data.requestBody,
...
export const globalUsersExport =
  (): CancelablePromise<GlobalUsersExportResponse> => {
    return __request(OpenAPI, {
      method: "GET",
      url: "/users/export",
    });
...
export const isDomainAllowed =
  (): CancelablePromise<IsDomainAllowedResponse> => {
    return __request(OpenAPI, {
      method: "GET",
...
export const listUserWorkspaces =
  (): CancelablePromise<ListUserWorkspacesResponse> => {
    return __request(OpenAPI, {
      method: "GET",
 ...
 * @throws ApiError
 */
export const listWorkspacesAsSuperAdmin = (
  data: ListWorkspacesAsSuperAdminData = {}
): CancelablePromise<ListWorkspacesAsSuperAdminResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const existsWorkspace = (
  data: ExistsWorkspaceData
): CancelablePromise<ExistsWorkspaceResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const existsUsername = (
  data: ExistsUsernameData
): CancelablePromise<ExistsUsernameResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const getGlobal = (
  data: GetGlobalData
): CancelablePromise<GetGlobalResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const setGlobal = (
  data: SetGlobalData
): CancelablePromise<SetGlobalResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/settings/global/{key}",
    path: {
 ...
 * @throws ApiError
 */
export const getLocal = (): CancelablePromise<GetLocalResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/settings/local",
  });
 ...
 * @throws ApiError
 */
export const testCriticalChannels = (
  data: TestCriticalChannelsData
): CancelablePromise<TestCriticalChannelsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const getCriticalAlerts = (
  data: GetCriticalAlertsData = {}
): CancelablePromise<GetCriticalAlertsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const acknowledgeCriticalAlert = (
  data: AcknowledgeCriticalAlertData
): CancelablePromise<AcknowledgeCriticalAlertResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const acknowledgeAllCriticalAlerts =
  (): CancelablePromise<AcknowledgeAllCriticalAlertsResponse> => {
    return __request(OpenAPI, {
      method: "POST",
 ...
 * @throws ApiError
 */
export const testLicenseKey = (
  data: TestLicenseKeyData
): CancelablePromise<TestLicenseKeyResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const testObjectStorageConfig = (
  data: TestObjectStorageConfigData
): CancelablePromise<TestObjectStorageConfigResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const sendStats = (): CancelablePromise<SendStatsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const getLatestKeyRenewalAttempt =
  (): CancelablePromise<GetLatestKeyRenewalAttemptResponse> => {
    return __request(OpenAPI, {
      method: "GET",
 ...
 * @throws ApiError
 */
export const renewLicenseKey = (
  data: RenewLicenseKeyData = {}
): CancelablePromise<RenewLicenseKeyResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const createCustomerPortalSession = (
  data: CreateCustomerPortalSessionData = {}
): CancelablePromise<CreateCustomerPortalSessionResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const testMetadata = (
  data: TestMetadataData
): CancelablePromise<TestMetadataResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const listGlobalSettings =
  (): CancelablePromise<ListGlobalSettingsResponse> => {
    return __request(OpenAPI, {
      method: "GET",
...
export const getCurrentEmail =
  (): CancelablePromise<GetCurrentEmailResponse> => {
    return __request(OpenAPI, {
      method: "GET",
      url: "/users/email",
    });
...
): CancelablePromise<RefreshUserTokenResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const getTutorialProgress =
  (): CancelablePromise<GetTutorialProgressResponse> => {
    return __request(OpenAPI, {
      method: "GET",
...
export const updateTutorialProgress = (
  data: UpdateTutorialProgressData
): CancelablePromise<UpdateTutorialProgressResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/users/tutorial_progress",
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const leaveInstance = (): CancelablePromise<LeaveInstanceResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const getUsage = (): CancelablePromise<GetUsageResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/users/usage",
  });
 ...
 * @throws ApiError
 */
export const getRunnable = (): CancelablePromise<GetRunnableResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const globalWhoami = (): CancelablePromise<GlobalWhoamiResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/users/whoami",
  });
...
export const listWorkspaceInvites =
  (): CancelablePromise<ListWorkspaceInvitesResponse> => {
    return __request(OpenAPI, {
      method: "GET",
 ...
 * @throws ApiError
 */
export const whoami = (data: WhoamiData): CancelablePromise<WhoamiResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const declineInvite = (
  data: DeclineInviteData
): CancelablePromise<DeclineInviteResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
): CancelablePromise<DeleteInviteResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const archiveWorkspace = (
  data: ArchiveWorkspaceData
): CancelablePromise<ArchiveWorkspaceResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const unarchiveWorkspace = (
  data: UnarchiveWorkspaceData
): CancelablePromise<UnarchiveWorkspaceResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
): CancelablePromise<DeleteWorkspaceResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
...
): CancelablePromise<LeaveWorkspaceResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const getWorkspaceName = (
  data: GetWorkspaceNameData
): CancelablePromise<GetWorkspaceNameResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const changeWorkspaceName = (
  data: ChangeWorkspaceNameData
): CancelablePromise<ChangeWorkspaceNameResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const changeWorkspaceId = (
  data: ChangeWorkspaceIdData
): CancelablePromise<ChangeWorkspaceIdResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const changeWorkspaceColor = (
  data: ChangeWorkspaceColorData
): CancelablePromise<ChangeWorkspaceColorResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const whois = (data: WhoisData): CancelablePromise<WhoisResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const updateOperatorSettings = (
  data: UpdateOperatorSettingsData
): CancelablePromise<UpdateOperatorSettingsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const existsEmail = (
  data: ExistsEmailData
): CancelablePromise<ExistsEmailResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listUsersAsSuperAdmin = (
  data: ListUsersAsSuperAdminData = {}
): CancelablePromise<ListUsersAsSuperAdminResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const listPendingInvites = (
  data: ListPendingInvitesData
): CancelablePromise<ListPendingInvitesResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getDeployTo = (
  data: GetDeployToData
): CancelablePromise<GetDeployToResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const getIsPremium = (
  data: GetIsPremiumData
): CancelablePromise<GetIsPremiumResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const getPremiumInfo = (
  data: GetPremiumInfoData
): CancelablePromise<GetPremiumInfoResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const setAutomaticBilling = (
  data: SetAutomaticBillingData
): CancelablePromise<SetAutomaticBillingResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const getThresholdAlert = (
  data: GetThresholdAlertData
): CancelablePromise<GetThresholdAlertResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const setThresholdAlert = (
  data: SetThresholdAlertData
): CancelablePromise<SetThresholdAlertResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/w/{workspace}/workspaces/threshold_alert",
    path: {
 ...
 * @throws ApiError
 */
export const editSlackCommand = (
  data: EditSlackCommandData
): CancelablePromise<EditSlackCommandResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const editTeamsCommand = (
  data: EditTeamsCommandData
): CancelablePromise<EditTeamsCommandResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const listAvailableTeamsIds = (
  data: ListAvailableTeamsIdsData
): CancelablePromise<ListAvailableTeamsIdsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listAvailableTeamsChannels = (
  data: ListAvailableTeamsChannelsData
): CancelablePromise<ListAvailableTeamsChannelsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const connectTeams = (
  data: ConnectTeamsData
): CancelablePromise<ConnectTeamsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const runSlackMessageTestJob = (
  data: RunSlackMessageTestJobData
): CancelablePromise<RunSlackMessageTestJobResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const runTeamsMessageTestJob = (
  data: RunTeamsMessageTestJobData
): CancelablePromise<RunTeamsMessageTestJobResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const editDeployTo = (
  data: EditDeployToData
): CancelablePromise<EditDeployToResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const editAutoInvite = (
  data: EditAutoInviteData
): CancelablePromise<EditAutoInviteResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
): CancelablePromise<EditWebhookResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const editCopilotConfig = (
  data: EditCopilotConfigData
): CancelablePromise<EditCopilotConfigResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const getCopilotInfo = (
  data: GetCopilotInfoData
): CancelablePromise<GetCopilotInfoResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const editErrorHandler = (
  data: EditErrorHandlerData
): CancelablePromise<EditErrorHandlerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const editLargeFileStorageConfig = (
  data: EditLargeFileStorageConfigData
): CancelablePromise<EditLargeFileStorageConfigResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const editWorkspaceGitSyncConfig = (
  data: EditWorkspaceGitSyncConfigData
): CancelablePromise<EditWorkspaceGitSyncConfigResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const editWorkspaceDeployUiSettings = (
  data: EditWorkspaceDeployUiSettingsData
): CancelablePromise<EditWorkspaceDeployUiSettingsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const editWorkspaceDefaultApp = (
  data: EditWorkspaceDefaultAppData
): CancelablePromise<EditWorkspaceDefaultAppResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const editDefaultScripts = (
  data: EditDefaultScriptsData
): CancelablePromise<EditDefaultScriptsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const getDefaultScripts = (
  data: GetDefaultScriptsData
): CancelablePromise<GetDefaultScriptsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/w/{workspace}/workspaces/default_scripts",
    path: {
...
export const setEnvironmentVariable = (
  data: SetEnvironmentVariableData
): CancelablePromise<SetEnvironmentVariableResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const getWorkspaceEncryptionKey = (
  data: GetWorkspaceEncryptionKeyData
): CancelablePromise<GetWorkspaceEncryptionKeyResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const setWorkspaceEncryptionKey = (
  data: SetWorkspaceEncryptionKeyData
): CancelablePromise<SetWorkspaceEncryptionKeyResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/w/{workspace}/workspaces/encryption_key",
    path: {
 ...
 * @throws ApiError
 */
export const getWorkspaceDefaultApp = (
  data: GetWorkspaceDefaultAppData
): CancelablePromise<GetWorkspaceDefaultAppResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getLargeFileStorageConfig = (
  data: GetLargeFileStorageConfigData
): CancelablePromise<GetLargeFileStorageConfigResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const getWorkspaceUsage = (
  data: GetWorkspaceUsageData
): CancelablePromise<GetWorkspaceUsageResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getUsedTriggers = (
  data: GetUsedTriggersData
): CancelablePromise<GetUsedTriggersResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listUsersUsage = (
  data: ListUsersUsageData
): CancelablePromise<ListUsersUsageResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const listUsernames = (
  data: ListUsernamesData
): CancelablePromise<ListUsernamesResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const usernameToEmail = (
  data: UsernameToEmailData
): CancelablePromise<UsernameToEmailResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const createTokenImpersonate = (
  data: CreateTokenImpersonateData
): CancelablePromise<CreateTokenImpersonateResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const listTokens = (
  data: ListTokensData = {}
): CancelablePromise<ListTokensResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const getOidcToken = (
  data: GetOidcTokenData
): CancelablePromise<GetOidcTokenResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
): CancelablePromise<CreateVariableResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const encryptValue = (
  data: EncryptValueData
): CancelablePromise<EncryptValueResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
): CancelablePromise<UpdateVariableResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const getVariableValue = (
  data: GetVariableValueData
): CancelablePromise<GetVariableValueResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const existsVariable = (
  data: ExistsVariableData
): CancelablePromise<ExistsVariableResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const listVariable = (
  data: ListVariableData
): CancelablePromise<ListVariableResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listContextualVariables = (
  data: ListContextualVariablesData
): CancelablePromise<ListContextualVariablesResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const workspaceGetCriticalAlerts = (
  data: WorkspaceGetCriticalAlertsData
): CancelablePromise<WorkspaceGetCriticalAlertsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const workspaceAcknowledgeCriticalAlert = (
  data: WorkspaceAcknowledgeCriticalAlertData
): CancelablePromise<WorkspaceAcknowledgeCriticalAlertResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const workspaceAcknowledgeAllCriticalAlerts = (
  data: WorkspaceAcknowledgeAllCriticalAlertsData
): CancelablePromise<WorkspaceAcknowledgeAllCriticalAlertsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const workspaceMuteCriticalAlertsUi = (
  data: WorkspaceMuteCriticalAlertsUiData
): CancelablePromise<WorkspaceMuteCriticalAlertsUiResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
): CancelablePromise<LoginWithOauthResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const connectSlackCallback = (
  data: ConnectSlackCallbackData
): CancelablePromise<ConnectSlackCallbackResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const connectSlackCallbackInstance = (
  data: ConnectSlackCallbackInstanceData
): CancelablePromise<ConnectSlackCallbackInstanceResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const connectCallback = (
  data: ConnectCallbackData
): CancelablePromise<ConnectCallbackResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
): CancelablePromise<DisconnectAccountResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const disconnectSlack = (
  data: DisconnectSlackData
): CancelablePromise<DisconnectSlackResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const disconnectTeams = (
  data: DisconnectTeamsData
): CancelablePromise<DisconnectTeamsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/w/{workspace}/oauth/disconnect_teams",
    path: {
      workspace: data.workspace,
    },
  });
 ...
 * @throws ApiError
 */
export const listOauthLogins =
  (): CancelablePromise<ListOauthLoginsResponse> => {
    return __request(OpenAPI, {
      method: "GET",
 ...
 * @throws ApiError
 */
export const listOauthConnects =
  (): CancelablePromise<ListOauthConnectsResponse> => {
    return __request(OpenAPI, {
      method: "GET",
 ...
 * @throws ApiError
 */
export const getOauthConnect = (
  data: GetOauthConnectData
): CancelablePromise<GetOauthConnectResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const syncTeams = (): CancelablePromise<SyncTeamsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/teams/sync",
  });
...
): CancelablePromise<SendMessageToConversationResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
): CancelablePromise<UpdateResourceResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const updateResourceValue = (
  data: UpdateResourceValueData
): CancelablePromise<UpdateResourceValueResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const getResourceValueInterpolated = (
  data: GetResourceValueInterpolatedData
): CancelablePromise<GetResourceValueInterpolatedResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const getResourceValue = (
  data: GetResourceValueData
): CancelablePromise<GetResourceValueResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const existsResource = (
  data: ExistsResourceData
): CancelablePromise<ExistsResourceResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
): CancelablePromise<ListResourceResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listSearchResource = (
  data: ListSearchResourceData
): CancelablePromise<ListSearchResourceResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
): CancelablePromise<ListResourceNamesResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
): CancelablePromise<CreateResourceTypeResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const fileResourceTypeToFileExtMap = (
  data: FileResourceTypeToFileExtMapData
): CancelablePromise<FileResourceTypeToFileExtMapResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const deleteResourceType = (
  data: DeleteResourceTypeData
): CancelablePromise<DeleteResourceTypeResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
...
export const updateResourceType = (
  data: UpdateResourceTypeData
): CancelablePromise<UpdateResourceTypeResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
): CancelablePromise<GetResourceTypeResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const existsResourceType = (
  data: ExistsResourceTypeData
): CancelablePromise<ExistsResourceTypeResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const listResourceType = (
  data: ListResourceTypeData
): CancelablePromise<ListResourceTypeResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listResourceTypeNames = (
  data: ListResourceTypeNamesData
): CancelablePromise<ListResourceTypeNamesResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const queryResourceTypes = (
  data: QueryResourceTypesData
): CancelablePromise<QueryResourceTypesResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listHubIntegrations = (
  data: ListHubIntegrationsData = {}
): CancelablePromise<ListHubIntegrationsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listHubFlows = (): CancelablePromise<ListHubFlowsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/flows/hub/list",
  });
 ...
 * @throws ApiError
 */
export const getHubFlowById = (
  data: GetHubFlowByIdData
): CancelablePromise<GetHubFlowByIdResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listHubApps = (): CancelablePromise<ListHubAppsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/apps/hub/list",
  });
 ...
 * @throws ApiError
 */
export const getHubAppById = (
  data: GetHubAppByIdData
): CancelablePromise<GetHubAppByIdResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/apps/hub/get/{id}",
    path: {
 ...
 * @throws ApiError
 */
export const getPublicAppByCustomPath = (
  data: GetPublicAppByCustomPathData
): CancelablePromise<GetPublicAppByCustomPathResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getHubScriptContentByPath = (
  data: GetHubScriptContentByPathData
): CancelablePromise<GetHubScriptContentByPathResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getHubScriptByPath = (
  data: GetHubScriptByPathData
): CancelablePromise<GetHubScriptByPathResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getTopHubScripts = (
  data: GetTopHubScriptsData = {}
): CancelablePromise<GetTopHubScriptsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/scripts/hub/top",
    query: {
 ...
 * @throws ApiError
 */
export const queryHubScripts = (
  data: QueryHubScriptsData
): CancelablePromise<QueryHubScriptsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listSearchScript = (
  data: ListSearchScriptData
): CancelablePromise<ListSearchScriptResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const listScripts = (
  data: ListScriptsData
): CancelablePromise<ListScriptsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listScriptPaths = (
  data: ListScriptPathsData
): CancelablePromise<ListScriptPathsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
): CancelablePromise<DeleteDraftResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
...
): CancelablePromise<CreateScriptResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const toggleWorkspaceErrorHandlerForScript = (
  data: ToggleWorkspaceErrorHandlerForScriptData
): CancelablePromise<ToggleWorkspaceErrorHandlerForScriptResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const getCustomTags = (
  data: GetCustomTagsData = {}
): CancelablePromise<GetCustomTagsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const geDefaultTags = (): CancelablePromise<GeDefaultTagsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const isDefaultTagsPerWorkspace =
  (): CancelablePromise<IsDefaultTagsPerWorkspaceResponse> => {
    return __request(OpenAPI, {
      method: "GET",
 ...
 * @throws ApiError
 */
export const archiveScriptByPath = (
  data: ArchiveScriptByPathData
): CancelablePromise<ArchiveScriptByPathResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const archiveScriptByHash = (
  data: ArchiveScriptByHashData
): CancelablePromise<ArchiveScriptByHashResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const deleteScriptByHash = (
  data: DeleteScriptByHashData
): CancelablePromise<DeleteScriptByHashResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const deleteScriptByPath = (
  data: DeleteScriptByPathData
): CancelablePromise<DeleteScriptByPathResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    ...
    query: {
      keep_captures: data.keepCaptures,
    },
  });
};
 ...
 * @throws ApiError
 */
export const getScriptByPath = (
  data: GetScriptByPathData
): CancelablePromise<GetScriptByPathResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getTriggersCountOfScript = (
  data: GetTriggersCountOfScriptData
): CancelablePromise<GetTriggersCountOfScriptResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listTokensOfScript = (
  data: ListTokensOfScriptData
): CancelablePromise<ListTokensOfScriptResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getScriptByPathWithDraft = (
  data: GetScriptByPathWithDraftData
): CancelablePromise<GetScriptByPathWithDraftResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getScriptHistoryByPath = (
  data: GetScriptHistoryByPathData
): CancelablePromise<GetScriptHistoryByPathResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getScriptLatestVersion = (
  data: GetScriptLatestVersionData
): CancelablePromise<GetScriptLatestVersionResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const updateScriptHistory = (
  data: UpdateScriptHistoryData
): CancelablePromise<UpdateScriptHistoryResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const rawScriptByPath = (
  data: RawScriptByPathData
): CancelablePromise<RawScriptByPathResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const rawScriptByPathTokened = (
  data: RawScriptByPathTokenedData
): CancelablePromise<RawScriptByPathTokenedResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const existsScriptByPath = (
  data: ExistsScriptByPathData
): CancelablePromise<ExistsScriptByPathResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getScriptByHash = (
  data: GetScriptByHashData
): CancelablePromise<GetScriptByHashResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const rawScriptByHash = (
  data: RawScriptByHashData
): CancelablePromise<RawScriptByHashResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getScriptDeploymentStatus = (
  data: GetScriptDeploymentStatusData
): CancelablePromise<GetScriptDeploymentStatusResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const runScriptByPath = (
  data: RunScriptByPathData
): CancelablePromise<RunScriptByPathResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const openaiSyncScriptByPath = (
  data: OpenaiSyncScriptByPathData
): CancelablePromise<OpenaiSyncScriptByPathResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const runWaitResultScriptByPath = (
  data: RunWaitResultScriptByPathData
): CancelablePromise<RunWaitResultScriptByPathResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const runWaitResultScriptByPathGet = (
  data: RunWaitResultScriptByPathGetData
): CancelablePromise<RunWaitResultScriptByPathGetResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/w/{workspace}/jobs/run_wait_result/p/{path}",
    path: {
 ...
 * @throws ApiError
 */
export const openaiSyncFlowByPath = (
  data: OpenaiSyncFlowByPathData
): CancelablePromise<OpenaiSyncFlowByPathResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const runWaitResultFlowByPath = (
  data: RunWaitResultFlowByPathData
): CancelablePromise<RunWaitResultFlowByPathResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const resultById = (
  data: ResultByIdData
): CancelablePromise<ResultByIdResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listFlowPaths = (
  data: ListFlowPathsData
): CancelablePromise<ListFlowPathsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listSearchFlow = (
  data: ListSearchFlowData
): CancelablePromise<ListSearchFlowResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const listFlows = (
  data: ListFlowsData
): CancelablePromise<ListFlowsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const getFlowHistory = (
  data: GetFlowHistoryData
): CancelablePromise<GetFlowHistoryResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getFlowLatestVersion = (
  data: GetFlowLatestVersionData
): CancelablePromise<GetFlowLatestVersionResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listFlowPathsFromWorkspaceRunnable = (
  data: ListFlowPathsFromWorkspaceRunnableData
): CancelablePromise<ListFlowPathsFromWorkspaceRunnableResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/w/{workspace}/flows/list_paths_from_workspace_runnable/{runnable_kind}/{path}",
    path: {
      workspace: data.workspace,
...
export const getFlowVersion = (
  data: GetFlowVersionData
): CancelablePromise<GetFlowVersionResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const updateFlowHistory = (
  data: UpdateFlowHistoryData
): CancelablePromise<UpdateFlowHistoryResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const getFlowByPath = (
  data: GetFlowByPathData
): CancelablePromise<GetFlowByPathResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getFlowDeploymentStatus = (
  data: GetFlowDeploymentStatusData
): CancelablePromise<GetFlowDeploymentStatusResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getTriggersCountOfFlow = (
  data: GetTriggersCountOfFlowData
): CancelablePromise<GetTriggersCountOfFlowResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listTokensOfFlow = (
  data: ListTokensOfFlowData
): CancelablePromise<ListTokensOfFlowResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const toggleWorkspaceErrorHandlerForFlow = (
  data: ToggleWorkspaceErrorHandlerForFlowData
): CancelablePromise<ToggleWorkspaceErrorHandlerForFlowResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const getFlowByPathWithDraft = (
  data: GetFlowByPathWithDraftData
): CancelablePromise<GetFlowByPathWithDraftResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const existsFlowByPath = (
  data: ExistsFlowByPathData
): CancelablePromise<ExistsFlowByPathResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const createFlow = (
  data: CreateFlowData
): CancelablePromise<CreateFlowResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const updateFlow = (
  data: UpdateFlowData
): CancelablePromise<UpdateFlowResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const archiveFlowByPath = (
  data: ArchiveFlowByPathData
): CancelablePromise<ArchiveFlowByPathResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const deleteFlowByPath = (
  data: DeleteFlowByPathData
): CancelablePromise<DeleteFlowByPathResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
 ...
 * @throws ApiError
 */
export const listRawApps = (
  data: ListRawAppsData
): CancelablePromise<ListRawAppsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const existsRawApp = (
  data: ExistsRawAppData
): CancelablePromise<ExistsRawAppResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getRawAppData = (
  data: GetRawAppDataData
): CancelablePromise<GetRawAppDataResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listSearchApp = (
  data: ListSearchAppData
): CancelablePromise<ListSearchAppResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const existsApp = (
  data: ExistsAppData
): CancelablePromise<ExistsAppResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getAppByPath = (
  data: GetAppByPathData
): CancelablePromise<GetAppByPathResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getAppLiteByPath = (
  data: GetAppLiteByPathData
): CancelablePromise<GetAppLiteByPathResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getAppByPathWithDraft = (
  data: GetAppByPathWithDraftData
): CancelablePromise<GetAppByPathWithDraftResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getAppHistoryByPath = (
  data: GetAppHistoryByPathData
): CancelablePromise<GetAppHistoryByPathResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const getAppLatestVersion = (
  data: GetAppLatestVersionData
): CancelablePromise<GetAppLatestVersionResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const updateAppHistory = (
  data: UpdateAppHistoryData
): CancelablePromise<UpdateAppHistoryResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const getPublicAppBySecret = (
  data: GetPublicAppBySecretData
): CancelablePromise<GetPublicAppBySecretResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const getPublicResource = (
  data: GetPublicResourceData
): CancelablePromise<GetPublicResourceResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getPublicSecretOfApp = (
  data: GetPublicSecretOfAppData
): CancelablePromise<GetPublicSecretOfAppResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getAppByVersion = (
  data: GetAppByVersionData
): CancelablePromise<GetAppByVersionResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const createRawApp = (
  data: CreateRawAppData
): CancelablePromise<CreateRawAppResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const updateRawApp = (
  data: UpdateRawAppData
): CancelablePromise<UpdateRawAppResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const deleteRawApp = (
  data: DeleteRawAppData
): CancelablePromise<DeleteRawAppResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
 ...
 * @throws ApiError
 */
export const customPathExists = (
  data: CustomPathExistsData
): CancelablePromise<CustomPathExistsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const executeComponent = (
  data: ExecuteComponentData
): CancelablePromise<ExecuteComponentResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const uploadS3FileFromApp = (
  data: UploadS3FileFromAppData
): CancelablePromise<UploadS3FileFromAppResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/w/{workspace}/apps_u/upload_s3_file/{path}",
    path: {
      workspace: data.workspace,
      path: data.path,
    },
 ...
 * @throws ApiError
 */
export const deleteS3FileFromApp = (
  data: DeleteS3FileFromAppData
): CancelablePromise<DeleteS3FileFromAppResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
    url: "/w/{workspace}/apps_u/delete_s3_file",
    path: {
      workspace: data.workspace,
    },
    query: {
 ...
 * @throws ApiError
 */
export const runFlowByPath = (
  data: RunFlowByPathData
): CancelablePromise<RunFlowByPathResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const restartFlowAtStep = (
  data: RestartFlowAtStepData
): CancelablePromise<RestartFlowAtStepResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const runScriptByHash = (
  data: RunScriptByHashData
): CancelablePromise<RunScriptByHashResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const runScriptPreview = (
  data: RunScriptPreviewData
): CancelablePromise<RunScriptPreviewResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const runCodeWorkflowTask = (
  data: RunCodeWorkflowTaskData
): CancelablePromise<RunCodeWorkflowTaskResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const runRawScriptDependencies = (
  data: RunRawScriptDependenciesData
): CancelablePromise<RunRawScriptDependenciesResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const runFlowPreview = (
  data: RunFlowPreviewData
): CancelablePromise<RunFlowPreviewResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const listQueue = (
  data: ListQueueData
): CancelablePromise<ListQueueResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const getQueueCount = (
  data: GetQueueCountData
): CancelablePromise<GetQueueCountResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const getCompletedCount = (
  data: GetCompletedCountData
): CancelablePromise<GetCompletedCountResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const countCompletedJobs = (
  data: CountCompletedJobsData
): CancelablePromise<CountCompletedJobsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listFilteredUuids = (
  data: ListFilteredUuidsData
): CancelablePromise<ListFilteredUuidsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const cancelSelection = (
  data: CancelSelectionData
): CancelablePromise<CancelSelectionResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const listCompletedJobs = (
  data: ListCompletedJobsData
): CancelablePromise<ListCompletedJobsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
  ...
  return __request(OpenAPI, {
    ...
    query: {
      ...
      created_or_started_after_completed_jobs:
        data.createdOrStartedAfterCompletedJobs,
      job_kinds: data.jobKinds,
      suspended: data.suspended,
      args: data.args,
      tag: data.tag,
 ...
 * @throws ApiError
 */
export const getDbClock = (): CancelablePromise<GetDbClockResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/jobs/db_clock",
  });
 ...
 * @throws ApiError
 */
export const countJobsByTag = (
  data: CountJobsByTagData = {}
): CancelablePromise<CountJobsByTagResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getJob = (data: GetJobData): CancelablePromise<GetJobResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getRootJobId = (
  data: GetRootJobIdData
): CancelablePromise<GetRootJobIdResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const getJobLogs = (
  data: GetJobLogsData
): CancelablePromise<GetJobLogsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getJobArgs = (
  data: GetJobArgsData
): CancelablePromise<GetJobArgsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getJobUpdates = (
  data: GetJobUpdatesData
): CancelablePromise<GetJobUpdatesResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getLogFileFromStore = (
  data: GetLogFileFromStoreData
): CancelablePromise<GetLogFileFromStoreResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getFlowDebugInfo = (
  data: GetFlowDebugInfoData
): CancelablePromise<GetFlowDebugInfoResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getCompletedJob = (
  data: GetCompletedJobData
): CancelablePromise<GetCompletedJobResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const getCompletedJobResult = (
  data: GetCompletedJobResultData
): CancelablePromise<GetCompletedJobResultResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getCompletedJobResultMaybe = (
  data: GetCompletedJobResultMaybeData
): CancelablePromise<GetCompletedJobResultMaybeResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const deleteCompletedJob = (
  data: DeleteCompletedJobData
): CancelablePromise<DeleteCompletedJobResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const cancelQueuedJob = (
  data: CancelQueuedJobData
): CancelablePromise<CancelQueuedJobResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const cancelPersistentQueuedJobs = (
  data: CancelPersistentQueuedJobsData
): CancelablePromise<CancelPersistentQueuedJobsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const forceCancelQueuedJob = (
  data: ForceCancelQueuedJobData
): CancelablePromise<ForceCancelQueuedJobResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const createJobSignature = (
  data: CreateJobSignatureData
): CancelablePromise<CreateJobSignatureResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const getResumeUrls = (
  data: GetResumeUrlsData
): CancelablePromise<GetResumeUrlsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getSlackApprovalPayload = (
  data: GetSlackApprovalPayloadData
): CancelablePromise<GetSlackApprovalPayloadResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const resumeSuspendedJobGet = (
  data: ResumeSuspendedJobGetData
): CancelablePromise<ResumeSuspendedJobGetResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const resumeSuspendedJobPost = (
  data: ResumeSuspendedJobPostData
): CancelablePromise<ResumeSuspendedJobPostResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/w/{workspace}/jobs_u/resume/{id}/{resume_id}/{signature}",
    path: {
 ...
 * @throws ApiError
 */
export const setFlowUserState = (
  data: SetFlowUserStateData
): CancelablePromise<SetFlowUserStateResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const getFlowUserState = (
  data: GetFlowUserStateData
): CancelablePromise<GetFlowUserStateResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/w/{workspace}/jobs/flow/user_states/{id}/{key}",
    path: {
 ...
 * @throws ApiError
 */
export const resumeSuspendedFlowAsOwner = (
  data: ResumeSuspendedFlowAsOwnerData
): CancelablePromise<ResumeSuspendedFlowAsOwnerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const cancelSuspendedJobGet = (
  data: CancelSuspendedJobGetData
): CancelablePromise<CancelSuspendedJobGetResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const cancelSuspendedJobPost = (
  data: CancelSuspendedJobPostData
): CancelablePromise<CancelSuspendedJobPostResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/w/{workspace}/jobs_u/cancel/{id}/{resume_id}/{signature}",
    path: {
 ...
 * @throws ApiError
 */
export const getSuspendedJobFlow = (
  data: GetSuspendedJobFlowData
): CancelablePromise<GetSuspendedJobFlowResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
): CancelablePromise<PreviewScheduleResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
): CancelablePromise<UpdateScheduleResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const setScheduleEnabled = (
  data: SetScheduleEnabledData
): CancelablePromise<SetScheduleEnabledResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
): CancelablePromise<DeleteScheduleResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
...
): CancelablePromise<GetScheduleResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const existsSchedule = (
  data: ExistsScheduleData
): CancelablePromise<ExistsScheduleResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const listSchedules = (
  data: ListSchedulesData
): CancelablePromise<ListSchedulesResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listSchedulesWithJobs = (
  data: ListSchedulesWithJobsData
): CancelablePromise<ListSchedulesWithJobsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const setDefaultErrorOrRecoveryHandler = (
  data: SetDefaultErrorOrRecoveryHandlerData
): CancelablePromise<SetDefaultErrorOrRecoveryHandlerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const createHttpTrigger = (
  data: CreateHttpTriggerData
): CancelablePromise<CreateHttpTriggerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const updateHttpTrigger = (
  data: UpdateHttpTriggerData
): CancelablePromise<UpdateHttpTriggerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const deleteHttpTrigger = (
  data: DeleteHttpTriggerData
): CancelablePromise<DeleteHttpTriggerResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
 ...
 * @throws ApiError
 */
export const getHttpTrigger = (
  data: GetHttpTriggerData
): CancelablePromise<GetHttpTriggerResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listHttpTriggers = (
  data: ListHttpTriggersData
): CancelablePromise<ListHttpTriggersResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const existsHttpTrigger = (
  data: ExistsHttpTriggerData
): CancelablePromise<ExistsHttpTriggerResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const existsRoute = (
  data: ExistsRouteData
): CancelablePromise<ExistsRouteResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const createWebsocketTrigger = (
  data: CreateWebsocketTriggerData
): CancelablePromise<CreateWebsocketTriggerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const updateWebsocketTrigger = (
  data: UpdateWebsocketTriggerData
): CancelablePromise<UpdateWebsocketTriggerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const deleteWebsocketTrigger = (
  data: DeleteWebsocketTriggerData
): CancelablePromise<DeleteWebsocketTriggerResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
 ...
 * @throws ApiError
 */
export const getWebsocketTrigger = (
  data: GetWebsocketTriggerData
): CancelablePromise<GetWebsocketTriggerResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listWebsocketTriggers = (
  data: ListWebsocketTriggersData
): CancelablePromise<ListWebsocketTriggersResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const existsWebsocketTrigger = (
  data: ExistsWebsocketTriggerData
): CancelablePromise<ExistsWebsocketTriggerResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const setWebsocketTriggerEnabled = (
  data: SetWebsocketTriggerEnabledData
): CancelablePromise<SetWebsocketTriggerEnabledResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const testWebsocketConnection = (
  data: TestWebsocketConnectionData
): CancelablePromise<TestWebsocketConnectionResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/w/{workspace}/websocket_triggers/test",
    path: {
      workspace: data.workspace,
    },
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const createKafkaTrigger = (
  data: CreateKafkaTriggerData
): CancelablePromise<CreateKafkaTriggerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const updateKafkaTrigger = (
  data: UpdateKafkaTriggerData
): CancelablePromise<UpdateKafkaTriggerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const deleteKafkaTrigger = (
  data: DeleteKafkaTriggerData
): CancelablePromise<DeleteKafkaTriggerResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
 ...
 * @throws ApiError
 */
export const getKafkaTrigger = (
  data: GetKafkaTriggerData
): CancelablePromise<GetKafkaTriggerResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listKafkaTriggers = (
  data: ListKafkaTriggersData
): CancelablePromise<ListKafkaTriggersResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const existsKafkaTrigger = (
  data: ExistsKafkaTriggerData
): CancelablePromise<ExistsKafkaTriggerResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const setKafkaTriggerEnabled = (
  data: SetKafkaTriggerEnabledData
): CancelablePromise<SetKafkaTriggerEnabledResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const testKafkaConnection = (
  data: TestKafkaConnectionData
): CancelablePromise<TestKafkaConnectionResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/w/{workspace}/kafka_triggers/test",
    path: {
      workspace: data.workspace,
    },
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const createNatsTrigger = (
  data: CreateNatsTriggerData
): CancelablePromise<CreateNatsTriggerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const updateNatsTrigger = (
  data: UpdateNatsTriggerData
): CancelablePromise<UpdateNatsTriggerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const deleteNatsTrigger = (
  data: DeleteNatsTriggerData
): CancelablePromise<DeleteNatsTriggerResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
 ...
 * @throws ApiError
 */
export const getNatsTrigger = (
  data: GetNatsTriggerData
): CancelablePromise<GetNatsTriggerResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listNatsTriggers = (
  data: ListNatsTriggersData
): CancelablePromise<ListNatsTriggersResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const existsNatsTrigger = (
  data: ExistsNatsTriggerData
): CancelablePromise<ExistsNatsTriggerResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const setNatsTriggerEnabled = (
  data: SetNatsTriggerEnabledData
): CancelablePromise<SetNatsTriggerEnabledResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const testNatsConnection = (
  data: TestNatsConnectionData
): CancelablePromise<TestNatsConnectionResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/w/{workspace}/nats_triggers/test",
    path: {
      workspace: data.workspace,
    },
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const createSqsTrigger = (
  data: CreateSqsTriggerData
): CancelablePromise<CreateSqsTriggerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/w/{workspace}/sqs_triggers/create",
    path: {
      workspace: data.workspace,
    },
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const updateSqsTrigger = (
  data: UpdateSqsTriggerData
): CancelablePromise<UpdateSqsTriggerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/w/{workspace}/sqs_triggers/update/{path}",
    path: {
      workspace: data.workspace,
      path: data.path,
    },
 ...
 * @throws ApiError
 */
export const deleteSqsTrigger = (
  data: DeleteSqsTriggerData
): CancelablePromise<DeleteSqsTriggerResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
    url: "/w/{workspace}/sqs_triggers/delete/{path}",
    path: {
      workspace: data.workspace,
      path: data.path,
    },
 ...
 * @throws ApiError
 */
export const getSqsTrigger = (
  data: GetSqsTriggerData
): CancelablePromise<GetSqsTriggerResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/w/{workspace}/sqs_triggers/get/{path}",
    path: {
      workspace: data.workspace,
      path: data.path,
    },
 ...
 * @throws ApiError
 */
export const listSqsTriggers = (
  data: ListSqsTriggersData
): CancelablePromise<ListSqsTriggersResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/w/{workspace}/sqs_triggers/list",
    path: {
      workspace: data.workspace,
    },
    query: {
 ...
 * @throws ApiError
 */
export const existsSqsTrigger = (
  data: ExistsSqsTriggerData
): CancelablePromise<ExistsSqsTriggerResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const setSqsTriggerEnabled = (
  data: SetSqsTriggerEnabledData
): CancelablePromise<SetSqsTriggerEnabledResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const testSqsConnection = (
  data: TestSqsConnectionData
): CancelablePromise<TestSqsConnectionResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const createMqttTrigger = (
  data: CreateMqttTriggerData
): CancelablePromise<CreateMqttTriggerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const updateMqttTrigger = (
  data: UpdateMqttTriggerData
): CancelablePromise<UpdateMqttTriggerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const deleteMqttTrigger = (
  data: DeleteMqttTriggerData
): CancelablePromise<DeleteMqttTriggerResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
 ...
 * @throws ApiError
 */
export const getMqttTrigger = (
  data: GetMqttTriggerData
): CancelablePromise<GetMqttTriggerResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listMqttTriggers = (
  data: ListMqttTriggersData
): CancelablePromise<ListMqttTriggersResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const existsMqttTrigger = (
  data: ExistsMqttTriggerData
): CancelablePromise<ExistsMqttTriggerResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const setMqttTriggerEnabled = (
  data: SetMqttTriggerEnabledData
): CancelablePromise<SetMqttTriggerEnabledResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const testMqttConnection = (
  data: TestMqttConnectionData
): CancelablePromise<TestMqttConnectionResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const isValidPostgresConfiguration = (
  data: IsValidPostgresConfigurationData
): CancelablePromise<IsValidPostgresConfigurationResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const createTemplateScript = (
  data: CreateTemplateScriptData
): CancelablePromise<CreateTemplateScriptResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const getTemplateScript = (
  data: GetTemplateScriptData
): CancelablePromise<GetTemplateScriptResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listPostgresReplicationSlot = (
  data: ListPostgresReplicationSlotData
): CancelablePromise<ListPostgresReplicationSlotResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const createPostgresReplicationSlot = (
  data: CreatePostgresReplicationSlotData
): CancelablePromise<CreatePostgresReplicationSlotResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const deletePostgresReplicationSlot = (
  data: DeletePostgresReplicationSlotData
): CancelablePromise<DeletePostgresReplicationSlotResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
 ...
 * @throws ApiError
 */
export const listPostgresPublication = (
  data: ListPostgresPublicationData
): CancelablePromise<ListPostgresPublicationResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getPostgresPublication = (
  data: GetPostgresPublicationData
): CancelablePromise<GetPostgresPublicationResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const createPostgresPublication = (
  data: CreatePostgresPublicationData
): CancelablePromise<CreatePostgresPublicationResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const updatePostgresPublication = (
  data: UpdatePostgresPublicationData
): CancelablePromise<UpdatePostgresPublicationResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const deletePostgresPublication = (
  data: DeletePostgresPublicationData
): CancelablePromise<DeletePostgresPublicationResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
 ...
 * @throws ApiError
 */
export const createPostgresTrigger = (
  data: CreatePostgresTriggerData
): CancelablePromise<CreatePostgresTriggerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const updatePostgresTrigger = (
  data: UpdatePostgresTriggerData
): CancelablePromise<UpdatePostgresTriggerResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const deletePostgresTrigger = (
  data: DeletePostgresTriggerData
): CancelablePromise<DeletePostgresTriggerResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
 ...
 * @throws ApiError
 */
export const getPostgresTrigger = (
  data: GetPostgresTriggerData
): CancelablePromise<GetPostgresTriggerResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listPostgresTriggers = (
  data: ListPostgresTriggersData
): CancelablePromise<ListPostgresTriggersResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const existsPostgresTrigger = (
  data: ExistsPostgresTriggerData
): CancelablePromise<ExistsPostgresTriggerResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const setPostgresTriggerEnabled = (
  data: SetPostgresTriggerEnabledData
): CancelablePromise<SetPostgresTriggerEnabledResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const testPostgresConnection = (
  data: TestPostgresConnectionData
): CancelablePromise<TestPostgresConnectionResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const listInstanceGroups =
  (): CancelablePromise<ListInstanceGroupsResponse> => {
    return __request(OpenAPI, {
      method: "GET",
      url: "/groups/list",
    });
 ...
 * @throws ApiError
 */
export const getInstanceGroup = (
  data: GetInstanceGroupData
): CancelablePromise<GetInstanceGroupResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/groups/get/{name}",
    path: {
 ...
 * @throws ApiError
 */
export const createInstanceGroup = (
  data: CreateInstanceGroupData
): CancelablePromise<CreateInstanceGroupResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/groups/create",
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const updateInstanceGroup = (
  data: UpdateInstanceGroupData
): CancelablePromise<UpdateInstanceGroupResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const deleteInstanceGroup = (
  data: DeleteInstanceGroupData
): CancelablePromise<DeleteInstanceGroupResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
 ...
 * @throws ApiError
 */
export const addUserToInstanceGroup = (
  data: AddUserToInstanceGroupData
): CancelablePromise<AddUserToInstanceGroupResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const removeUserFromInstanceGroup = (
  data: RemoveUserFromInstanceGroupData
): CancelablePromise<RemoveUserFromInstanceGroupResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const exportInstanceGroups =
  (): CancelablePromise<ExportInstanceGroupsResponse> => {
    return __request(OpenAPI, {
      method: "GET",
      url: "/groups/export",
    });
 ...
 * @throws ApiError
 */
export const overwriteInstanceGroups = (
  data: OverwriteInstanceGroupsData
): CancelablePromise<OverwriteInstanceGroupsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const listGroupNames = (
  data: ListGroupNamesData
): CancelablePromise<ListGroupNamesResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
): CancelablePromise<AddUserToGroupResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const removeUserToGroup = (
  data: RemoveUserToGroupData
): CancelablePromise<RemoveUserToGroupResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const listFolderNames = (
  data: ListFolderNamesData
): CancelablePromise<ListFolderNamesResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
): CancelablePromise<UpdateFolderResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const getFolder = (
  data: GetFolderData
): CancelablePromise<GetFolderResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const existsFolder = (
  data: ExistsFolderData
): CancelablePromise<ExistsFolderResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/w/{workspace}/folders/exists/{name}",
    path: {
      workspace: data.workspace,
      name: data.name,
    },
 ...
 * @throws ApiError
 */
export const getFolderUsage = (
  data: GetFolderUsageData
): CancelablePromise<GetFolderUsageResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const addOwnerToFolder = (
  data: AddOwnerToFolderData
): CancelablePromise<AddOwnerToFolderResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const removeOwnerToFolder = (
  data: RemoveOwnerToFolderData
): CancelablePromise<RemoveOwnerToFolderResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
): CancelablePromise<ListWorkersResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/workers/list",
    query: {
 ...
 * @throws ApiError
 */
export const existsWorkerWithTag = (
  data: ExistsWorkerWithTagData
): CancelablePromise<ExistsWorkerWithTagResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const getQueueMetrics =
  (): CancelablePromise<GetQueueMetricsResponse> => {
    return __request(OpenAPI, {
      method: "GET",
...
export const getCountsOfJobsWaitingPerTag =
  (): CancelablePromise<GetCountsOfJobsWaitingPerTagResponse> => {
    return __request(OpenAPI, {
      method: "GET",
...
export const listWorkerGroups =
  (): CancelablePromise<ListWorkerGroupsResponse> => {
    return __request(OpenAPI, {
      method: "GET",
...
export const deleteConfig = (
  data: DeleteConfigData
): CancelablePromise<DeleteConfigResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
    url: "/configs/update/{name}",
    path: {
 ...
 * @throws ApiError
 */
export const listConfigs = (): CancelablePromise<ListConfigsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
    url: "/configs/list",
  });
 ...
 * @throws ApiError
 */
export const listAutoscalingEvents = (
  data: ListAutoscalingEventsData
): CancelablePromise<ListAutoscalingEventsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getGranularAcls = (
  data: GetGranularAclsData
): CancelablePromise<GetGranularAclsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const addGranularAcls = (
  data: AddGranularAclsData
): CancelablePromise<AddGranularAclsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const removeGranularAcls = (
  data: RemoveGranularAclsData
): CancelablePromise<RemoveGranularAclsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const setCaptureConfig = (
  data: SetCaptureConfigData
): CancelablePromise<SetCaptureConfigResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const pingCaptureConfig = (
  data: PingCaptureConfigData
): CancelablePromise<PingCaptureConfigResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const getCaptureConfigs = (
  data: GetCaptureConfigsData
): CancelablePromise<GetCaptureConfigsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const listCaptures = (
  data: ListCapturesData
): CancelablePromise<ListCapturesResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const moveCapturesAndConfigs = (
  data: MoveCapturesAndConfigsData
): CancelablePromise<MoveCapturesAndConfigsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
    url: "/w/{workspace}/capture/move/{runnable_kind}/{path}",
    path: {
      workspace: data.workspace,
      runnable_kind: data.runnableKind,
      path: data.path,
...
export const getCapture = (
  data: GetCaptureData
): CancelablePromise<GetCaptureResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const deleteCapture = (
  data: DeleteCaptureData
): CancelablePromise<DeleteCaptureResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
    url: "/w/{workspace}/capture/{id}",
    path: {
 ...
 * @throws ApiError
 */
export const star = (data: StarData): CancelablePromise<StarResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const unstar = (data: UnstarData): CancelablePromise<UnstarResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const getInputHistory = (
  data: GetInputHistoryData
): CancelablePromise<GetInputHistoryResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getArgsFromHistoryOrSavedInput = (
  data: GetArgsFromHistoryOrSavedInputData
): CancelablePromise<GetArgsFromHistoryOrSavedInputResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const listInputs = (
  data: ListInputsData
): CancelablePromise<ListInputsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
): CancelablePromise<CreateInputResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
): CancelablePromise<UpdateInputResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
): CancelablePromise<DeleteInputResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const duckdbConnectionSettings = (
  data: DuckdbConnectionSettingsData
): CancelablePromise<DuckdbConnectionSettingsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const duckdbConnectionSettingsV2 = (
  data: DuckdbConnectionSettingsV2Data
): CancelablePromise<DuckdbConnectionSettingsV2Response> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const polarsConnectionSettings = (
  data: PolarsConnectionSettingsData
): CancelablePromise<PolarsConnectionSettingsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const polarsConnectionSettingsV2 = (
  data: PolarsConnectionSettingsV2Data
): CancelablePromise<PolarsConnectionSettingsV2Response> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const s3ResourceInfo = (
  data: S3ResourceInfoData
): CancelablePromise<S3ResourceInfoResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const datasetStorageTestConnection = (
  data: DatasetStorageTestConnectionData
 ...
 * @throws ApiError
 */
export const listStoredFiles = (
  data: ListStoredFilesData
): CancelablePromise<ListStoredFilesResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const loadFileMetadata = (
  data: LoadFileMetadataData
...
export const loadFilePreview = (
  data: LoadFilePreviewData
): CancelablePromise<LoadFilePreviewResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const loadParquetPreview = (
  data: LoadParquetPreviewData
): CancelablePromise<LoadParquetPreviewResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const loadTableRowCount = (
  data: LoadTableRowCountData
): CancelablePromise<LoadTableRowCountResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const loadCsvPreview = (
  data: LoadCsvPreviewData
): CancelablePromise<LoadCsvPreviewResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const deleteS3File = (
  data: DeleteS3FileData
): CancelablePromise<DeleteS3FileResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
 ...
 * @throws ApiError
 */
export const moveS3File = (
  data: MoveS3FileData
): CancelablePromise<MoveS3FileResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
): CancelablePromise<FileDownloadResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const fileDownloadParquetAsCsv = (
  data: FileDownloadParquetAsCsvData
): CancelablePromise<FileDownloadParquetAsCsvResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const getJobMetrics = (
  data: GetJobMetricsData
): CancelablePromise<GetJobMetricsResponse> => {
  return __request(OpenAPI, {
    method: "POST",
 ...
 * @throws ApiError
 */
export const setJobProgress = (
  data: SetJobProgressData
): CancelablePromise<SetJobProgressResponse> => {
  return __request(OpenAPI, {
    method: "POST",
...
export const getJobProgress = (
  data: GetJobProgressData
): CancelablePromise<GetJobProgressResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const listLogFiles = (
  data: ListLogFilesData = {}
): CancelablePromise<ListLogFilesResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const getLogFile = (
  data: GetLogFileData
): CancelablePromise<GetLogFileResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listConcurrencyGroups =
  (): CancelablePromise<ListConcurrencyGroupsResponse> => {
    return __request(OpenAPI, {
      method: "GET",
 ...
 * @throws ApiError
 */
export const deleteConcurrencyGroup = (
  data: DeleteConcurrencyGroupData
): CancelablePromise<DeleteConcurrencyGroupResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
 ...
 * @throws ApiError
 */
export const getConcurrencyKey = (
  data: GetConcurrencyKeyData
): CancelablePromise<GetConcurrencyKeyResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const listExtendedJobs = (
  data: ListExtendedJobsData
): CancelablePromise<ListExtendedJobsResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const searchJobsIndex = (
  data: SearchJobsIndexData
): CancelablePromise<SearchJobsIndexResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const searchLogsIndex = (
  data: SearchLogsIndexData
): CancelablePromise<SearchLogsIndexResponse> => {
  return __request(OpenAPI, {
    method: "GET",
 ...
 * @throws ApiError
 */
export const countSearchLogsIndex = (
  data: CountSearchLogsIndexData
): CancelablePromise<CountSearchLogsIndexResponse> => {
  return __request(OpenAPI, {
    method: "GET",
...
export const clearIndex = (
  data: ClearIndexData
): CancelablePromise<ClearIndexResponse> => {
  return __request(OpenAPI, {
    method: "DELETE",
