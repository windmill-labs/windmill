 ...
 * @throws ApiError
 */
export const getHealthStatus = (data: GetHealthStatusData = {}): CancelablePromise<GetHealthStatusResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/health/status',
    query: {
        force: data.force
 ...
 * @throws ApiError
 */
export const getHealthDetailed = (): CancelablePromise<GetHealthDetailedResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/health/detailed',
    errors: {
        503: 'server is unhealthy (database unreachable)'
 ...
 * @throws ApiError
 */
export const queryDocumentation = (data: QueryDocumentationData): CancelablePromise<QueryDocumentationResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/inkeep',
 ...
 * @throws ApiError
 */
export const isSmtpConfigured = (): CancelablePromise<IsSmtpConfiguredResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const requestPasswordReset = (data: RequestPasswordResetData): CancelablePromise<RequestPasswordResetResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const setPasswordForUser = (data: SetPasswordForUserData): CancelablePromise<SetPasswordForUserResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const setLoginTypeForUser = (data: SetLoginTypeForUserData): CancelablePromise<SetLoginTypeForUserResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const submitOnboardingData = (data: SubmitOnboardingDataData): CancelablePromise<SubmitOnboardingDataResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const convertUserToGroup = (data: ConvertUserToGroupData): CancelablePromise<ConvertUserToGroupResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const getGlobalConnectedRepositories = (data: GetGlobalConnectedRepositoriesData = {}): CancelablePromise<GetGlobalConnectedRepositoriesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getWorkspaceAsSuperAdmin = (data: GetWorkspaceAsSuperAdminData): CancelablePromise<GetWorkspaceAsSuperAdminResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const createWorkspaceForkGitBranch = (data: CreateWorkspaceForkGitBranchData): CancelablePromise<CreateWorkspaceForkGitBranchResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const createWorkspaceFork = (data: CreateWorkspaceForkData): CancelablePromise<CreateWorkspaceForkResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const refreshCustomInstanceUserPwd = (): CancelablePromise<RefreshCustomInstanceUserPwdResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const listCustomInstanceDbs = (): CancelablePromise<ListCustomInstanceDbsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const setupCustomInstanceDb = (data: SetupCustomInstanceDbData): CancelablePromise<SetupCustomInstanceDbResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const acknowledgeCriticalAlert = (data: AcknowledgeCriticalAlertData): CancelablePromise<AcknowledgeCriticalAlertResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const acknowledgeAllCriticalAlerts = (): CancelablePromise<AcknowledgeAllCriticalAlertsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const getStats = (): CancelablePromise<GetStatsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getInstanceConfig = (): CancelablePromise<GetInstanceConfigResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const setInstanceConfig = (data: SetInstanceConfigData): CancelablePromise<SetInstanceConfigResponse> => { return __request(OpenAPI, {
    method: 'PUT',
    url: '/settings/instance_config',
    body: data.requestBody,
    mediaType: 'application/json'
 ...
 * @throws ApiError
 */
export const getMinKeepAliveVersion = (): CancelablePromise<GetMinKeepAliveVersionResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const testSecretBackend = (data: TestSecretBackendData): CancelablePromise<TestSecretBackendResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const migrateSecretsToVault = (data: MigrateSecretsToVaultData): CancelablePromise<MigrateSecretsToVaultResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const migrateSecretsToDatabase = (data: MigrateSecretsToDatabaseData): CancelablePromise<MigrateSecretsToDatabaseResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const ghesInstallationCallback = (data: GhesInstallationCallbackData): CancelablePromise<GhesInstallationCallbackResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const getGhesConfig = (): CancelablePromise<GetGhesConfigResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const updateOperatorSettings = (data: UpdateOperatorSettingsData): CancelablePromise<UpdateOperatorSettingsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const compareWorkspaces = (data: CompareWorkspacesData): CancelablePromise<CompareWorkspacesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const resetDiffTally = (data: ResetDiffTallyData): CancelablePromise<ResetDiffTallyResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const rebuildDependencyMap = (data: RebuildDependencyMapData): CancelablePromise<RebuildDependencyMapResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const getDependents = (data: GetDependentsData): CancelablePromise<GetDependentsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getDependentsAmounts = (data: GetDependentsAmountsData): CancelablePromise<GetDependentsAmountsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const getDependencyMap = (data: GetDependencyMapData): CancelablePromise<GetDependencyMapResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getWorkspaceSlackOauthConfig = (data: GetWorkspaceSlackOauthConfigData): CancelablePromise<GetWorkspaceSlackOauthConfigResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const setWorkspaceSlackOauthConfig = (data: SetWorkspaceSlackOauthConfigData): CancelablePromise<SetWorkspaceSlackOauthConfigResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/w/{workspace}/workspaces/slack_oauth_config',
    path: {
        workspace: data.workspace
 ...
 * @throws ApiError
 */
export const deleteWorkspaceSlackOauthConfig = (data: DeleteWorkspaceSlackOauthConfigData): CancelablePromise<DeleteWorkspaceSlackOauthConfigResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
    url: '/w/{workspace}/workspaces/slack_oauth_config',
    path: {
        workspace: data.workspace
 ...
 * @throws ApiError
 */
export const editTeamsCommand = (data: EditTeamsCommandData): CancelablePromise<EditTeamsCommandResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const listAvailableTeamsIds = (data: ListAvailableTeamsIdsData): CancelablePromise<ListAvailableTeamsIdsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listAvailableTeamsChannels = (data: ListAvailableTeamsChannelsData): CancelablePromise<ListAvailableTeamsChannelsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const connectTeams = (data: ConnectTeamsData): CancelablePromise<ConnectTeamsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const runTeamsMessageTestJob = (data: RunTeamsMessageTestJobData): CancelablePromise<RunTeamsMessageTestJobResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const editInstanceGroups = (data: EditInstanceGroupsData): CancelablePromise<EditInstanceGroupsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const editSuccessHandler = (data: EditSuccessHandlerData): CancelablePromise<EditSuccessHandlerResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const listDucklakes = (data: ListDucklakesData): CancelablePromise<ListDucklakesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listDataTables = (data: ListDataTablesData): CancelablePromise<ListDataTablesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listDataTableSchemas = (data: ListDataTableSchemasData): CancelablePromise<ListDataTableSchemasResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const editDucklakeConfig = (data: EditDucklakeConfigData): CancelablePromise<EditDucklakeConfigResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const editDataTableConfig = (data: EditDataTableConfigData): CancelablePromise<EditDataTableConfigResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const editGitSyncRepository = (data: EditGitSyncRepositoryData): CancelablePromise<EditGitSyncRepositoryResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/w/{workspace}/workspaces/edit_git_sync_repository',
    path: {
        workspace: data.workspace
    },
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const deleteGitSyncRepository = (data: DeleteGitSyncRepositoryData): CancelablePromise<DeleteGitSyncRepositoryResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
    url: '/w/{workspace}/workspaces/delete_git_sync_repository',
    path: {
        workspace: data.workspace
    },
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const getUsedTriggers = (data: GetUsedTriggersData): CancelablePromise<GetUsedTriggersResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listAvailableScopes = (): CancelablePromise<ListAvailableScopesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @param data The data for the request.
 * @param data.workspace
 * @param data.requestBody paths to delete
 * @returns string deleted paths
 * @throws ApiError
 */
export const deleteVariablesBulk = (data: DeleteVariablesBulkData): CancelablePromise<DeleteVariablesBulkResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
    url: '/w/{workspace}/variables/delete_bulk',
    path: {
        workspace: data.workspace
    },
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const getSecondaryStorageNames = (data: GetSecondaryStorageNamesData): CancelablePromise<GetSecondaryStorageNamesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const workspaceAcknowledgeCriticalAlert = (data: WorkspaceAcknowledgeCriticalAlertData): CancelablePromise<WorkspaceAcknowledgeCriticalAlertResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const workspaceAcknowledgeAllCriticalAlerts = (data: WorkspaceAcknowledgeAllCriticalAlertsData): CancelablePromise<WorkspaceAcknowledgeAllCriticalAlertsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const workspaceMuteCriticalAlertsUi = (data: WorkspaceMuteCriticalAlertsUiData): CancelablePromise<WorkspaceMuteCriticalAlertsUiResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const listProtectionRules = (data: ListProtectionRulesData): CancelablePromise<ListProtectionRulesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const createProtectionRule = (data: CreateProtectionRuleData): CancelablePromise<CreateProtectionRuleResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/w/{workspace}/workspaces/protection_rules',
    path: {
        workspace: data.workspace
 ...
 * @throws ApiError
 */
export const updateProtectionRule = (data: UpdateProtectionRuleData): CancelablePromise<UpdateProtectionRuleResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const deleteProtectionRule = (data: DeleteProtectionRuleData): CancelablePromise<DeleteProtectionRuleResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
    url: '/w/{workspace}/workspaces/protection_rules/{rule_name}',
    path: {
        workspace: data.workspace,
 ...
 * @throws ApiError
 */
export const logAiChat = (data: LogAiChatData): CancelablePromise<LogAiChatResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const getCloudQuotas = (data: GetCloudQuotasData): CancelablePromise<GetCloudQuotasResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const pruneVersions = (data: PruneVersionsData): CancelablePromise<PruneVersionsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const setPublicAppRateLimit = (data: SetPublicAppRateLimitData): CancelablePromise<SetPublicAppRateLimitResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const connectClientCredentials = (data: ConnectClientCredentialsData): CancelablePromise<ConnectClientCredentialsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const disconnectTeams = (data: DisconnectTeamsData): CancelablePromise<DisconnectTeamsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const sendMessageToConversation = (data: SendMessageToConversationData): CancelablePromise<SendMessageToConversationResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const deleteResourcesBulk = (data: DeleteResourcesBulkData): CancelablePromise<DeleteResourcesBulkResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
    url: '/w/{workspace}/resources/delete_bulk',
    path: {
        workspace: data.workspace
    },
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const getGitCommitHash = (data: GetGitCommitHashData): CancelablePromise<GetGitCommitHashResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getMcpTools = (data: GetMcpToolsData): CancelablePromise<GetMcpToolsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getNpmPackageMetadata = (data: GetNpmPackageMetadataData): CancelablePromise<GetNpmPackageMetadataResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const resolveNpmPackageVersion = (data: ResolveNpmPackageVersionData): CancelablePromise<ResolveNpmPackageVersionResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getNpmPackageFiletree = (data: GetNpmPackageFiletreeData): CancelablePromise<GetNpmPackageFiletreeResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getNpmPackageFile = (data: GetNpmPackageFileData): CancelablePromise<GetNpmPackageFileResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getHubRawAppById = (data: GetHubRawAppByIdData): CancelablePromise<GetHubRawAppByIdResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const pickHubScriptByPath = (data: PickHubScriptByPathData): CancelablePromise<PickHubScriptByPathResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getCustomTagsForWorkspace = (data: GetCustomTagsForWorkspaceData): CancelablePromise<GetCustomTagsForWorkspaceResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const createWorkspaceDependencies = (data: CreateWorkspaceDependenciesData): CancelablePromise<CreateWorkspaceDependenciesResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const archiveWorkspaceDependencies = (data: ArchiveWorkspaceDependenciesData): CancelablePromise<ArchiveWorkspaceDependenciesResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const deleteWorkspaceDependencies = (data: DeleteWorkspaceDependenciesData): CancelablePromise<DeleteWorkspaceDependenciesResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const listWorkspaceDependencies = (data: ListWorkspaceDependenciesData): CancelablePromise<ListWorkspaceDependenciesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getLatestWorkspaceDependencies = (data: GetLatestWorkspaceDependenciesData): CancelablePromise<GetLatestWorkspaceDependenciesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const deleteScriptsBulk = (data: DeleteScriptsBulkData): CancelablePromise<DeleteScriptsBulkResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
    url: '/w/{workspace}/scripts/delete_bulk',
    path: {
        workspace: data.workspace
    },
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const getTriggersCountOfScript = (data: GetTriggersCountOfScriptData): CancelablePromise<GetTriggersCountOfScriptResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listTokensOfScript = (data: ListTokensOfScriptData): CancelablePromise<ListTokensOfScriptResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getScriptLatestVersion = (data: GetScriptLatestVersionData): CancelablePromise<GetScriptLatestVersionResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listSelectedJobGroups = (data: ListSelectedJobGroupsData): CancelablePromise<ListSelectedJobGroupsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const runWaitResultFlowByVersion = (data: RunWaitResultFlowByVersionData): CancelablePromise<RunWaitResultFlowByVersionResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const runWaitResultFlowByVersionGet = (data: RunWaitResultFlowByVersionGetData): CancelablePromise<RunWaitResultFlowByVersionGetResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/w/{workspace}/jobs/run_wait_result/fv/{version}',
    path: {
        workspace: data.workspace,
 ...
 * @throws ApiError
 */
export const runAndStreamFlowByPath = (data: RunAndStreamFlowByPathData): CancelablePromise<RunAndStreamFlowByPathResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const runAndStreamFlowByPathGet = (data: RunAndStreamFlowByPathGetData): CancelablePromise<RunAndStreamFlowByPathGetResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/w/{workspace}/jobs/run_and_stream/f/{path}',
    path: {
        workspace: data.workspace,
 ...
 * @throws ApiError
 */
export const runAndStreamFlowByVersion = (data: RunAndStreamFlowByVersionData): CancelablePromise<RunAndStreamFlowByVersionResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const runAndStreamFlowByVersionGet = (data: RunAndStreamFlowByVersionGetData): CancelablePromise<RunAndStreamFlowByVersionGetResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/w/{workspace}/jobs/run_and_stream/fv/{version}',
    path: {
        workspace: data.workspace,
 ...
 * @throws ApiError
 */
export const runAndStreamScriptByPath = (data: RunAndStreamScriptByPathData): CancelablePromise<RunAndStreamScriptByPathResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const runAndStreamScriptByPathGet = (data: RunAndStreamScriptByPathGetData): CancelablePromise<RunAndStreamScriptByPathGetResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/w/{workspace}/jobs/run_and_stream/p/{path}',
    path: {
        workspace: data.workspace,
 ...
 * @throws ApiError
 */
export const runAndStreamScriptByHash = (data: RunAndStreamScriptByHashData): CancelablePromise<RunAndStreamScriptByHashResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const runAndStreamScriptByHashGet = (data: RunAndStreamScriptByHashGetData): CancelablePromise<RunAndStreamScriptByHashGetResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/w/{workspace}/jobs/run_and_stream/h/{hash}',
    path: {
        workspace: data.workspace,
 ...
 * @throws ApiError
 */
export const getFlowLatestVersion = (data: GetFlowLatestVersionData): CancelablePromise<GetFlowLatestVersionResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @param data.path
 * @param data.matchPathStart
 * @returns string list of flow paths
 * @throws ApiError
 */
export const listFlowPathsFromWorkspaceRunnable = (data: ListFlowPathsFromWorkspaceRunnableData): CancelablePromise<ListFlowPathsFromWorkspaceRunnableResponse> => { return __request(OpenAPI, {
    method: 'GET',
    ...
    query: {
        match_path_start: data.matchPathStart
    }
}); };
 ...
 * @throws ApiError
 */
export const getTriggersCountOfFlow = (data: GetTriggersCountOfFlowData): CancelablePromise<GetTriggersCountOfFlowResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listTokensOfFlow = (data: ListTokensOfFlowData): CancelablePromise<ListTokensOfFlowResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listFlowConversations = (data: ListFlowConversationsData): CancelablePromise<ListFlowConversationsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const deleteFlowConversation = (data: DeleteFlowConversationData): CancelablePromise<DeleteFlowConversationResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
 ...
 * @throws ApiError
 */
export const listConversationMessages = (data: ListConversationMessagesData): CancelablePromise<ListConversationMessagesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const createAppRaw = (data: CreateAppRawData): CancelablePromise<CreateAppRawResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/w/{workspace}/apps/create_raw',
    path: {
        workspace: data.workspace
    },
 ...
 * @throws ApiError
 */
export const getAppLatestVersion = (data: GetAppLatestVersionData): CancelablePromise<GetAppLatestVersionResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getPublicSecretOfLatestVersionOfApp = (data: GetPublicSecretOfLatestVersionOfAppData): CancelablePromise<GetPublicSecretOfLatestVersionOfAppResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const updateAppRaw = (data: UpdateAppRawData): CancelablePromise<UpdateAppRawResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/w/{workspace}/apps/update_raw/{path}',
    path: {
        workspace: data.workspace,
        path: data.path
    },
 ...
 * @throws ApiError
 */
export const signS3Objects = (data: SignS3ObjectsData): CancelablePromise<SignS3ObjectsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const uploadS3FileFromApp = (data: UploadS3FileFromAppData): CancelablePromise<UploadS3FileFromAppResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const deleteS3FileFromApp = (data: DeleteS3FileFromAppData): CancelablePromise<DeleteS3FileFromAppResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
 ...
 * @throws ApiError
 */
export const runFlowByVersion = (data: RunFlowByVersionData): CancelablePromise<RunFlowByVersionResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const batchReRunJobs = (data: BatchReRunJobsData): CancelablePromise<BatchReRunJobsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const runScriptPreviewInline = (data: RunScriptPreviewInlineData): CancelablePromise<RunScriptPreviewInlineResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const runScriptByPathInline = (data: RunScriptByPathInlineData): CancelablePromise<RunScriptByPathInlineResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const runScriptByHashInline = (data: RunScriptByHashInlineData): CancelablePromise<RunScriptByHashInlineResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const runScriptPreviewAndWaitResult = (data: RunScriptPreviewAndWaitResultData): CancelablePromise<RunScriptPreviewAndWaitResultResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const runFlowPreviewAndWaitResult = (data: RunFlowPreviewAndWaitResultData): CancelablePromise<RunFlowPreviewAndWaitResultResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const runDynamicSelect = (data: RunDynamicSelectData): CancelablePromise<RunDynamicSelectResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const countCompletedJobs = (data: CountCompletedJobsData): CancelablePromise<CountCompletedJobsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listFilteredJobsUuids = (data: ListFilteredJobsUuidsData): CancelablePromise<ListFilteredJobsUuidsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listFilteredQueueUuids = (data: ListFilteredQueueUuidsData): CancelablePromise<ListFilteredQueueUuidsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getJobOtelTraces = (data: GetJobOtelTracesData): CancelablePromise<GetJobOtelTracesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const resumeSuspendedTriggerJobs = (data: ResumeSuspendedTriggerJobsData): CancelablePromise<ResumeSuspendedTriggerJobsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const cancelSuspendedTriggerJobs = (data: CancelSuspendedTriggerJobsData): CancelablePromise<CancelSuspendedTriggerJobsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const exportCompletedJobs = (data: ExportCompletedJobsData): CancelablePromise<ExportCompletedJobsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const importCompletedJobs = (data: ImportCompletedJobsData): CancelablePromise<ImportCompletedJobsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const exportQueuedJobs = (data: ExportQueuedJobsData): CancelablePromise<ExportQueuedJobsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const importQueuedJobs = (data: ImportQueuedJobsData): CancelablePromise<ImportQueuedJobsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const deleteJobs = (data: DeleteJobsData): CancelablePromise<DeleteJobsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const getCompletedJobLogsTail = (data: GetCompletedJobLogsTailData): CancelablePromise<GetCompletedJobLogsTailResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getStartedAtByIds = (data: GetStartedAtByIdsData): CancelablePromise<GetStartedAtByIdsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const getJobUpdatesSse = (data: GetJobUpdatesSseData): CancelablePromise<GetJobUpdatesSseResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getCompletedJobTiming = (data: GetCompletedJobTimingData): CancelablePromise<GetCompletedJobTimingResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @param data The data for the request.
 * @param data.workspace
 * @param data.scheduledFor
 * @returns unknown queue position information
 * @throws ApiError
 */
export const getQueuePosition = (data: GetQueuePositionData): CancelablePromise<GetQueuePositionResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/w/{workspace}/jobs/queue/position/{scheduled_for}',
    path: {
        workspace: data.workspace,
        scheduled_for: data.scheduledFor
    }
 ...
 * @param data.workspace
 * @param data.id
 * @returns number scheduled for timestamp
 * @throws ApiError
 */
export const getScheduledFor = (data: GetScheduledForData): CancelablePromise<GetScheduledForResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/w/{workspace}/jobs/queue/scheduled_for/{id}',
    path: {
        workspace: data.workspace,
        id: data.id
    }
 ...
 * @throws ApiError
 */
export const getTeamsApprovalPayload = (data: GetTeamsApprovalPayloadData): CancelablePromise<GetTeamsApprovalPayloadResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/w/{workspace}/jobs/teams_approval/{id}',
    path: {
        workspace: data.workspace,
        id: data.id
    },
 ...
 * @throws ApiError
 */
export const generateOpenapiSpec = (data: GenerateOpenapiSpecData): CancelablePromise<GenerateOpenapiSpecResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/w/{workspace}/openapi/generate',
    path: {
        workspace: data.workspace
    },
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const downloadOpenapiSpec = (data: DownloadOpenapiSpecData): CancelablePromise<DownloadOpenapiSpecResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/w/{workspace}/openapi/download',
    path: {
        workspace: data.workspace
    },
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const createHttpTriggers = (data: CreateHttpTriggersData): CancelablePromise<CreateHttpTriggersResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/w/{workspace}/http_triggers/create_many',
    path: {
        workspace: data.workspace
    },
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const setHttpTriggerMode = (data: SetHttpTriggerModeData): CancelablePromise<SetHttpTriggerModeResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const createWebsocketTrigger = (data: CreateWebsocketTriggerData): CancelablePromise<CreateWebsocketTriggerResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const updateWebsocketTrigger = (data: UpdateWebsocketTriggerData): CancelablePromise<UpdateWebsocketTriggerResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const deleteWebsocketTrigger = (data: DeleteWebsocketTriggerData): CancelablePromise<DeleteWebsocketTriggerResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
 ...
 * @throws ApiError
 */
export const getWebsocketTrigger = (data: GetWebsocketTriggerData): CancelablePromise<GetWebsocketTriggerResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listWebsocketTriggers = (data: ListWebsocketTriggersData): CancelablePromise<ListWebsocketTriggersResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const existsWebsocketTrigger = (data: ExistsWebsocketTriggerData): CancelablePromise<ExistsWebsocketTriggerResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const setWebsocketTriggerMode = (data: SetWebsocketTriggerModeData): CancelablePromise<SetWebsocketTriggerModeResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const testWebsocketConnection = (data: TestWebsocketConnectionData): CancelablePromise<TestWebsocketConnectionResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const setKafkaTriggerMode = (data: SetKafkaTriggerModeData): CancelablePromise<SetKafkaTriggerModeResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const testKafkaConnection = (data: TestKafkaConnectionData): CancelablePromise<TestKafkaConnectionResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const resetKafkaOffsets = (data: ResetKafkaOffsetsData): CancelablePromise<ResetKafkaOffsetsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const commitKafkaOffsets = (data: CommitKafkaOffsetsData): CancelablePromise<CommitKafkaOffsetsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const setNatsTriggerMode = (data: SetNatsTriggerModeData): CancelablePromise<SetNatsTriggerModeResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const testNatsConnection = (data: TestNatsConnectionData): CancelablePromise<TestNatsConnectionResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const createSqsTrigger = (data: CreateSqsTriggerData): CancelablePromise<CreateSqsTriggerResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const updateSqsTrigger = (data: UpdateSqsTriggerData): CancelablePromise<UpdateSqsTriggerResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const deleteSqsTrigger = (data: DeleteSqsTriggerData): CancelablePromise<DeleteSqsTriggerResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
 ...
 * @throws ApiError
 */
export const getSqsTrigger = (data: GetSqsTriggerData): CancelablePromise<GetSqsTriggerResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listSqsTriggers = (data: ListSqsTriggersData): CancelablePromise<ListSqsTriggersResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const existsSqsTrigger = (data: ExistsSqsTriggerData): CancelablePromise<ExistsSqsTriggerResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const setSqsTriggerMode = (data: SetSqsTriggerModeData): CancelablePromise<SetSqsTriggerModeResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const testSqsConnection = (data: TestSqsConnectionData): CancelablePromise<TestSqsConnectionResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const listNativeTriggerServices = (data: ListNativeTriggerServicesData): CancelablePromise<ListNativeTriggerServicesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const checkIfNativeTriggersServiceExists = (data: CheckIfNativeTriggersServiceExistsData): CancelablePromise<CheckIfNativeTriggersServiceExistsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const createNativeTriggerService = (data: CreateNativeTriggerServiceData): CancelablePromise<CreateNativeTriggerServiceResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const generateNativeTriggerServiceConnectUrl = (data: GenerateNativeTriggerServiceConnectUrlData): CancelablePromise<GenerateNativeTriggerServiceConnectUrlResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const checkInstanceSharingAvailable = (data: CheckInstanceSharingAvailableData): CancelablePromise<CheckInstanceSharingAvailableResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const generateInstanceConnectUrl = (data: GenerateInstanceConnectUrlData): CancelablePromise<GenerateInstanceConnectUrlResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const deleteNativeTriggerService = (data: DeleteNativeTriggerServiceData): CancelablePromise<DeleteNativeTriggerServiceResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
 ...
 * @throws ApiError
 */
export const nativeTriggerServiceCallback = (data: NativeTriggerServiceCallbackData): CancelablePromise<NativeTriggerServiceCallbackResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const createNativeTrigger = (data: CreateNativeTriggerData): CancelablePromise<CreateNativeTriggerResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const updateNativeTrigger = (data: UpdateNativeTriggerData): CancelablePromise<UpdateNativeTriggerResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const getNativeTrigger = (data: GetNativeTriggerData): CancelablePromise<GetNativeTriggerResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const deleteNativeTrigger = (data: DeleteNativeTriggerData): CancelablePromise<DeleteNativeTriggerResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
 ...
 * @throws ApiError
 */
export const listNativeTriggers = (data: ListNativeTriggersData): CancelablePromise<ListNativeTriggersResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const existsNativeTrigger = (data: ExistsNativeTriggerData): CancelablePromise<ExistsNativeTriggerResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const syncNativeTriggers = (data: SyncNativeTriggersData): CancelablePromise<SyncNativeTriggersResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const listNextCloudEvents = (data: ListNextCloudEventsData): CancelablePromise<ListNextCloudEventsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listGoogleCalendars = (data: ListGoogleCalendarsData): CancelablePromise<ListGoogleCalendarsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listGoogleDriveFiles = (data: ListGoogleDriveFilesData): CancelablePromise<ListGoogleDriveFilesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listGoogleSharedDrives = (data: ListGoogleSharedDrivesData): CancelablePromise<ListGoogleSharedDrivesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const nativeTriggerWebhook = (data: NativeTriggerWebhookData): CancelablePromise<NativeTriggerWebhookResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const createMqttTrigger = (data: CreateMqttTriggerData): CancelablePromise<CreateMqttTriggerResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const updateMqttTrigger = (data: UpdateMqttTriggerData): CancelablePromise<UpdateMqttTriggerResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const deleteMqttTrigger = (data: DeleteMqttTriggerData): CancelablePromise<DeleteMqttTriggerResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
 ...
 * @throws ApiError
 */
export const getMqttTrigger = (data: GetMqttTriggerData): CancelablePromise<GetMqttTriggerResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listMqttTriggers = (data: ListMqttTriggersData): CancelablePromise<ListMqttTriggersResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const existsMqttTrigger = (data: ExistsMqttTriggerData): CancelablePromise<ExistsMqttTriggerResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const setMqttTriggerMode = (data: SetMqttTriggerModeData): CancelablePromise<SetMqttTriggerModeResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const testMqttConnection = (data: TestMqttConnectionData): CancelablePromise<TestMqttConnectionResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const createGcpTrigger = (data: CreateGcpTriggerData): CancelablePromise<CreateGcpTriggerResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const updateGcpTrigger = (data: UpdateGcpTriggerData): CancelablePromise<UpdateGcpTriggerResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const deleteGcpTrigger = (data: DeleteGcpTriggerData): CancelablePromise<DeleteGcpTriggerResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
 ...
 * @throws ApiError
 */
export const listGcpTriggers = (data: ListGcpTriggersData): CancelablePromise<ListGcpTriggersResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const existsGcpTrigger = (data: ExistsGcpTriggerData): CancelablePromise<ExistsGcpTriggerResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const setGcpTriggerMode = (data: SetGcpTriggerModeData): CancelablePromise<SetGcpTriggerModeResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const testGcpConnection = (data: TestGcpConnectionData): CancelablePromise<TestGcpConnectionResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const deleteGcpSubscription = (data: DeleteGcpSubscriptionData): CancelablePromise<DeleteGcpSubscriptionResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
 ...
 * @throws ApiError
 */
export const listGoogleTopics = (data: ListGoogleTopicsData): CancelablePromise<ListGoogleTopicsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listAllTgoogleTopicSubscriptions = (data: ListAllTgoogleTopicSubscriptionsData): CancelablePromise<ListAllTgoogleTopicSubscriptionsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const getPostgresVersion = (data: GetPostgresVersionData): CancelablePromise<GetPostgresVersionResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/w/{workspace}/postgres_triggers/postgres/version/{path}',
    path: {
        workspace: data.workspace,
        path: data.path
    }
 ...
 * @throws ApiError
 */
export const isValidPostgresConfiguration = (data: IsValidPostgresConfigurationData): CancelablePromise<IsValidPostgresConfigurationResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const createTemplateScript = (data: CreateTemplateScriptData): CancelablePromise<CreateTemplateScriptResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const getTemplateScript = (data: GetTemplateScriptData): CancelablePromise<GetTemplateScriptResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listPostgresReplicationSlot = (data: ListPostgresReplicationSlotData): CancelablePromise<ListPostgresReplicationSlotResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const createPostgresReplicationSlot = (data: CreatePostgresReplicationSlotData): CancelablePromise<CreatePostgresReplicationSlotResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const deletePostgresReplicationSlot = (data: DeletePostgresReplicationSlotData): CancelablePromise<DeletePostgresReplicationSlotResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
 ...
 * @throws ApiError
 */
export const listPostgresPublication = (data: ListPostgresPublicationData): CancelablePromise<ListPostgresPublicationResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getPostgresPublication = (data: GetPostgresPublicationData): CancelablePromise<GetPostgresPublicationResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const createPostgresPublication = (data: CreatePostgresPublicationData): CancelablePromise<CreatePostgresPublicationResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const updatePostgresPublication = (data: UpdatePostgresPublicationData): CancelablePromise<UpdatePostgresPublicationResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const deletePostgresPublication = (data: DeletePostgresPublicationData): CancelablePromise<DeletePostgresPublicationResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
 ...
 * @throws ApiError
 */
export const createPostgresTrigger = (data: CreatePostgresTriggerData): CancelablePromise<CreatePostgresTriggerResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const updatePostgresTrigger = (data: UpdatePostgresTriggerData): CancelablePromise<UpdatePostgresTriggerResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const deletePostgresTrigger = (data: DeletePostgresTriggerData): CancelablePromise<DeletePostgresTriggerResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
 ...
 * @throws ApiError
 */
export const getPostgresTrigger = (data: GetPostgresTriggerData): CancelablePromise<GetPostgresTriggerResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listPostgresTriggers = (data: ListPostgresTriggersData): CancelablePromise<ListPostgresTriggersResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const existsPostgresTrigger = (data: ExistsPostgresTriggerData): CancelablePromise<ExistsPostgresTriggerResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const setPostgresTriggerMode = (data: SetPostgresTriggerModeData): CancelablePromise<SetPostgresTriggerModeResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const testPostgresConnection = (data: TestPostgresConnectionData): CancelablePromise<TestPostgresConnectionResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @param data The data for the request.
 * @param data.workspace
 * @param data.requestBody new email trigger
 * @returns string email trigger created
 * @throws ApiError
 */
export const createEmailTrigger = (data: CreateEmailTriggerData): CancelablePromise<CreateEmailTriggerResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/w/{workspace}/email_triggers/create',
    path: {
        workspace: data.workspace
    },
    body: data.requestBody,
 ...
 * @param data.path
 * @param data.requestBody updated trigger
 * @returns string email trigger updated
 * @throws ApiError
 */
export const updateEmailTrigger = (data: UpdateEmailTriggerData): CancelablePromise<UpdateEmailTriggerResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/w/{workspace}/email_triggers/update/{path}',
    path: {
        workspace: data.workspace,
        path: data.path
    },
 ...
 * @param data.workspace
 * @param data.path
 * @returns string email trigger deleted
 * @throws ApiError
 */
export const deleteEmailTrigger = (data: DeleteEmailTriggerData): CancelablePromise<DeleteEmailTriggerResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
    url: '/w/{workspace}/email_triggers/delete/{path}',
    path: {
        workspace: data.workspace,
        path: data.path
    }
 ...
 * @throws ApiError
 */
export const getEmailTrigger = (data: GetEmailTriggerData): CancelablePromise<GetEmailTriggerResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/w/{workspace}/email_triggers/get/{path}',
    path: {
        workspace: data.workspace,
        path: data.path
    }
 ...
 * @throws ApiError
 */
export const listEmailTriggers = (data: ListEmailTriggersData): CancelablePromise<ListEmailTriggersResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/w/{workspace}/email_triggers/list',
    path: {
        workspace: data.workspace
    },
    query: {
 ...
 * @param data.workspace
 * @param data.path
 * @returns boolean email trigger exists
 * @throws ApiError
 */
export const existsEmailTrigger = (data: ExistsEmailTriggerData): CancelablePromise<ExistsEmailTriggerResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/w/{workspace}/email_triggers/exists/{path}',
    path: {
        workspace: data.workspace,
        path: data.path
    }
 ...
 * @param data The data for the request.
 * @param data.workspace
 * @param data.requestBody email local part exists request
 * @returns boolean email local part exists
 * @throws ApiError
 */
export const existsEmailLocalPart = (data: ExistsEmailLocalPartData): CancelablePromise<ExistsEmailLocalPartResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/w/{workspace}/email_triggers/local_part_exists',
    path: {
        workspace: data.workspace
    },
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const setEmailTriggerMode = (data: SetEmailTriggerModeData): CancelablePromise<SetEmailTriggerModeResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const listInstanceGroupsWithWorkspaces = (): CancelablePromise<ListInstanceGroupsWithWorkspacesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getGroupPermissionHistory = (data: GetGroupPermissionHistoryData): CancelablePromise<GetGroupPermissionHistoryResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const existsFolder = (data: ExistsFolderData): CancelablePromise<ExistsFolderResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getFolderPermissionHistory = (data: GetFolderPermissionHistoryData): CancelablePromise<GetFolderPermissionHistoryResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const existsWorkersWithTags = (data: ExistsWorkersWithTagsData): CancelablePromise<ExistsWorkersWithTagsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getCountsOfJobsWaitingPerTag = (): CancelablePromise<GetCountsOfJobsWaitingPerTagResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getCountsOfRunningJobsPerTag = (): CancelablePromise<GetCountsOfRunningJobsPerTagResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listAutoscalingEvents = (data: ListAutoscalingEventsData): CancelablePromise<ListAutoscalingEventsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const nativeKubernetesAutoscalingHealthcheck = (): CancelablePromise<NativeKubernetesAutoscalingHealthcheckResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listAvailablePythonVersions = (): CancelablePromise<ListAvailablePythonVersionsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const createAgentToken = (data: CreateAgentTokenData): CancelablePromise<CreateAgentTokenResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const blacklistAgentToken = (data: BlacklistAgentTokenData): CancelablePromise<BlacklistAgentTokenResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const removeBlacklistAgentToken = (data: RemoveBlacklistAgentTokenData): CancelablePromise<RemoveBlacklistAgentTokenResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const listBlacklistedAgentTokens = (data: ListBlacklistedAgentTokensData = {}): CancelablePromise<ListBlacklistedAgentTokensResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/agent_workers/list_blacklisted_tokens',
    query: {
        include_expired: data.includeExpired
    }
}); };
 ...
 * @throws ApiError
 */
export const getMinVersion = (): CancelablePromise<GetMinVersionResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const moveCapturesAndConfigs = (data: MoveCapturesAndConfigsData): CancelablePromise<MoveCapturesAndConfigsResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const listGitRepoFiles = (data: ListGitRepoFilesData): CancelablePromise<ListGitRepoFilesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const loadGitRepoFilePreview = (data: LoadGitRepoFilePreviewData): CancelablePromise<LoadGitRepoFilePreviewResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const loadGitRepoFileMetadata = (data: LoadGitRepoFileMetadataData): CancelablePromise<LoadGitRepoFileMetadataResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const checkS3FolderExists = (data: CheckS3FolderExistsData): CancelablePromise<CheckS3FolderExistsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const gitRepoViewerFileUpload = (data: GitRepoViewerFileUploadData): CancelablePromise<GitRepoViewerFileUploadResponse> => { return __request(OpenAPI, {
    method: 'POST',
...
export const searchJobsIndex = (data: SearchJobsIndexData): CancelablePromise<SearchJobsIndexResponse> => { return __request(OpenAPI, {
    ...
    query: {
        ...
        pagination_offset: data.paginationOffset
    }
}); };
 ...
 * @throws ApiError
 */
export const searchLogsIndex = (data: SearchLogsIndexData): CancelablePromise<SearchLogsIndexResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const countSearchLogsIndex = (data: CountSearchLogsIndexData): CancelablePromise<CountSearchLogsIndexResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getIndexStorageSizes = (): CancelablePromise<GetIndexStorageSizesResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/indexer/storage'
}); };
 ...
 * @throws ApiError
 */
export const getIndexerStatus = (): CancelablePromise<GetIndexerStatusResponse> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/indexer/status'
}); };
 ...
 * @throws ApiError
 */
export const listAssets = (data: ListAssetsData): CancelablePromise<ListAssetsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listAssetsByUsage = (data: ListAssetsByUsageData): CancelablePromise<ListAssetsByUsageResponse> => { return __request(OpenAPI, {
    method: 'POST',
    url: '/w/{workspace}/assets/list_by_usages',
    path: {
        workspace: data.workspace
    },
    body: data.requestBody,
 ...
 * @throws ApiError
 */
export const listFavoriteAssets = (data: ListFavoriteAssetsData): CancelablePromise<ListFavoriteAssetsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const listVolumes = (data: ListVolumesData): CancelablePromise<ListVolumesResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const getVolumeStorage = (data: GetVolumeStorageData): CancelablePromise<GetVolumeStorageResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const createVolume = (data: CreateVolumeData): CancelablePromise<CreateVolumeResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const deleteVolume = (data: DeleteVolumeData): CancelablePromise<DeleteVolumeResponse> => { return __request(OpenAPI, {
    method: 'DELETE',
 ...
 * @throws ApiError
 */
export const listMcpTools = (data: ListMcpToolsData): CancelablePromise<ListMcpToolsResponse> => { return __request(OpenAPI, {
    method: 'GET',
 ...
 * @throws ApiError
 */
export const discoverMcpOauth = (data: DiscoverMcpOauthData): CancelablePromise<DiscoverMcpOauthResponse> => { return __request(OpenAPI, {
    method: 'POST',
 ...
 * @throws ApiError
 */
export const startMcpOauthPopup = (data: StartMcpOauthPopupData): CancelablePromise<void> => { return __request(OpenAPI, {
    method: 'GET',
    url: '/mcp/oauth/start',
    query: {
 ...
 * @throws ApiError
 */
export const mcpOauthCallback = (data: McpOauthCallbackData): CancelablePromise<McpOauthCallbackResponse> => { return __request(OpenAPI, {
    method: 'GET',
