...
| MIN_FREE_DISK_SPACE_MB              | 5000                   | Minimum amount of free space on worker. Sends critical alert if worker has less free space.  
| DISK_SPACE_CHECK_FREQ               | 10                     | How often workers check for free space. For example with value 15 worker would check once per 15 jobs.
