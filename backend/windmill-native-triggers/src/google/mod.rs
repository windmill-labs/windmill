...
/// Data retrieved from Google about an active watch channel.
/// Used for sync operations and stored in service_config.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct GoogleTriggerData {
    /// The type of trigger (drive or calendar)
    pub trigger_type: GoogleTriggerType,
    /// The channel ID (UUID generated by Windmill)
    #[serde(skip_serializing)]
    pub channel_id: String,
    /// The resource ID assigned by Google
    #[serde(skip_serializing)]
