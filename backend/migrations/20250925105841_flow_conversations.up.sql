...
CREATE INDEX idx_conversation_message_conversation_time ON flow_conversation_message(conversation_id, created_at);
CREATE INDEX idx_conversation_message_job ON flow_conversation_message(job_id) WHERE job_id IS NOT NULL;
