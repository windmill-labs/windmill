...
ALTER TABLE script ADD COLUMN IF NOT EXISTS on_behalf_of_permissioned_as VARCHAR(255);
ALTER TABLE flow ADD COLUMN IF NOT EXISTS on_behalf_of_permissioned_as VARCHAR(255);
