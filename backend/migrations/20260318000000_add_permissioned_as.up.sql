...
UPDATE http_trigger SET permissioned_as = CASE WHEN edited_by LIKE '%@%' THEN edited_by WHEN edited_by LIKE 'group-%' THEN 'g/' || substr(edited_by, 7) ELSE 'u/' || edited_by END;
...
UPDATE websocket_trigger SET permissioned_as = CASE WHEN edited_by LIKE '%@%' THEN edited_by WHEN edited_by LIKE 'group-%' THEN 'g/' || substr(edited_by, 7) ELSE 'u/' || edited_by END;
...
UPDATE postgres_trigger SET permissioned_as = CASE WHEN edited_by LIKE '%@%' THEN edited_by WHEN edited_by LIKE 'group-%' THEN 'g/' || substr(edited_by, 7) ELSE 'u/' || edited_by END;
...
UPDATE mqtt_trigger SET permissioned_as = CASE WHEN edited_by LIKE '%@%' THEN edited_by WHEN edited_by LIKE 'group-%' THEN 'g/' || substr(edited_by, 7) ELSE 'u/' || edited_by END;
...
UPDATE kafka_trigger SET permissioned_as = CASE WHEN edited_by LIKE '%@%' THEN edited_by WHEN edited_by LIKE 'group-%' THEN 'g/' || substr(edited_by, 7) ELSE 'u/' || edited_by END;
...
UPDATE nats_trigger SET permissioned_as = CASE WHEN edited_by LIKE '%@%' THEN edited_by WHEN edited_by LIKE 'group-%' THEN 'g/' || substr(edited_by, 7) ELSE 'u/' || edited_by END;
...
UPDATE sqs_trigger SET permissioned_as = CASE WHEN edited_by LIKE '%@%' THEN edited_by WHEN edited_by LIKE 'group-%' THEN 'g/' || substr(edited_by, 7) ELSE 'u/' || edited_by END;
...
UPDATE gcp_trigger SET permissioned_as = CASE WHEN edited_by LIKE '%@%' THEN edited_by WHEN edited_by LIKE 'group-%' THEN 'g/' || substr(edited_by, 7) ELSE 'u/' || edited_by END;
...
UPDATE email_trigger SET permissioned_as = CASE WHEN edited_by LIKE '%@%' THEN edited_by WHEN edited_by LIKE 'group-%' THEN 'g/' || substr(edited_by, 7) ELSE 'u/' || edited_by END;
...
UPDATE schedule SET permissioned_as = CASE WHEN edited_by LIKE '%@%' THEN edited_by WHEN edited_by LIKE 'group-%' THEN 'g/' || substr(edited_by, 7) ELSE 'u/' || edited_by END;
