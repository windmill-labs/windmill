...
CREATE INDEX idx_native_triggers_workspace
    ON native_triggers (workspace_id);

CREATE INDEX idx_native_triggers_script_path
    ON native_triggers (workspace_id, script_path, is_flow);
