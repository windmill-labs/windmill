...
DROP TRIGGER IF EXISTS flow_mcp_tools_insert_trigger ON flow;
DROP TRIGGER IF EXISTS flow_mcp_tools_update_trigger ON flow;
DROP TRIGGER IF EXISTS resource_mcp_tools_insert_trigger ON resource;
DROP TRIGGER IF EXISTS resource_mcp_tools_update_trigger ON resource;
DROP TRIGGER IF EXISTS resource_mcp_tools_delete_trigger ON resource;
