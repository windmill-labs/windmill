...
use monitor::{
    ...
    reload_instance_python_version_setting, reload_maven_config_setting,
...
use windmill_worker::{
    ...
    JAVA_CACHE_DIR, MAVEN_PLUGINS_DIR, NU_CACHE_DIR, POWERSHELL_CACHE_DIR, PY310_CACHE_DIR,
    PY311_CACHE_DIR, PY312_CACHE_DIR, PY313_CACHE_DIR, RUST_CACHE_DIR, TAR_JAVA_CACHE_DIR,
    TAR_PY310_CACHE_DIR, TAR_PY311_CACHE_DIR, TAR_PY312_CACHE_DIR, TAR_PY313_CACHE_DIR,
    UV_CACHE_DIR,
};
