...
use windmill_worker::{
    ...
    PY310_CACHE_DIR, PY311_CACHE_DIR, PY312_CACHE_DIR, PY313_CACHE_DIR, PYSYS_CACHE_DIR,
    RUST_CACHE_DIR, TAR_PIP_CACHE_DIR, TAR_PY310_CACHE_DIR, TAR_PY311_CACHE_DIR,
    TAR_PY312_CACHE_DIR, TAR_PY313_CACHE_DIR, TAR_PYSYS_CACHE_DIR, TMP_LOGS_DIR, UV_CACHE_DIR,
};
