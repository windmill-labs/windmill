...
use crate::users::{add_to_demo_if_exists, LoginUserInfo};
use crate::webhook_util::WebhookShared;
...
async fn login_callback(
    ...
    if let Ok(token) = token_res {
        ...
        webhook.send_instance_event(InstanceEvent::UserSignupOAuth {
            email: email.clone(),
        });
