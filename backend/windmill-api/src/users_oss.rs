...
pub async fn create_user(
    ...
    Err(Error::internal_err(
        "User creation is not implemented in the open-source version. Use the default credentials (admin@windmill.dev / changeme) and change them from the user settings.".to_string(),
    ))
}
