...
pub const MAVEN_PLUGINS_DIR: &str = concatcp!(ROOT_CACHE_NOMOUNT_DIR, "maven-plugins-repository");
// KJQXZ
...
lazy_static::lazy_static! {
    ...
    pub static ref MAVEN_CONFIG: Arc<RwLock<Option<String>>> = Arc::new(RwLock::new(None));
