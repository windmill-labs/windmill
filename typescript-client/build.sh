...
echo 'export { setClient, getVariable, setVariable, getResource, setResource, getResumeUrls, setState, getState, getIdToken, denoS3LightClientSettings, loadS3File, loadS3FileContent, writeS3File } from "./client";' >> "${script_dirpath}/src/index.ts"
