...
<CenteredModal title="Welcome to Windmill">
	...
	<div class="flex flex-row justify-between pt-4 gap-x-1">
		<Button color="light" variant="contained" unifiedSize="md" onclick={decline}>Skip</Button>
		<div class="flex items-center gap-2">
			<Button variant="default" unifiedSize="md" onclick={() => startSetup(true)}>Advanced setup</Button>
			<Button variant="accent" unifiedSize="md" onclick={() => startSetup()}>Quick setup</Button>
		</div>
	</div>
</CenteredModal>
