...
{:else if $userStore}
	...
	<div>
		...
		>
			<div
				class={classNames(
					'fixed inset-0 bg-[#1e232e] bg-opacity-75 transition-opacity ease-linear duration-300 z-40',
		...
		>
			<div class="flex-1 flex flex-col min-h-0 h-screen shadow-lg bg-[#1e232e]">
				<button
					on:click={() => {
						goto('/')
					}}
