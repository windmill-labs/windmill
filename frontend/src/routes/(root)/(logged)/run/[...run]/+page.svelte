			...
			<div class="flex flex-row flex-wrap gap-6 items-center">
				{#if job}
					...
					<div class="flex flex-row gap-2 items-center flex-wrap">
						...
						{/if}
						{#if job.tag && !['deno', 'python3', 'flow', 'other', 'go', 'postgresql', 'mysql', 'bigquery', 'snowflake', 'mssql', 'graphql', 'oracledb', 'nativets', 'bash', 'powershell', 'php', 'rust', 'other', 'ansible', 'csharp', 'nu', 'java', 'dependency', 'duckdb'].includes(job.tag)}
