...
export const mcpEndpointTools: EndpointTool[] = [
    ...
    {
        name: "readDocsPage",
        description: "Fetch the markdown of a single Windmill documentation page. Provide the `path` (or full URL) of a page found via searchDocs. If the page is large, this returns its list of section headings instead of the full content; call again with the `section` argument set to one of those headings to read that section.",
        instructions: "",
        path: "/docs/page",
        method: "GET",
        pathParamsSchema: undefined,
