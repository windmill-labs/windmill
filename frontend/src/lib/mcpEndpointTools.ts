...
export const mcpEndpointTools: EndpointTool[] = [
	...
	},
	{
		...
		instructions:
			"To create a script, specify the path (e.g., 'f/my_folder/my_script'), the content (source code), and the language. For TypeScript, use 'bun' unless deno-specific APIs are needed.",
		...
		bodySchema: {
			...
			properties: {
				...
				language: {
					type: 'string',
					description:
						'Possible values: python3, deno, go, bash, powershell, postgresql, mysql, bigquery, snowflake, mssql, oracledb, graphql, nativets, bun, php, rust, ansible, csharp, nu, java, ruby, duckdb, bunnative'
				},
				kind: {
					type: 'string',
	...
	},
	{
		...
		instructions:
			"You should first use getScriptByPath to retrieve the script's schema and understand what arguments are expected.",
	...
	},
	{
		...
		bodySchema: {
			...
			required: ['summary', 'value', 'path__body'],
			description:
				'Top-level flow definition containing metadata, configuration, and the flow structure'
		},
		pathFieldRenames: {
	...
	},
	{
		...
		instructions:
			"You should first use getFlowByPath to retrieve the flow's schema and understand what arguments are expected.",
	...
	},
	{
		...
		instructions:
			'Allows testing a script before deploying it. For typescript code, the language to send is either bun or deno. By default, send bun if no deno specific code is detected.',
		...
		bodySchema: {
			...
			required: ['args', 'content', 'language']
		},
		pathFieldRenames: undefined,
		queryFieldRenames: undefined,
		bodyFieldRenames: undefined
	},
	{
		...
		queryParamsSchema: {
			...
			properties: {
				...
				trigger_kind: {
					description:
						'trigger kind (schedule, http, websocket...). Possible values: webhook, default_email, email, schedule, http, websocket, postgres, kafka, nats, mqtt, sqs, gcp',
					type: 'string'
				},
				script_hash: {
					type: 'string',
