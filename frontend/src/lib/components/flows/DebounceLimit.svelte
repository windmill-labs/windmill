...
<div>
	...
	<div class="flex flex-col gap-4 mt-2">
		...
		<Label label="Max total debounces amount (optional)">
			{#snippet header()}
				<Tooltip>
					Maximum number of times a job can be debounced before it must execute. Once this count is
					reached, the job will run regardless of ongoing debouncing.</Tooltip
				>
			{/snippet}
