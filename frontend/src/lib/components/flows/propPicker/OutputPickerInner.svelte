<script lang="ts">
	...
	import FlowHistoryJobPicker from '$lib/components/FlowHistoryJobPicker.svelte'
			...
			<div class="flex flex-row items-center gap-0.5">
				<FlowHistoryJobPicker
					...
					floatingConfig={{
						...
						gutter: 0 // hack to make effset effective, see https://github.com/melt-ui/melt-ui/issues/528
					}}
					height={clientHeight}
