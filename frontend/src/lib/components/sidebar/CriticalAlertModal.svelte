<script lang="ts">
	...
	let getCriticalAlerts: ((params?: any) => Promise<any>) | undefined = $state()
	let acknowledgeCriticalAlert: ((params?: any) => Promise<any>) | undefined = $state()
	let acknowledgeAllCriticalAlerts: ((params?: any) => Promise<any>) | undefined = $state()
