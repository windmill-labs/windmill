...
<!-- #0B5CFF / #FFFFFF per brand.zoom.com. The logo "may only be used in Bloom (#0B5CFF), White, or
	Black", with White reserved for dark backgrounds and Black requiring prior brand approval. -->
<svg
	class="text-[#0B5CFF] dark:text-[#FFFFFF]"
	{width}
	{height}
