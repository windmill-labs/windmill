...
<!-- #11110D / #FFFFFF per zendesk.com. Zendesk's brand guidelines specify the logo in Licorice
	#11110D and Coconut #FFFFFF only and forbid unapproved color variations. -->
<svg
	class="text-[#11110D] dark:text-[#FFFFFF]"
	{width}
	{height}
	viewBox="-11.636 -42.636 279.273 279.273"
	version="1.1"
