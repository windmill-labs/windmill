...
<!-- #CB171E on the A per yaml.org's own assets/favicon.svg and assets/logo.png; the Y, M and L carry no fill in YAML's SVG, so they take the surrounding text colour. YAML publishes no reversed variant, and its black letters would be invisible on the dark surface. -->
<svg
	width={derivedWidth}
	height={derivedHeight}
	viewBox="-23.273 -43.949 558.545 558.545"
	fill="none"
