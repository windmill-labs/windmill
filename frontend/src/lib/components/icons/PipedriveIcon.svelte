<!-- #017737 / #017737 per pipedrive.com logo token --pd-puco-global-color-green-500. Pipedrive's partner media kit says "do not alter, rotate, modify or animate the logo", so the mark keeps its published colours on both themes. -->
<script lang="ts">
	interface Props {
		height?: string
		width?: string
