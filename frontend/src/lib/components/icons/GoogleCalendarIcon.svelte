...
>
	...
	<g mask="url(#google-calendar-body-mask)">
		<path
			fill="url(#google-calendar-bottom-gradient)"
			d="M0 0h166v76H0z"
			transform="matrix(1 0 0 -1 13 172)"
		/>
	</g>
	<mask
		id="google-calendar-top-mask"
		width="154"
		height="152"
		x="19"
		y="20"
	...
	<g mask="url(#google-calendar-top-mask)">
		<path
			fill="url(#google-calendar-top-gradient)"
			d="M32 27.2C32 16.596 40.596 8 51.2 8h89.6c10.604 0 19.2 8.596 19.2 19.2V96H32z"
			filter="url(#google-calendar-top-blur)"
		/>
	</g>
	<path
		fill="#fff"
	...
	<defs>
		<linearGradient
			id="google-calendar-bottom-gradient"
			x1="83"
			x2="83"
			y1="76"
		...
		<linearGradient
			id="google-calendar-top-gradient"
			x1="89.06"
			x2="89.06"
			y1="21.75"
			y2="96.39"
