...
<!-- #000000 / #FFFFFF per matrix.org/branding. Artwork is the Foundation's matrix-icon.svg verbatim; the trademark policy forbids altering it. -->
<svg
