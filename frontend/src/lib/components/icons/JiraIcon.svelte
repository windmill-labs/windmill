...
<!-- #1868DB tile with a white glyph per Atlassian's official Jira logo pack (atlassian.design/foundations/logos). The logomark is identical on light and dark; only the wordmark changes colour. -->
<svg
	x="0px"
	y="0px"
	{width}
