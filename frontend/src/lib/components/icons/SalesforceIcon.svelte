...
<!-- #00B3FF (Cloud Blue 68) per brand.salesforce.com/brand/color. Salesforce reserves the white/reversed cloud for its own blue backgrounds, so the blue mark stands in both themes. -->
