...
<!-- #EA5937 per honeybadger.io/favicon.svg. Single-colour bolt mark, no per-theme variant published. -->
<svg {width} {height} viewBox="0 0 24 24" fill="#EA5937" xmlns="http://www.w3.org/2000/svg">
	<path
