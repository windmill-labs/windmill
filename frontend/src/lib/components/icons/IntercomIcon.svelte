...
<!-- #000000 / #FFFFFF per intercom.com. Intercom ships the mark as fill="currentColor" bound to
	its nav foreground token, so it takes the colour of the surface it sits on. -->
<svg
