...
<!-- #000000 / #FFF9F4 per gorgias.com/about-us/style, which ships the symbol as a "Dark"/"Light"
	pair. The guide allows only black or white for the symbol: "Do not use gray!". -->
<svg
	class="text-[#000000] dark:text-[#FFF9F4]"
	{width}
	{height}
	viewBox="0 0 65 69"
