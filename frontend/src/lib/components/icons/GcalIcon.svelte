...
<!-- #3c90ff per Google's own Calendar 2026 product logo, https://www.gstatic.com/images/branding/productlogos/calendar_2026/v2/web/192px.svg (paths verbatim).
	 Google forbids modifying its logos, colour included, so this stays fixed with no per-theme pair. -->
<svg
	{width}
	{height}
...
>
	...
	<g mask="url(#gcal-body-mask)">
		<path
			fill="url(#gcal-bottom-gradient)"
			d="M0 0h166v76H0z"
