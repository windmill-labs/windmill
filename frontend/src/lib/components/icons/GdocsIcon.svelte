...
<!-- #3186FF (fold #76BBFF, #3186FF->#A9A8FF gradient) per Google's own Docs product icon
	(gstatic.com/images/branding/productlogos/docs_2026/v2/web/192px.svg, served on workspace.google.com/products/docs). -->
<!-- This is a generic document glyph, not Google's mark, drawn monochrome on currentcolor on purpose;
	Google's brand guidelines forbid recolouring or redrawing its product icons. -->
<svg
