...
<!-- #FF7A00 / #FFFFFF per assets.ringcentral.com/us/brand-library/logos/ringcentral-logo.zip
	(RingCentral logo fullcolor.svg / RingCentral logo white.svg). -->
<svg
	class="text-[#FF7A00] dark:text-[#FFFFFF]"
	{width}
	{height}
