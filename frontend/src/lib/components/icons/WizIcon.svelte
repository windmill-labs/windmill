...
<!-- #0254EC / #FFFFFF per wiz.io/press media kit logo pack (WizLogo_Blue_Vector.svg /
	WizLogo_White_Vector.svg). -->
<svg
	class="text-[#0254EC] dark:text-[#FFFFFF]"
	{width}
	{height}
	viewBox="-1.476 -1.509 35.437 35.437"
	fill="currentColor"
