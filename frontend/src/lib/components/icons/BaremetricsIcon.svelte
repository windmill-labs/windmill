...
<!-- #6078FF per baremetrics.com/favicon.ico. Their site header logo ships the same mark at #5386FF —
	first-party assets disagree, so neither is a safe "correction" of the other. -->
