...
<!-- #7856FF / #FFFFFF per brand.mixpanel.com/logo and /color (Purple 100); mixpanel.com ships the
	same pair as its light/dark favicons. "The Mixpanel logo is only ever used in three colors: black,
	white and the primary brand purple." -->
<svg
	class="text-[#7856FF] dark:text-[#FFFFFF]"
	{width}
	{height}
