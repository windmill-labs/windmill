<!-- #2560FF (Ocean Blue) per Docker's official logo kit (docker.com/company/newsroom/media-resources). Docker requires its logos appear only in its primary brand colours. -->
<script lang="ts">
	interface Props {
		height?: string
		width?: string
