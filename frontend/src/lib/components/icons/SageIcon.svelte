...
<!-- #000000 / #00D639 per @sage/design-tokens --logo-sage-bg-default. Sage sets its logo black on light surfaces and Sage green only on dark ones. -->
<svg
	class="text-[#000000] dark:text-[#00D639]"
	{width}
	{height}
	viewBox="-13.778 -2.436 58.449 58.449"
	fill="currentColor"
