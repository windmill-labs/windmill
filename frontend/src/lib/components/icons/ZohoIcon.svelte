...
<!-- #000000 / #FFFFFF per zoho.com/branding (zoho-logo-web.svg / zoho-logo-white.svg). The four
	squares carry their own brand hexes (#E42527/#089949/#226DB4/#F9B21D) on light; Zoho's reversed
	lock-up is entirely white, so they invert with the wordmark on dark. -->
<svg
...
>
	<path
		class="fill-[#089949] dark:fill-[#FFFFFF]"
	...
	/>
	<path
		class="fill-[#F9B21D] dark:fill-[#FFFFFF]"
	...
	/>
	<path
		class="fill-[#E42527] dark:fill-[#FFFFFF]"
	...
	/>
	<path
		class="fill-[#226DB4] dark:fill-[#FFFFFF]"
