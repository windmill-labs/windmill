...
<!-- #D255FE / #651DDD (Surreal Gradient) per surrealdb.com/brand. Same gradient mark on light and dark; monochrome variants are for subtle placements only. -->
<svg
	{width}
	{height}
	viewBox="-114.491 -44.541 1068.982 1068.982"
	fill="currentColor"
	xmlns="http://www.w3.org/2000/svg"
>
	<style type="text/css">
		.surrealdb-st0 {
			fill: url(#surrealdb-SVGID_1_);
		}
	</style>
	<linearGradient
		id="surrealdb-SVGID_1_"
		gradientUnits="userSpaceOnUse"
		x1="203.3477"
		y1="-25.4128"
		x2="636.6956"
		y2="725.1678"
		gradientTransform="matrix(1 0 0 1 0 140.11)"
	>
		<stop offset="0" style="stop-color:#D255FE" />
		<stop offset="1" style="stop-color:#651DDD" />
	</linearGradient>
	<path
		class="surrealdb-st0"
		d="M420,257.8L653.3,387v-51.8L420,206.3c-34.7,19.2-202.4,111.9-233.3,128.9c28.7,15.9,330.1,182.4,513.3,283.6
