...
<!-- #00684A / #00ED64 per MongoDB brand resources and their LeafyGreen palette. MongoDB permits
	only four logo colours, chosen for contrast with the background, and forbids any other recolour. -->
<svg
	class="text-[#00684A] dark:text-[#00ED64]"
	{width}
	{height}
	viewBox="0 0 15 32"
	fill="none"
