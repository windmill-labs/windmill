...
<!-- #146EF5 per brand.webflow.com/brand-assets. Mark ships in blue, black or white only. -->
<svg {width} {height} viewBox="0 0 24 24" fill="#146EF5" xmlns="http://www.w3.org/2000/svg">
	<path
