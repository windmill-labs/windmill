...
<!-- #000000 / #FFFFFF per brand.github.com/foundations/logo. GitHub allows the Invertocat
	in white or black only and forbids recolouring it, so the pair is fixed here rather than
