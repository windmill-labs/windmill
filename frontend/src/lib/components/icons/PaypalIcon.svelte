...
<!-- #002991 / #60CDFF / #008CFF per PayPal's own paypal-mark-color_new.svg (site header logo on
	paypal.com). The third fill is the deep/bright blue overlap: a two-colour or flat fill loses it. -->
<svg
	{width}
	{height}
	viewBox="7.056 3 37.35 45"
	fill="none"
