...
<!-- Greyscale trigger variant, restored from the pre-audit artwork. Triggers are listed
	beside lucide glyphs (Webhook, Route, Database), and Google's four-colour mark is the one
	mark loud enough to break that set. Deliberately greyscale rather than flattened to
	currentColor: the tonal steps keep the cloud shape legible where a single flat colour
	loses it. The full-colour mark lives in ../GoogleCloudIcon.svelte and is what the resource
	picker and the GCP docs use. -->
<svg
	width={size}
	height={size}
	viewBox="-11.636 -36.636 279.273 279.273"
	version="1.1"
