<!-- #F03C2E on both themes per git-scm.com/community/logos (Git-Icon-1788C.svg, logo by Jason Long, CC BY 3.0). A white reversed logomark exists, but git-scm.com's own dark theme exempts the mark from inversion and keeps it orange. -->
<script lang="ts">
	interface Props {
		height?: string
		width?: string
...
<svg
	...
	viewBox="-1.642 -1.642 100.355 100.355"
	fill="none"
