...
<!-- #181C1F / #F2F7F7 per the GitBook-icon-dark / GitBook-icon-light downloads on
	gitbook.gitbook.io/brand-assets, matching the live gitbook.com favicon. #1C1917 is the marketing
	palette's dark base, not the logomark. -->
<svg
	class="text-[#181C1F] dark:text-[#F2F7F7]"
	{width}
	{height}
