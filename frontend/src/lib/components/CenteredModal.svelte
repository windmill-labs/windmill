...
<div class="center-center min-h-screen p-4 relative bg-secondary">
	<div class="flex flex-col gap-2 items-center w-full">
		...
		<div
			class="border rounded-md shadow-md bg-white w-full max-w-[640px] p-4 sm:py-8 sm:px-10 mb-6 md:mb-20 z-10"
		>
			<div class="mb-10">
