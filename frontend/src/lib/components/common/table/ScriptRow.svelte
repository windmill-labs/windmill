...
<!--
	`path` prefers the user-typed `draft_path` for display — the
	autogenerated `u/{user}/draft_{uuid}` URL stays in `href` for
	navigation since the draft row is keyed by it.
-->
<Row
