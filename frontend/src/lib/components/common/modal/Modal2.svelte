<!-- @migration-task Error while migrating Svelte code: This migration would change the name of a slot (header-left to header_left) making the component unusable -->
<script lang="ts">
