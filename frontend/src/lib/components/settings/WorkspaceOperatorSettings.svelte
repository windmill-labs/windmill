...
>
	...
	<div class="flex flex-col gap-y-1 mb-4">
		...
		<span class="text-xs font-normal text-secondary">
			Let operators compose out of scripts and flows that are already deployed. They still cannot
			write code. Granting either right makes each operator consume a full seat instead of half a
			seat.
		</span>
		<Toggle
