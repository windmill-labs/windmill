...
let toolCompletionListener: ((toolName: string) => void) | undefined

export function setToolCompletionListener(fn: ((toolName: string) => void) | undefined): void {
...
async function callTool<T>({
	...
	toolCompletionListener?.(functionName)
	return result
}
