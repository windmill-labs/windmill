<!-- <script context="module">
	...
	languages.typescript.typescriptDefaults.setCompilerOptions({
		jsx: languages.typescript.JsxEmit.React, // or "ReactJSX" for React 17+
		allowJs: true,
		checkJs: true,
...
<script lang="ts">
	...
	export const runApplicationPlayground = async () => {
		...
		fileSystemProvider.registerFile(new RegisteredMemoryFile(helloTsUri, 'foo'))
		fileSystemProvider.registerFile(new RegisteredMemoryFile(testerTsUri, 'bar'))
