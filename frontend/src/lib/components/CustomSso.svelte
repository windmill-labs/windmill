...
<label class="block pb-2">
	<span class="text-primary font-medium text-xs">Auth URL</span>
	<input
		type="text"
...
<label class="block pb-2">
	<span class="text-primary font-medium text-xs">Token URL</span>
	<input
		type="text"
...
<label class="block pb-2">
	<span class="text-primary font-medium text-xs">Userinfo URL</span>
	<input
		type="text"
...
<label class="block pb-2">
	<span class="text-primary font-medium text-xs">Scopes</span>
