				...
				<div class="text-primary pb-4 text-xs">
					...
					<ul class="list-disc list-inside pl-2">
						...
						<li
							...
							far that import got, whether a pre-approved trial offer was opened, and whether data
							tables are put under roles and whether callers name a role or take the default, last
							30 days)</li
						>
						<li
