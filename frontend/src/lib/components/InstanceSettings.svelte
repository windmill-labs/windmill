				...
				<div class="text-primary pb-4 text-xs">
					...
					<ul class="list-disc list-inside pl-2">
						...
						<li
							...
							the flow editor, which skin approval steps are given, whether AI agent steps set their
							own memory id as a fixed id or an expression, how data tables and their migrations are
							set up and used, how often an empty workspace home is seen, how often the home page’s
							create menu and hub-project picker are opened and from which entry point, and the name
							of any public hub project imported from the home page and how far that import got,
							last 30 days)</li
						>
						<li
