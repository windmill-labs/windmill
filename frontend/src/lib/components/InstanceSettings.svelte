				...
				<div class="text-primary pb-4 text-xs">
					...
					<ul class="list-disc list-inside pl-2">
						...
						<li
							...
							up and used, how often an empty workspace home is seen, how often the home page’s
							...
							whether a pre-approved trial offer was opened, and whether data tables are put under
							roles and whether callers name a role or take the default, last 30 days)</li
						>
						<li
