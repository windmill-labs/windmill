				...
				<div class="text-primary pb-4 text-xs">
					...
					<ul class="list-disc list-inside pl-2">
						...
						<li
							...
							tables are put under roles and whether callers name a role or take the default, and
							which kinds of access change (grant, revoke, ownership, default privileges) are
							applied to data tables, last 30 days)</li
						>
						<li
