 ...
 *
 * NOTE: The core logic for non-trigger kinds is shared with the CLI via
 * cli/windmill-utils-internal/src/deploy.ts. When changing deploy behavior
 * here, keep that file in sync (or vice versa).
 */
 ...
 *
 * NOTE: Keep in sync with cli/windmill-utils-internal/src/deploy.ts
 */
