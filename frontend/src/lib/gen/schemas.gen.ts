...
export const $GitSyncObjectType = {
    type: 'string',
    enum: ['script', 'flow', 'app', 'folder', 'resource', 'variable', 'secret', 'resourcetype', 'schedule', 'user', 'group', 'trigger', 'settings', 'key', 'workspacedependencies']
} as const;
...
export const $GlobalUserInfo = {
    ...
    required: ['email', 'login_type', 'super_admin', 'verified', 'first_time_user', 'role_source']
} as const;
