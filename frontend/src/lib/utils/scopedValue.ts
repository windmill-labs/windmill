 ...
 * last successful value standing, which is why `loading` and `error` cannot gate this:
 * both are set during a re-read whose held value is still the right one to show.
 */
