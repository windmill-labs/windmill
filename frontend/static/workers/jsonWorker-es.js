...
class qe {
  ...
  add(t) {
    ...
    return this._isDisposed ? qe.DISABLE_DISPOSED_WARNING || console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack) : this._toDispose.add(t), t;
  }
}
...
const Ia = typeof ((Kt = te == null ? void 0 : te.versions) === null || Kt === void 0 ? void 0 : Kt.electron) == "string", Ra = Ia && (te == null ? void 0 : te.type) === "renderer";
...
(function(e) {
  ...
  class m {
    constructor(b) {
      this.event = b, this.disposables = new qe();
    }
    map(b) {
  ...
  function C(w, b) {
    let y = null;
    function _(T) {
      y == null || y.dispose(), y = new qe(), b(T, y);
    }
    _(void 0);
    const k = w((T) => _(T));
    return It(() => {
...
class Ae {
  ...
  get event() {
    return this._event || (this._event = (t, r, n) => {
      var i, s, o;
      this._listeners || (this._listeners = new Rt());
      ...
      return n instanceof qe ? n.add(d) : Array.isArray(n) && n.push(d), d;
    }), this._event;
  }
  fire(t) {
    var r, n;
    if (this._listeners) {
      this._deliveryQueue || (this._deliveryQueue = new qa());
...
function ds(e, t, r) {
  return new De(new an(e), new an(t)).ComputeDiff(r).changes;
}
class Je {
  static Assert(t, r) {
    if (!t)
...
class De {
  constructor(t, r, n = null) {
    ...
    const [i, s, o] = De._getElements(t), [l, u, c] = De._getElements(r);
  ...
  ElementsAreStrictEqual(t, r) {
    if (!this.ElementsAreEqual(t, r))
      return !1;
    const n = De._getStrictElement(this._originalSequence, t), i = De._getStrictElement(this._modifiedSequence, r);
    return n === i;
  }
  ...
  ComputeDiffRecursive(t, r, n, i, s) {
    ...
    if (t > r || n > i) {
      let f;
      return n <= i ? (Je.Assert(t === r + 1, "originalStart should only be one more than originalEnd"), f = [
        new Ie(t, 0, n, i - n + 1)
      ]) : t <= r ? (Je.Assert(n === i + 1, "modifiedStart should only be one more than modifiedEnd"), f = [
        new Ie(t, r - t + 1, n, 0)
      ]) : (Je.Assert(t === r + 1, "originalStart should only be one more than originalEnd"), Je.Assert(n === i + 1, "modifiedStart should only be one more than modifiedEnd"), f = []), f;
    }
  ...
  ComputeRecursionPoint(t, r, n, i, s, o, l) {
    ...
    for (let y = 1; y <= v / 2 + 1; y++) {
      ...
      if (y <= 1447) {
        ...
        P[0] = S - h + 1, Ze.Copy2(g, h, P, 1, f - h + 1), this.m_forwardHistory.push(P), P = new Int32Array(m - d + 2), P[0] = C - d + 1, Ze.Copy2(A, d, P, 1, m - d + 1), this.m_reverseHistory.push(P);
      }
    }
  ...
  ConcatenateChanges(t, r) {
    ...
    if (this.ChangesOverlap(t[t.length - 1], r[0], n)) {
      ...
      return Ze.Copy(t, 0, i, 0, t.length - 1), i[t.length - 1] = n[0], Ze.Copy(r, 1, i, t.length, r.length - 1), i;
    } else {
      const i = new Array(t.length + r.length);
      return Ze.Copy(t, 0, i, 0, t.length), Ze.Copy(r, 0, i, t.length, r.length), i;
    }
  }
  ChangesOverlap(t, r, n) {
    if (Je.Assert(t.originalStart <= r.originalStart, "Left change is not less than or equal to right change"), Je.Assert(t.modifiedStart <= r.modifiedStart, "Left change is not less than or equal to right change"), t.originalStart + t.originalLength >= r.originalStart || t.modifiedStart + t.modifiedLength >= r.modifiedStart) {
...
if (typeof re.vscode < "u" && typeof re.vscode.process < "u") {
  ...
  typeof process < "u" ? et = {
    ...
    get platform() {
      return mt ? "win32" : Da ? "darwin" : "linux";
    },
    get arch() {
    },
    get env() {
...
const pr = et.cwd, ms = et.env, We = et.platform, gs = 65, ps = 97, vs = 90, bs = 122, Ue = 46, K = 47, se = 92, Pe = 58, ws = 63;
...
const ae = {
  ...
  resolve(...e) {
    ...
    return t = Dt(t, !r, "/", vr), r ? `/${t}` : t.length > 0 ? t : ".";
  },
  normalize(e) {
    if (Z(e, "path"), e.length === 0)
      return ".";
    const t = e.charCodeAt(0) === K, r = e.charCodeAt(e.length - 1) === K;
    return e = Dt(e, !t, "/", vr), e.length === 0 ? t ? "/" : r ? "./" : "." : (r && (e += "/"), t ? `/${e}` : e);
  },
  isAbsolute(e) {
  ...
  relative(e, t) {
    if (Z(e, "from"), Z(t, "to"), e === t || (e = ue.resolve(e), t = ue.resolve(t), e === t))
      return "";
...
We === "win32" ? ae.normalize : ue.normalize;
We === "win32" ? ae.resolve : ue.resolve;
We === "win32" ? ae.relative : ue.relative;
We === "win32" ? ae.dirname : ue.dirname;
We === "win32" ? ae.basename : ue.basename;
We === "win32" ? ae.extname : ue.extname;
We === "win32" ? ae.sep : ue.sep;
...
let tt = class {
  ...
  static isUri(t) {
    return t instanceof tt ? !0 : t ? typeof t.authority == "string" && typeof t.fragment == "string" && typeof t.path == "string" && typeof t.query == "string" && typeof t.scheme == "string" && typeof t.fsPath == "string" && typeof t.with == "function" && typeof t.toString == "function" : !1;
  }
  get fsPath() {
    return br(this, !1);
  }
  with(t) {
    ...
    return r === void 0 ? r = this.scheme : r === null && (r = G), n === void 0 ? n = this.authority : n === null && (n = G), i === void 0 ? i = this.path : i === null && (i = G), s === void 0 ? s = this.query : s === null && (s = G), o === void 0 ? o = this.fragment : o === null && (o = G), r === this.scheme && n === this.authority && i === this.path && s === this.query && o === this.fragment ? this : new Xe(r, n, i, s, o);
  }
  static parse(t, r = !1) {
    const n = Ns.exec(t);
    return n ? new Xe(n[2] || G, Nt(n[4] || G), Nt(n[5] || G), Nt(n[7] || G), Nt(n[9] || G), r) : new Xe(G, G, G, G, G);
  }
  static file(t) {
    let r = G;
    ...
    return new Xe("file", r, t, G, G);
  }
  static from(t) {
    const r = new Xe(t.scheme, t.authority, t.path, t.query, t.fragment);
    return on(r, !0), r;
  }
  static joinPath(t, ...r) {
    if (!t.path)
    ...
    let n;
    return mt && t.scheme === "file" ? n = tt.file(ae.join(br(t, !0), ...r)).path : n = ue.join(t.path, ...r), t.with({ path: n });
  }
  toString(t = !1) {
    return wr(this, t);
  }
...
const ks = 3;
function ia(e, t, r, n) {
  return new De(e, t, r).ComputeDiff(n);
}
class cn {
  constructor(t) {
    const r = [], n = [];
...
class Ts {
  ...
  setValue(t, r) {
    return t = Qe(t), r = Qe(r), this.values[t] === r ? !1 : (this.values[t] = r, t - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = t - 1), !0);
  }
  removeValues(t, r) {
    t = Qe(t), r = Qe(r);
  ...
  getPrefixSum(t) {
    return t < 0 ? 0 : (t = Qe(t), this._getPrefixSum(t));
  }
  _getPrefixSum(t) {
...
class io extends Fs {
  ...
  getWordAtPosition(t, r) {
    const n = zr(t.column, Rs(r), this._lines[t.lineNumber - 1], 0);
...
class Be {
  ...
  acceptNewModel(t) {
    this._models[t.url] = new io(tt.parse(t.url), t.lines, t.EOL, t.versionId);
  }
  ...
  computeDiff(t, r, n, i) {
    return je(this, void 0, void 0, function* () {
      ...
      return !s || !o ? null : Be.computeDiff(s, o, n, i);
    });
  }
  ...
  computeMoreMinimalEdits(t, r) {
    return je(this, void 0, void 0, function* () {
      ...
      for (let { range: o, text: l, eol: u } of r) {
        ...
        if (l = l.replace(/\r\n|\n|\r/g, n.eol), c === l)
          continue;
        if (Math.max(l.length, c.length) > Be._diffLimit) {
        ...
        for (const u of t) {
          ...
          if (c) {
            for (const h of c.words(o))
              if (!(h === r || !isNaN(Number(h))) && (l.add(h), l.size > Be._suggestionsLimit))
                break e;
          }
        }
...
`), l++, c = n, o = 14;
    switch (C) {
      ...
      case 45:
        if (i += String.fromCharCode(C), n++, n === r || !Ye(e.charCodeAt(n)))
          return o = 16;
      case 48:
      case 49:
      case 50:
...
(function(e) {
  function t(n, i) {
    return n === Number.MAX_VALUE && (n = $t.MAX_VALUE), i === Number.MAX_VALUE && (i = $t.MAX_VALUE), { line: n, character: i };
  }
  e.create = t;
  function r(n) {
    var i = n;
...
(function(e) {
  function t(r) {
    ...
    return n && (n.changes !== void 0 || n.documentChanges !== void 0) && (n.documentChanges === void 0 || n.documentChanges.every(function(i) {
      return L.string(i.kind) ? wt.is(i) || yt.is(i) || Ct.is(i) : qt.is(i);
    }));
  }
  e.is = t;
})(Vr || (Vr = {}));
var Lt = function() {
  ...
  return e.prototype.insert = function(t, r, n) {
    var i, s;
    if (n === void 0 ? i = we.insert(t, r) : ie.is(n) ? (s = n, i = Re.insert(t, r, n)) : (this.assertChangeAnnotations(this.changeAnnotations), s = this.changeAnnotations.manage(n), i = Re.insert(t, r, s)), this.edits.push(i), s !== void 0)
      return s;
  }, e.prototype.replace = function(t, r, n) {
    var i, s;
    if (n === void 0 ? i = we.replace(t, r) : ie.is(n) ? (s = n, i = Re.replace(t, r, n)) : (this.assertChangeAnnotations(this.changeAnnotations), s = this.changeAnnotations.manage(n), i = Re.replace(t, r, s)), this.edits.push(i), s !== void 0)
      return s;
  }, e.prototype.delete = function(t, r) {
    var n, i;
    if (r === void 0 ? n = we.del(t) : ie.is(r) ? (i = r, n = Re.del(t, r)) : (this.assertChangeAnnotations(this.changeAnnotations), i = this.changeAnnotations.manage(r), n = Re.del(t, i)), this.edits.push(n), i !== void 0)
      return i;
  ...
  function s() {
    ...
    var N = function(I, B) {
      for (var Q = [], W = void 0, E = 0, M = I; E < M.length; E++) {
        ...
        if (ee(i, V, D, U), D.hasProblems() || Q.push(V), !W)
          ...
          if (Array.isArray(Ce))
            for (var Xt = 0, Xr = Ce; Xt < Xr.length; Xt++) {
              ...
              v[Qr] ? d.propertiesValueMatches++ : d.problems.push({
                location: { offset: h.offset, length: h.length },
                message: R("RequiredDependentPropWarning", "Object is missing property {0} required by property {1}.", Qr, C)
              });
            }
          else {
            var P = oe(Ce);
...
function To(e, t) {
  ...
  function v(w, b) {
    ...
    y.keyNode = _;
    var T = b[_.value];
    if (T ? (u(R("DuplicateKeyWarning", "Duplicate object key"), q.DuplicateKey, y.keyNode.offset, y.keyNode.offset + y.keyNode.length, me.Warning), typeof T == "object" && u(R("DuplicateKeyWarning", "Duplicate object key"), q.DuplicateKey, T.keyNode.offset, T.keyNode.offset + T.keyNode.length, me.Warning), b[_.value] = !0) : b[_.value] = y, s.getToken() === 6)
  ...
  var N = void 0, x = l();
  return x !== 17 && (N = C(N), N ? s.getToken() !== 17 && c(R("End of file expected", "End of file expected."), q.Undefined) : c(R("Invalid symbol", "Expected a JSON object, array or literal."), q.Undefined)), new da(N, r, o);
}
function Br(e, t, r) {
    ...
    var o = [], l = {}, u = function(d) {
      ...
      if (d) {
        if (d.errors.length && r.root && g) {
          ...
          if (S && S.keyNode.value === "$schema") {
            ...
            u(xe.create(N, d.errors[0], g, q.SchemaResolveError));
          } else {
      ...
      if (typeof v == "number") {
        ...
        r.comments.forEach(function(k) {
          u(xe.create(k, _, v, q.CommentNotPermitted));
        });
      }
      return o;
    };
    if (i) {
      var h = i.id || "schemaservice://untitled/" + Do++, f = this.jsonSchemaService.registerExternalSchema(h, [], i);
...
var qi = 48, Oo = 57, Uo = 65, xt = 97, jo = 102;
function X(e) {
  return e < qi ? 0 : e <= Oo ? e - qi : (e < xt && (e += xt - Uo), e >= xt && e <= jo ? e - xt + 10 : 0);
}
function Bo(e) {
  if (e[0] === "#")
    switch (e.length) {
...
for (Wi in $r.schemas) {
  Mt = $r.schemas[Wi];
  for (Ke in Mt.properties)
    Pt = Mt.properties[Ke], typeof Pt == "boolean" && (Pt = Mt.properties[Ke] = {}), lr = qo[Ke], lr ? Pt.description = lr : console.log("".concat(Ke, ": localize('schema.json.").concat(Ke, `', "")`));
}
var Mt, Pt, lr, Ke, Wi, pa;
pa = (() => {
  var e = { 470: (n) => {
    function i(l) {
      if (typeof l != "string")
    ...
    var p = "", g = "/", A = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/, S = function() {
      function E(M, F, V, D, U, $) {
        $ === void 0 && ($ = !1), typeof M == "object" ? (this.scheme = M.scheme || p, this.authority = M.authority || p, this.path = M.path || p, this.query = M.query || p, this.fragment = M.fragment || p) : (this.scheme = function(ye, ne) {
          return ye || ne ? ye : "file";
        }(M, $), this.authority = F || p, this.path = function(ye, ne) {
          switch (ye) {
            case "https":
            case "http":
            case "file":
    ...
    function _(E, M) {
      var F = M ? b : w, V = "", D = E.scheme, U = E.authority, $ = E.path, ye = E.query, ne = E.fragment;
      if (D && (V += D, V += ":"), (U || D === "file") && (V += g, V += g), U) {
        var ge = U.indexOf("@");
        if (ge !== -1) {
          var Ge = U.substr(0, ge);
          U = U.substr(ge + 1), (ge = Ge.indexOf(":")) === -1 ? V += F(Ge, !1) : (V += F(Ge.substr(0, ge), !1), V += ":", V += F(Ge.substr(ge + 1), !1)), V += "@";
        }
        (ge = (U = U.toLowerCase()).indexOf(":")) === -1 ? V += F(U, !1) : (V += F(U.substr(0, ge), !1), V += U.substr(ge));
      }
      if ($) {
        if ($.length >= 3 && $.charCodeAt(0) === 47 && $.charCodeAt(2) === 58)
          (Ce = $.charCodeAt(1)) >= 65 && Ce <= 90 && ($ = "/".concat(String.fromCharCode(Ce + 32), ":").concat($.substr(3)));
        else if ($.length >= 2 && $.charCodeAt(1) === 58) {
          var Ce;
          (Ce = $.charCodeAt(0)) >= 65 && Ce <= 90 && ($ = "".concat(String.fromCharCode(Ce + 32), ":").concat($.substr(2)));
        }
        V += F($, !0);
      }
    ...
    (function(E) {
      E.joinPath = function(M) {
        ...
        for (var F = [], V = 1; V < arguments.length; V++)
          F[V - 1] = arguments[V];
        var D = M.path || "/";
        return M.with({ path: W.resolve.apply(W, Q([D], F, !1)) });
...
function al(e) {
  ...
  r.setSchemaContributions($r);
  var n = new Eo(r, e.contributions, t, e.clientCapabilities), i = new Fo(r, e.contributions, t), s = new $o(r), o = new Ro(r, t);
  return {
...
var sl = class {
  ...
  _getTextDocument(e) {
    ...
    for (let r of t)
      if (r.uri.toString() === e)
        return Dr.create(e, this._languageId, r.version, r.getValue());
    return null;
  }
