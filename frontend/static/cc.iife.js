...
var wmc = (function (t, e, r) {
	'use strict'
	const w = ''
	function i({ passSetters: n, setOutput: m, renderInit: u }) {
		const [d, l] = e.useState(u),
			[s, c] = e.useState(void 0)
		return (
			e.useEffect(() => {
				n({
					onInput: (a) => {
			...
			d
				? e.createElement(
						e.Fragment,
						null,
						e.createElement('h1', null, 'Minimal Component'),
						e.createElement('pre', null, JSON.stringify(s)),
						e.createElement(
							'button',
							{
	...
	function o(n) {
		r.createRoot(document.getElementById(n.id)).render(
			e.createElement(
				e.StrictMode,
				null,
				e.createElement(i, {
					passSetters: n.passSetters,
					setOutput: n.setOutput,
					renderInit: n.render
				})
			)
		)
	...
	return (
		window.windmill === void 0 && (window.windmill = {}),
		(window.windmill.mycomponent = o),
		(t.customComponent = o),
